Ext.define('B4.controller.report.CountRoByCeoInPublProgram', {
    extend: 'B4.controller.BaseReportController',

    mainView: 'B4.view.report.CountRoByCeoInPublProgramPanel',
    mainViewSelector: 'countrobyceoinpublprogrampanel',
    ...
    views: [
        'report.CountRoByCeoInPublProgramPanel',
    ...
    refs: [
        {
            ref: 'nfStart',
            selector: 'countrobyceoinpublprogrampanel [name=StartYear]'
        },
        {
            ref: 'nfEnd',
            selector: 'countrobyceoinpublprogrampanel [name=EndYear]'
        },
        {
            ref: 'MunicipalityTriggerField',
            selector: 'countrobyceoinpublprogrampanel [name=Municipalities]'
        }
    ],
    ...
    aspects: [
        {
            ...
            name: 'countrobyceoinpublprogramMultiselectwindowaspect',
            fieldSelector: 'countrobyceoinpublprogrampanel [name=Municipalities]',
            multiSelectWindow: 'SelectWindow.MultiSelectWindow',
            multiSelectWindowSelector: '#countrobyceoinpublprogrampanelMunicipalitySelectWindow',
    ...
    validateParams: function() {
        ...
        if (nfStart.getValue() > nfEnd.getValue()) {
            return 'Год окончания должен быть больше либо равен году начала';
        }
