Ext.define('B4.controller.import.Dpkr1CImport', {
    extend: 'B4.base.Controller',

    views: ['import.dpkr.Dpkr1Cdata'],

    mainView: 'import.dpkr.Dpkr1Cdata',
    mainViewSelector: 'dpkr1cdataimport',

    refs: [{
        ref: 'mainView',
        selector: 'dpkr1cdataimport'
    }],
    ...
    loadButtonClick: function () {
        ...
        me.params = {};
        me.params.importId = 'Dpkr1cImport';
    ...
    index: function () {
        var view = this.getMainView() || Ext.widget('dpkr1cdataimport');
