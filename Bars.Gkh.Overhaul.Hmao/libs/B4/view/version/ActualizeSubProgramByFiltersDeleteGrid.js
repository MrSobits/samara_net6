Ext.define('B4.view.version.ActualizeSubProgramByFiltersDeleteGrid', {
    extend: 'B4.ux.grid.Panel',

    alias: 'widget.actualizesubprogrambyfilterdeletegrid',

    requires: [
        'B4.ux.button.Update',
        'B4.ux.grid.plugin.HeaderFilters',
        'B4.ux.grid.toolbar.Paging',
        'B4.store.version.ActualizeSubProgramByFiltersDelete',
    ],
    closable: false,
    title: 'Дома на удаление',
    layout: 'form',
    bodyPadding: 5,
    store: 'version.ActualizeSubProgramByFiltersDelete',
