Ext.define('B4.view.protocolmkd.EditWindow', {
    ...
    requires: [
        ...
        'B4.view.protocolmkd.DecisionGrid',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'tabpanel',
                            itemId: 'protocolmkdTabPanel',
                            flex: 1,
                            disabled: false,
                            border: false,
                            items: [
                                {
                                    xtype: 'protocolmkddecisiongrid',
                                    flex: 1
                                },
                                {
