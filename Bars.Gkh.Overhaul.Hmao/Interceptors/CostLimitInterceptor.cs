...
{
    public class CostLimitInterceptor : EmptyDomainInterceptor<CostLimit>
    {
        public override IDataResult BeforeCreateAction(IDomainService<CostLimit> service, CostLimit entity)
        {
        ...
        public override IDataResult BeforeUpdateAction(IDomainService<CostLimit> service, CostLimit entity)
        {
            //var costs = service.GetAll()
