namespace Bars.Gkh.Overhaul.Hmao.Interceptors
{
    ...
    {
        public override IDataResult BeforeCreateAction(IDomainService<SpecialAccountDecisionNotice> service,
            SpecialAccountDecisionNotice entity)
        {
            ...
            var noticeNums = service.GetAll()
                .Where(
                    x =>
                        ...
                        x.NoticeDate == entity.NoticeDate)
