namespace Bars.Gkh.Overhaul.Hmao.DomainService.Impl
{
    ...
    public class DefectService : IDefectService
    {
        ...
        public DefectService(IWindsorContainer container, IDomainService<ObjectCr> objectCrService,
        ...
        public IDataResult WorksForDefectList(BaseParams baseParams)
        {
            ...
            return this.Container.Resolve<IDomainService<Work>>().GetAll()
        ...
        public IDataResult GetDefectListViewValue(BaseParams baseParams)
        {
            ...
            {
                programCrChange = ProgramCrChangeService
                    .GetAll()
