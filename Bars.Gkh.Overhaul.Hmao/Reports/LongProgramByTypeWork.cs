namespace Bars.Gkh.Overhaul.Hmao.Reports
{
    ...
    public class LongProgramByTypeWork : BasePrintForm
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            var correctionYearBySt3 =
                 DpkrCorrectionDomain.GetAll()
                     .Where(x => x.Stage2.Stage3Version.ProgramVersion.IsMain)
                     .WhereIf(municipalityIds.Count > 0, x => municipalityIds.Contains(x.Stage2.Stage3Version.ProgramVersion.Municipality.Id))
                     .Where(x => x.Stage2.Stage3Version.IndexNumber > 0 || x.Stage2.Stage3Version.Year < endYear)
            ...
            var data =
                Stage1Domain.GetAll()
                    ...
                    .WhereIf(typeWorkIds.Any(), x => structElsQuery.Any(y => y.StructuralElement.Id == x.StructuralElement.StructuralElement.Id))
                    .Select(
                        x =>
                            new 
                            {
                    ...
                    .Select(x => new
                            {
                                ...
                                x.SumService,
                                x.Volume,
                                CorrectYear = correctionYearBySt3.Get(x.st3Id),
                            })
