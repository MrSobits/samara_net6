    ...
    public class RealtyObjectDataReport : BasePrintForm
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            using (this.Container.Using(realityObjectService, realityObjectStructuralElementService))
            {
                ...
                reportParams.SimpleReportParams["MaximumFloors"] = realityObjInfo.MaximumFloors;
                reportParams.SimpleReportParams["NumberEntrances"] = realityObjInfo.NumberEntrances;
