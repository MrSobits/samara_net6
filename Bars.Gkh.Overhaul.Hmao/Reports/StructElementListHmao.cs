namespace Bars.Gkh.Overhaul.Hmao.Reports
{
    ...
    public class StructElementListHmao : Overhaul.Reports.StructElementList
    {
        public StructElementListHmao(): base(new ReportTemplateBinary(Resources.StructElementList))
        {
        }

        public override string Id
        {
            get { return "StructElementListHmao"; }
        }
