...
///     using Entities;
/// 
///     public class QualityPriorityParamMap : BaseImportableEntityMap<QualityPriorityParam>
///     {
...
namespace Bars.Gkh.Overhaul.Hmao.Map
{
    ...
    /// <summary>Маппинг для "Качественный параметр очередности"</summary>
    public class QualityPriorityParamMap : BaseImportableEntityMap<QualityPriorityParam>
    {
        
        public QualityPriorityParamMap() : 
                base("Качественный параметр очередности", "OVRHL_PRIOR_PARAM_QUALITY")
        {
        }
