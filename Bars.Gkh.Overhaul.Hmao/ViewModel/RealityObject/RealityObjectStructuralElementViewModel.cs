namespace Bars.Gkh.Overhaul.Hmao.ViewModel.RealityObject
{
    using System;
            ...
            try
            {
                ...
                var data = roElements
                    ...
                    .Select(x => new
                    {
                        ...
                        ElementName = x.StructuralElement.Name,
                        ...
                        x.Condition,
                        PlanRepairYear = publishYearsByCeo.ContainsKey(x.Id) ? (int?)publishYearsByCeo[x.Id] : null,
                        ...
                        x.NetworkLength,
                        x.NetworkPower,
                        AdjustedYear = adjustedYears.ContainsKey(x.Id) ? (int?)adjustedYears[x.Id] : null,
                    })
                    .AsQueryable()
