namespace Bars.Gkh.Overhaul.Hmao.FormatDataExport.Domain.Impl
{
    using System.Linq;
    ...
    public class FormatDataExportObjectCrRepository : BaseFormatDataExportRepository<ObjectCr>
    {
        ...
        public override IQueryable<ObjectCr> GetQuery(IFormatDataExportFilterService filterService)
        {
            ...
            if (!programCrIdList.Any() && !municipalityIdList.Any() && !isSelectByIds)
                objectCrQuery = objectCrQuery.Where(w => false);
