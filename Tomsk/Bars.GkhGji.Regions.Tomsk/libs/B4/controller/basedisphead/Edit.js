    ...
    aspects: [
        {
            ...
            */
            ...
            onValidateUserParams: function (params) {
                if (params.ruleId == 'BaseDispHeadActVisualRule') {
                    return false;
                }
            }
        },
        ...
        },
        {
            ...
            */
            ...
            name: 'baseDispHeadToActVisualGJIAspect',
            buttonSelector: '#baseDispHeadEditPanel [ruleId=BaseDispHeadActVisualRule]',
            multiSelectWindow: 'SelectWindow.MultiSelectWindow',
            multiSelectWindowSelector: '#baseDispHeadToActVisualRuleSelectWindow',
            ...
            listeners: {
                getdata: function (asp, records) {
                    ...
                    if (recordIds[0] > 0) {
                        creationAspect = asp.controller.getAspect('baseDispHeadCreateButtonAspect');
