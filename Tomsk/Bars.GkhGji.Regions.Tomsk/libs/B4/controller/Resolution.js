Ext.define('B4.controller.Resolution', {
    ...
    aspects: [
        ...
        },
        {
            ...
            */
            ...
            otherActions: function (actions) {
                ...
                actions['legalinvestigationpanel [name=HasPetition]'] = { 'change': { fn: this.onChangeHasPetition, scope: this } };
            },
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                this.controller.getAspect('resolutionBlobDescriptionAspect').doInjection();
                this.controller.getAspect('resolutionBlobPetitionAspect').doInjection();
                this.controller.getAspect('resolutionBlobExplanationAspect').doInjection();
            },
            onChangeHasPetition: function (fld, newValue) {
                var textField = fld.up('panel').down('[name=PetitionText]');

                textField.setDisabled(newValue == 10);
            },
                ...
                if (typeExec) {
                    ...
                    B4.Ajax.request({
                        ...
                        case "19":
                            ...
                            panel.down('#cbPhysGender').setDisabled(!perm[1]);
                        ...
                        case "18":
                            ...
                            panel.down('#cbPhysGender').setDisabled(true);
            ...
            listeners: {
                beforesave: function (asp, rec) {
                    var panel = asp.getPanel(),
                        tfTime = panel.down('textfield[name=CreationTime]'),
                    ...
                    if (value) {
                        ...
                        documentTime.setHours(hour, minute);
                        rec.set('DocumentTime', documentTime);
                    }
        ...
        },
        {
            ...
            fieldSelector: '[name="ResolutionText"]',
            editPanelAspectName: 'resolutionEditPanelAspect',
            controllerName: 'Resolution',
            valueFieldName: 'ResolutionText',
            previewLength: 2000,
            autoSavePreview: true,
            getParentPanel: function () {
                return this.componentQuery('resolutionRequisitePanel');
            },
        ...
        {
            xtype: 'gkhblobtextaspect',
            name: 'resolutionBlobPetitionAspect',
            fieldSelector: '[name="PetitionText"]',
            editPanelAspectName: 'resolutionEditPanelAspect',
            controllerName: 'Resolution',
            valueFieldName: 'PetitionText',
            previewLength: 2000,
            autoSavePreview: true,
            
            getParentPanel: function () {
                return this.componentQuery('legalinvestigationpanel');
            },
        ...
        {
            xtype: 'gkhblobtextaspect',
            name: 'resolutionBlobExplanationAspect',
            fieldSelector: '[name="ExplanationText"]',
            editPanelAspectName: 'resolutionEditPanelAspect',
            controllerName: 'Resolution',
            valueFieldName: 'ExplanationText',
            previewLength: 2000,
            autoSavePreview: true,
            getParentPanel: function () {
                return this.componentQuery('legalinvestigationpanel');
