    ...
    aspects: [
        {
            ...
            */
            ...
            typeBase: 20, // Тип проверка по обращению
            onValidateUserParams: function (params) {
                if (params.ruleId == 'BaseStatementToActVisualRule'
                   || params.ruleId == 'BaseStatementToAdminCaseRule') {
                    return false;
                }
            }
        },
        ...
        {
            /*
            Аспект основной панели проверки по обращению
            */
            ...
            listeners: {
                aftersetpaneldata: function (asp, rec, panel) {
                    ...
                    B4.Ajax.request(B4.Url.action('GetInfo', 'BaseStatement', {
                        ...
                        var fieldPrimaryAppealCitizen = panel.down('#tfPrimaryAppealCitizens');
                        
                        if (fieldPrimaryAppealCitizen) {
                            fieldPrimaryAppealCitizen.setValue(obj.primaryAppealCit);
                            panel.PrimaryAppealCitizenId = obj.primaryAppealCitId;
                        }
                    }).error(function () {
                        asp.controller.unmask();
                    });
        ...
        {
            /* 
            Аспект взаимодействия кнопки создания Акта визуального осмотра и массовой формы выборка домов
            ...
            */
            ...
            name: 'baseStatementToActVisualGJIAspect',
            buttonSelector: '#baseStatementEditPanel [ruleId=BaseStatementToActVisualRule]',
            multiSelectWindow: 'SelectWindow.MultiSelectWindow',
            multiSelectWindowSelector: '#baseStatementToActVisualRuleSelectWindow',
            ...
            listeners: {
                getdata: function (asp, records) {
                    ...
                    if (recordIds[0] > 0) {
                        creationAspect = asp.controller.getAspect('baseStatementCreateButtonAspect');
        ...
        {
            /*
            Аспект формирования Админ дела из обращения
            */
            xtype: 'gkhbuttonmultiselectwindowaspect',
            name: 'baseStatementToAdminCaseAspect',
            buttonSelector: '#baseStatementEditPanel [ruleId=BaseStatementToAdminCaseRule]',
            multiSelectWindow: 'SelectWindow.MultiSelectWindow',
            multiSelectWindowSelector: '#baseStatementToAdminCaseRuleSelectWindow',
            storeSelectSelector: '#realityobjForSelectStore',
            storeSelect: 'RealityObjectGjiForSelect',
            storeSelected: 'RealityObjectGjiForSelected',
            columnsGridSelect: [
        ...
        },
        {
            ...
            */
            ...
            onBeforeLoad: function (store, operation) {
                var panel = this.componentQuery(this.controller.baseStatementEditPanelSelector);
                
                if (!operation.params) {
                    operation.params = {};
                }
                
                operation.params['excludeIds'] = panel.PrimaryAppealCitizenId;
            }
        },
        {
            /* 
