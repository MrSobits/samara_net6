    ...
    build: function (store, records) {
        ...
        if (!this.isBuilt) {
            if (records.length > 0) {
                        ...
                        '<div class="task-list">',
                             '<div class="legend-item">',
                                 '<ul class="squares max">',
                                    ...
                                    '<li class="white" data-qtip="Задачи, по которым не сформированы необходимые документы">Нет документа</li>',
                                 '</ul>',
                             '</div>',
                             '<div class="head-item">',
                             ...
                             '<div class="task-list-item">',
                                 '<div class="task-list-item-inner">',
                                     ...
                                     '</div>',
                                     '<div class="pull-right">',
                                         '<ul class="squares" typeWidget="protocol">',
                                             '<li class="red">' + (recordsDict.containsKey('80') ? recordsDict.get('80').red : 0) + '</li>',
                                             '<li class="yellow">' + (recordsDict.containsKey('80') ? recordsDict.get('80').yellow : 0) + '</li>',
                                             '<li class="green">' + (recordsDict.containsKey('80') ? recordsDict.get('80').green : 0) + '</li>',
                                             '<li class="white">' + (recordsDict.containsKey('80') ? recordsDict.get('80').white : 0) + '</li>',
                                         '</ul>',
                                     '</div>',
                                     '<div class="clearfix"></div>',
                                 '</div>',
                ...
                Ext.select('ul[typeWidget="protocol"] li').on('click', function () {
                    var typeReminder = 80,
                        colorType = this.getAttribute('class');
