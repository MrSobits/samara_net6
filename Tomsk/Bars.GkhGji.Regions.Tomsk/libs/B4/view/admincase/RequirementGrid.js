Ext.define('B4.view.admincase.RequirementGrid', {
    ...
    requires: [
        ...
        'B4.store.admincase.Requirement'
    ],

    alias: 'widget.admincaserequirementgrid',
    title: 'Требования',
    
    initComponent: function() {
        var me = this,
            store = Ext.create('B4.store.admincase.Requirement');
