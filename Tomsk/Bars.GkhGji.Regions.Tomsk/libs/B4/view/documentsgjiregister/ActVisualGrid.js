Ext.define('B4.view.documentsgjiregister.ActVisualGrid', {
    ...
    title: 'Акты визуального осмотра',
    store: 'view.ActVisual',
    itemId: 'docsGjiRegisterActVisualGrid',
                    ...
                    filter: {
                        ...
                        listeners: {
                            storebeforeload: function (field, store, options) {
                                options.params.typeId = 'gji_document_actvisual';
                            },
                            storeloaded: {
                                fn: function (me) {
