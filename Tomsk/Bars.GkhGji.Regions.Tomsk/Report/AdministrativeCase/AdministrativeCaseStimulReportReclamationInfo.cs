namespace Bars.GkhGji.Regions.Tomsk.Report.AdministrativeCase
{
    ...
    public class AdministrativeCaseStimulReportReclamationInfo : GkhBaseStimulReport
     
    {
        ...
        public AdministrativeCaseStimulReportReclamationInfo()
            : base(new ReportTemplateBinary(Properties.Resources.AdminCaseReclamationInfo))
        {
        }
        ...
        /// Id
        /// </summary>
        public override string Id => "AdminCaseReclamationInfo";
        ...
        /// Название
        /// </summary>
        public override string Name => "Определение об истребование сведени";

        /// <summary>
        /// Комментарий  
        /// </summary>
        public override string Description => "Определение об истребование сведени";
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Code = "TomskAdminCaseReclamationInfo",
                    Name = "AdminCaseReclamationInfo",
                    Description = "Определение об истребовании",
                    Template = Properties.Resources.AdminCaseReclamationInfo
                }
            };
        }
