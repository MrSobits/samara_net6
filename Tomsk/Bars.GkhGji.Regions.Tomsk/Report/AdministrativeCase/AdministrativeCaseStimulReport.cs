namespace Bars.GkhGji.Regions.Tomsk.Report.AdministrativeCase
{
    ...
    using GkhGji.Enums;
    public class AdministrativeCaseStimulReport : GkhBaseStimulReport
    {
        ...
        public AdministrativeCaseStimulReport()
            : base(new ReportTemplateBinary(Properties.Resources.AdministrativeCase))
        {
        }
        ...
        /// Id
        /// </summary>
        public override string Id => "AdministrativeCase";
        ...
        /// Название
        /// </summary>
        public override string Name => "Административ. дело";

        /// <summary>
        /// Комментарий  
        /// </summary>
        public override string Description => "Административное дело";
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Code = "TomskAdministrativeCase",
                    Name = "AdministrativeCase",
                    Description = "Административное дело",
                    Template = Properties.Resources.AdministrativeCase
                }
            };
        }
