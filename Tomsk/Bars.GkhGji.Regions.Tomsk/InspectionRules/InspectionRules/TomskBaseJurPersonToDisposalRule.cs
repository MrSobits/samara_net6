namespace Bars.GkhGji.Regions.Tomsk.InspectionRules
{
    ...
    /// </summary>
    public class TomskBaseJurPersonToDisposalRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseJurPersonToDisposalRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Распоряжения из основания плановой проверки ЮЛ"; }
        }
        ...
        {
            get { return TypeBase.PlanJuridicalPerson; }
        }
