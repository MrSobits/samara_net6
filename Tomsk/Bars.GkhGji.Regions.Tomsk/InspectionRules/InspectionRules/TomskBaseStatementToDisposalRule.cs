namespace Bars.GkhGji.Regions.Tomsk.InspectionRules
{
    ...
    /// </summary>
    public class TomskBaseStatementToDisposalRule : IInspectionGjiRule
    {
		/// <summary>
		/// Контейнер
		/// </summary>
		...
		public string Id
        {
            get { return "BaseStatementToDisposalRule"; }
        }
        ...
        {
            get { return "Правило создание документа Распоряжения из основания проверки по обращению"; }
        }
