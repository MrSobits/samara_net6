namespace Bars.GkhGji.Regions.Tomsk.InspectionRules
{
    ...
    /// </summary>
    public class TomskBaseLicenseAppToActVisualRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseLicenseAppToActVisualRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Акта визуального осмотра из основания проверки соискателей лицензии"; }
        }
