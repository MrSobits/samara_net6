namespace Bars.GkhGji.Regions.Tomsk.InspectionRules
{
    ...
    /// </summary>
    public class TomskBaseProsClaimToDisposalRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseProsClaimToDisposalRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Распоряжения по основанию Проверки по требованию прокуратуры"; }
        }
        ...
        {
            get { return TypeBase.ProsecutorsClaim; }
        }
