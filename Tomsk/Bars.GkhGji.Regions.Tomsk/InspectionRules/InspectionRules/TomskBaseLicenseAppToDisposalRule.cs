namespace Bars.GkhGji.Regions.Tomsk.InspectionRules
{
    ...
    /// </summary>
    public class TomskBaseLicenseAppToDisposalRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseLicenseAppToDisposalRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Распоряжения из основания проверки соискателей лицензии"; }
        }
