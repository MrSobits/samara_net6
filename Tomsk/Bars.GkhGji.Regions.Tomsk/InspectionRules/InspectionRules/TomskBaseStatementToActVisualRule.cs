namespace Bars.GkhGji.Regions.Tomsk.InspectionRules
{
    ...
    /// </summary>
    public class TomskBaseStatementToActVisualRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseStatementToActVisualRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Акта визуального осмотра из основания проверки по обращению"; }
        }
