namespace Bars.GkhGji.Regions.Tomsk.InspectionRules
{
    ...
    /// </summary>
    public class TomskBaseStatementToAdminCaseRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseStatementToAdminCaseRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Администраивного дела из основания проверки по обращению"; }
        }
