namespace Bars.Gkh.Overhaul.Nso.Migration.Version_2013121002
{
    using System.Data;
    ...
    [global::Bars.B4.Modules.Ecm7.Framework.MigrationDependsOn(typeof(global::Bars.Gkh.Overhaul.Nso.Migration.Version_2013121001.UpdateSchema))]
    public class UpdateSchema : global::Bars.B4.Modules.Ecm7.Framework.Migration
    {
        public override void Up()
        {
            ...
            //                         ALTER TABLE OVRHL_PROP_OWN_DEC_REGOP ALTER COLUMN REG_OPERATOR_ID DROP NOT NULL;");

            if (Database.DatabaseKind == DbmsKind.Oracle)
            {
                Database.ExecuteNonQuery(@"ALTER TABLE OVRHL_PROP_OWN_DECISION_BASE MODIFY PROP_OWNER_PROTOCOL_ID NULL");
            }
               //Database.For<OracleDialect>()
               //     .ExecuteNonQuery(@"ALTER TABLE OVRHL_PROP_OWN_DEC_REGOP MODIFY REG_OPERATOR_ID NULL");
            ...
            Database.AddEntityTable(
                ...
                new Column("NOTICE_NUMBER", DbType.String, 250),
                 ...
                 new Column("NOTICE_NUM", DbType.Int32),
