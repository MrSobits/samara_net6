namespace Bars.Gkh.Overhaul.Nso.Migration.Version_1
{
    using System.Data;
    ...
    public class UpdateSchema : global::Bars.B4.Modules.Ecm7.Framework.Migration
    {
        ...
        {
            //Миграция перенесена в базовый модуль Overhaul, не удалять эту миграцию
        ...
        public override void Down()
        {
            ...
            // Аттрибут группы конструктивных элементов
            Database.RemoveEntityTable("OVRHL_STRUCT_EL");

             // Аттрибут группы конструктивных элементов
            Database.RemoveEntityTable("OVRHL_STRUCT_EL_GROUP_ATR");

            // Группа конструктивных элементов
            Database.RemoveEntityTable("OVRHL_STRUCT_EL_GROUP");

            // Объект общего имущества
            Database.RemoveEntityTable("OVRHL_COMMON_ESTATE_OBJECT");

            // Расценки работ
            Database.RemoveEntityTable("OVRHL_DICT_CEO_GROUP_TYPE");

            // Расценки работ
            Database.RemoveEntityTable("GKH_DICT_WORK_PRICE");*/
        }
    }
}