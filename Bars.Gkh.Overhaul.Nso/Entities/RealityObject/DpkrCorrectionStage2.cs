namespace Bars.Gkh.Overhaul.Nso.Entities
{
    ...
    public class DpkrCorrectionStage2 : BaseEntity
    {
        ...
        /// <summary>
        /// Строка субсидирования. Используется только для вычислений, в базе не хранится
        /// </summary>
        [Obsolete("Не использовать в запросах и т.п.")]
        public virtual SubsidyMunicipalityRecord SubsidyMunicipalityRecord { get; set; }
    }
}