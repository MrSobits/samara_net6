...
namespace Bars.Gkh.Overhaul.Nso.Map
{
    ...
    /// <summary>Маппинг для "Bars.Gkh.Overhaul.Nso.Entities.MinFundSizeDecision"</summary>
    public class MinFundSizeDecisionMap : JoinedSubClassMap<MinFundSizeDecision>
    {
        
        public MinFundSizeDecisionMap() : 
                base("Bars.Gkh.Overhaul.Nso.Entities.MinFundSizeDecision", "OVRHL_PR_DEC_MIN_FUND_SIZE")
        {
        }
