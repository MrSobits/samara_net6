...
namespace Bars.Gkh.Overhaul.Nso.Map
{
    ...
    /// <summary>Маппинг для "Bars.Gkh.Overhaul.Nso.Entities.MinAmountDecision"</summary>
    public class MinAmountDecisionMap : JoinedSubClassMap<MinAmountDecision>
    {
        
        public MinAmountDecisionMap() : 
                base("Bars.Gkh.Overhaul.Nso.Entities.MinAmountDecision", "OVRHL_PR_DEC_MIN_AMOUNT")
        {
        }
