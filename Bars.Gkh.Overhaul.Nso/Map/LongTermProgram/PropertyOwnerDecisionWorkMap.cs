...
namespace Bars.Gkh.Overhaul.Nso.Map
{
    ...
    /// <summary>Маппинг для "Bars.Gkh.Overhaul.Nso.Entities.PropertyOwnerDecisionWork"</summary>
    public class PropertyOwnerDecisionWorkMap : BaseEntityMap<PropertyOwnerDecisionWork>
    {
        
        public PropertyOwnerDecisionWorkMap() : 
                base("Bars.Gkh.Overhaul.Nso.Entities.PropertyOwnerDecisionWork", "OVRHL_PROP_OWN_DECISION_WORK")
        {
        }
