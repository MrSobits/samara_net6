...
namespace Bars.Gkh.Overhaul.Nso.Map
{
    ...
    /// <summary>Маппинг для "Bars.Gkh.Overhaul.Nso.Entities.CurrentPrioirityParams"</summary>
    public class CurrentPrioirityParamsMap : BaseEntityMap<CurrentPrioirityParams>
    {
        
        public CurrentPrioirityParamsMap() : 
                base("Bars.Gkh.Overhaul.Nso.Entities.CurrentPrioirityParams", "OVRHL_CURR_PRIORITY")
        {
        }
