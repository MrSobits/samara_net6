namespace Bars.Gkh.Overhaul.Nso.Reports
{
    ...
    public class PublishedDpkrByWorkReport : BasePrintForm
    {
        ...
        public PublishedDpkrByWorkReport()
            : base(new ReportTemplateBinary(Properties.Resources.PublishProgramByWork))
        {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            var data =
                query.OrderBy(x => x.Address).Select(
                    x =>
                    new
                    {
                        x.MuId,
            ...
            foreach (var muData in data)
            {
                ...
                foreach (var roData in muData.Value)
                {
                    ...
                    while (currentYear <= maxYear)
                    {
                        ...
                        sectRealObj[string.Format("TypeWork{0}", currentYear)] = works.Any() ? works.AggregateWithSeparator(", ") : string.Empty;
