Ext.define('B4.controller.import.KpkrImport', {
    extend: 'B4.base.Controller',
    views: ['import.program.KpkrImportPanel'],

    mainView: 'import.program.KpkrImportPanel',
    mainViewSelector: 'nsoKpkrImportPanel',
    ...
    index: function () {
        var view = this.getMainView() || Ext.widget('nsoKpkrImportPanel');
    ...
    loadButtonClick: function () {
        ...
        me.params = {};
        me.params.importId = 'Bars.Gkh.Overhaul.Nso.Import.Program.KpkrProgramImport';
