                        ...
                        editor = {
                            ...
                            listeners: {
                                keydown: function(field, e) {
                                    if (e.keyCode > 47 && e.keyCode < 57 && field.value != null) { // цифры
    ...
    */
    onCalcShortProgram: function (btn) {
        ...
        B4.Ajax.request({
            ...
            me.unmask();
            Ext.Msg.alert('Формирование краткосрочной программы!', 'Расчет краткосрочной программы произведен успешно');
    ...
    validateGrid: function (grid) {
        ...
        */
            ...
            for (var j = 0; j < columnLength; j++) {
                ...
                for (var c = 0, len = subColumns.length; c < len; ++c) {
                    ...
                    if (dataIndex) {
                        ...
                        errors = me.validateCellValue(subColumns[c], value);
        ...
        if (!isValid) {
            Ext.Msg.alert('Ошибка ввода', errors);
        }
