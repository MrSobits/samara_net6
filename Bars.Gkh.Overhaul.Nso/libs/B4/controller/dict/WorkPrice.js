Ext.define('B4.controller.dict.WorkPrice', {
    ...
    aspects: [
        ...
        },
        {
            ...
            columnsGridSelect: [
                {
                    text: 'Муниципальный район', dataIndex: 'Name', flex: 2,
                    filter: {
                        xtype: 'b4combobox',
        ...
        if (!me.massAddWindow) {
            ...
            if (b4Combo && b4Combo.getStore() != undefined) {
                b4Combo.getStore().on('beforeload', function (store, operation) {
                    ...
                    operation.params.Municipality = me.isMunicipalityLevel ? sfMunicipality.getValue() : sfSettlement.getValue();
                });
            }
        }
