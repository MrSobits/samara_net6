namespace Bars.Gkh.Overhaul.Nso.ViewModel
{
    ...
    public class NsoWorkPriceViewModel : Bars.Gkh.Overhaul.ViewModel.WorkPriceViewModel<NsoWorkPrice>
    {
        public IRepository<Municipality> MunicipalityRepo { get; set; }
        public override IDataResult Get(IDomainService<NsoWorkPrice> domainService, BaseParams baseParams)
        {
