namespace Bars.Gkh.Overhaul.Nso.Interceptors
{
    ...
    public class NsoWorkPriceInterceptor : Bars.Gkh.Overhaul.Interceptors.WorkPriceInterceptor<NsoWorkPrice>
    {
        public override IDataResult CheckWorkPrice(IDomainService<NsoWorkPrice> service, NsoWorkPrice entity)
        {
