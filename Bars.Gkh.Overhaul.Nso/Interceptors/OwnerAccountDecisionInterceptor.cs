namespace Bars.Gkh.Overhaul.Nso.Interceptors
{
    ...
    public class OwnerAccountDecisionInterceptor : EmptyDomainInterceptor<OwnerAccountDecision>
    {
        public override IDataResult BeforeUpdateAction(IDomainService<OwnerAccountDecision> service, OwnerAccountDecision entity)
        {
