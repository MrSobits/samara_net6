namespace Bars.GisIntegration.Gkh.DataExtractors.HouseManagement.ContractData
{
    ...
    /// <summary>
    /// Экстрактор для протоколов собрания собственников ДУ собственников
    /// </summary>
    public class OwnersProtocolMeetingOwnerExtractor : BaseDataExtractor<ProtocolMeetingOwner, FileInfo>
    {
            ...
            try
            {
                if (externalEntity != null)
                {
                    ...
                    catch (FileNotFoundException)
                    {
                        ...
                        this.Log.Add(
                            new BaseLogRecord(MessageType.Info, "Файл протокола собрания собственников договора управления номер " + contract.ProtocolNumber + " не найден"));
                    }
                }
            }
