Ext.define('B4.form.FiasSelectAddressWindow', {
    ...
    fillAddressField: function () {
        ...
        if (me.tfFlat.getValue()) {
            result += (addSeparator ? ', ' : '') + 'кв.' + ' ' + me.tfFlat.getValue();
            addSeparator = true;
        }
        if (me.tfOffice.getValue()) {
            result += (addSeparator ? ', ' : '') + 'офис.' + ' ' + me.tfOffice.getValue();
            addSeparator = true;
        }
        if (me.tfRoom.getValue()) {
            result += (addSeparator ? ', ' : '') + 'помещение.' + ' ' + me.tfRoom.getValue();
            addSeparator = true;
        }
    ...
    initComponent: function () {
        ...
        this.tfOffice = Ext.create('Ext.form.TextField', {
            allowBlank: true,
            labelWidth: 120,
            labelAlign: 'right',
            flex: 1,
            ...
            listeners: {
                change: {
                    fn: function () {
                        this.tfRoom.setDisabled(this.tfOffice.getValue());
                        this.tfFlat.setDisabled(this.tfOffice.getValue());
                        this.fillAddressField();
                    },
                    scope: this
                }
        ...
        this.tfRoom = Ext.create('Ext.form.TextField', {
            allowBlank: true,
            labelWidth: 120,
            labelAlign: 'right',
            flex: 1,
            ...
            listeners: {
                change: {
                    fn: function () {
                        this.tfFlat.setDisabled(this.tfRoom.getValue());
                        this.tfOffice.setDisabled(this.tfRoom.getValue());
                        this.fillAddressField();
                    },
                    scope: this
                }
