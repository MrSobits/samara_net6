Ext.define('B4.controller.claimwork.IndividualClaimWork', {
    ...
    aspects: [
        ...
        },
        {
            ...
            codeForm: 'CourtClaimAccount, LawSuitAccount',
    ...
    onBeforeLoadIndividualClaimWork: function(store, operation) {
        ...
        var checked = view.down('#cbShowPausedClw').getValue();
        if (this.params) {
           
            operation.params.showPaused = this.params.showPaused;
    ...
    onChangeCheckbox: function (field, newValue) {
        ...
        paystore.filter('showPaused', newValue);
      //  view.getStore().load();
    },
