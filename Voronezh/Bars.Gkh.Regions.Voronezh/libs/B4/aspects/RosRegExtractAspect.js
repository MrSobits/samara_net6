/*
*Данный аспект предназначен для импорта данных лс?
*/

Ext.define('B4.aspects.RosRegExtractAspect', {
    extend: 'B4.base.Aspect',

    alias: 'widget.rosregextractaspect',
    mixins: {
    ...
    loadButtonClick: function () {
        ...
        formImport.submit({
            // ?
            url: B4.Url.action('/RosRegExtractImport/ImportNow'),
            //
            params: me.params,
