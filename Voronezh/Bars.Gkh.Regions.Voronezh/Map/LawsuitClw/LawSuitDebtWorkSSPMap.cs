namespace Bars.Gkh.Regions.Voronezh.Map
{
    ...
    public class LawSuitDebtWorkSSPMap : BaseEntityMap<LawSuitDebtWorkSSP>
    {
        ...
        protected override void Map()
        {
            ...
            this.Property(x => x.DutyPayedForcibly, "Взыскания долга - Оплачено пошлины принудительно").Column("CB_DUTY_PAY_FORC");
            this.Property(x => x.PenaltyPayedForcibly, "Взыскания долга - Оплачно пени принудительно").Column("CB_PENALTY_PAY_FORC");
            this.Property(x => x.TRPayedForcibly, "Взыскания долга - Оплачено по тарифу решения принудительно").Column("CB_TR__PAY_FORC");
            this.Property(x => x.BtPayedForcibly, "Взыскания долга - Оплачено по базовому тарифу принудительно").Column("CB_BT_PAY_FORC");
            this.Property(x => x.DutyPayed, "Взыскания долга - Оплачено пошлины Добровольно").Column("CB_DUTY_PAY_VOL");
            this.Property(x => x.PenaltyPayed, "Взыскания долга - Оплачено пени Добровольно").Column("CB_PENALTY_PAY_VOL");
            this.Property(x => x.TRPayed, "Взыскания долга - Оплачено по тарифу решения Добровольно").Column("CB_TR__PAY_VOL");
            this.Property(x => x.BtPayed, "Взыскания долга - Оплачено по базовому тарифу Добровольно").Column("CB_BT_PAY_VOL");
            this.Property(x => x.CbDuty, "Взыскания долга - Оплачено пошлины добровольно").Column("CB_DUTY");
            this.Property(x => x.CbDebtDecisionSum, "Взыскания долга - Задолженость по тарифу решения").Column("CB_DEBT_DECISION_SUM");
            this.Property(x => x.DebtWorkType, "Признак колличества заявлений").Column("DEBT_WORK_TYPE");
