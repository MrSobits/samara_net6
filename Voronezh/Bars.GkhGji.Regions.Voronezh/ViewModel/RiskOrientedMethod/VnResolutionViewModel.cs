namespace Bars.GkhGji.Regions.Voronezh.ViewModel
{
    ...
    public class VnResolutionViewModel : BaseViewModel<VnResolution>
    {
        public override IDataResult List(IDomainService<VnResolution> domainService, BaseParams baseParams)
        {
