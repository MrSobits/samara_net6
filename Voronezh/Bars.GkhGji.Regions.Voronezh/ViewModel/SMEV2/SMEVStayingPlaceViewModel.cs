namespace Bars.GkhGji.Regions.Voronezh.ViewModel
{
    ...
    public class SMEVStayingPlaceViewModel : BaseViewModel<SMEVStayingPlace>
    {
        public override IDataResult List(IDomainService<SMEVStayingPlace> domainService, BaseParams baseParams)
        {
