namespace Bars.GkhGji.Regions.Voronezh.StateChanges
{
    ...
    public class LicRequestAcceptRule : IRuleChangeStatus
    {
        /// <summary>
        ...
        public string Id
        {
            get { return "LicRequestAcceptRule"; }
        }
        ...
        public ValidateResult Validate(IStatefulEntity statefulEntity, State oldState, State newState)
        {
            ...
            {
                if (RPGUService.SendAcceptMessage(Convert.ToInt64(statefulEntity.Id), true))
                {
