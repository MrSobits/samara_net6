namespace Bars.GkhGji.Regions.Voronezh.StateChanges
{
    ...
    public class LicenseReissuanceDeclineRule : IRuleChangeStatus
    {
        /// <summary>
        ...
        public string Id
        {
            get { return "LicenseReissuanceDeclineRule"; }
        }
        ...
        public ValidateResult Validate(IStatefulEntity statefulEntity, State oldState, State newState)
        {
            ...
            {
                if (RPGUService.SendAcceptReissuanceMessage(Convert.ToInt64(statefulEntity.Id), false))
                {
