namespace Bars.GkhGji.Regions.Voronezh.StateChanges
{
    ...
    public class LicenseInfoRequestDeclineRule : IRuleChangeStatus
    {
        /// <summary>
        ...
        public string Id
        {
            get { return "LicenseInfoRequestDeclineRule"; }
        }
        ...
        public ValidateResult Validate(IStatefulEntity statefulEntity, State oldState, State newState)
        {
            ...
            {
                if (RPGUService.SendLicActionAcceptMessage(Convert.ToInt64(statefulEntity.Id), false))
                {
