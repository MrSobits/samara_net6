namespace Bars.GkhGji.Regions.Voronezh.StateChange
{
    ...
    public class ComplaintsSentExecutatnRule : IRuleChangeStatus
    {
        /// <summary>
        ...
        public string Id
        {
            get { return "ComplaintsSentExecutatnRule"; }
        }

        public string Name { get { return "Назначение исполнителя"; } }
        public string TypeId { get { return "gji_smev_complaints"; } }
        public string Description
        {
            get
            {
                return "При переводе статуса будет отправлен запрос о назначении исполнителя заявки на досудебное обжалование";
            }
        }
