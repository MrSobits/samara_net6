namespace Bars.GkhGji.Regions.Voronezh.Map
{
    ...
    public class SMEVMVDMap : BaseEntityMap<SMEVMVD>
    {
        ...
        protected override void Map()
        {
            ...
            Reference(x => x.Contragent, "Дата запроса").Column("CONTRAGENT_ID");
            Reference(x => x.Person, "Person").Column("PERSON_ID");
            Reference(x => x.ContragentContact, "Дата запроса").Column("CONTACT_ID");
