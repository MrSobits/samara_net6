    ...
    public class GISERPService : IGISERPService
    {
        ...
        public object GetInspectionInfo(BaseParams baseParams)
        {
            ...
            if (protocolData > 0)
            {
                        ...
                        case TypeBase.CitizenStatement:
                            {
                                ...
                                inspType = ERPInspectionType.VP;
                                inspectionName = $"Проверка по обращению № {inspAppcit.AppealCits.DocumentNumber} от {inspAppcit.AppealCits.DateFrom.Value.ToShortDateString()}";
                ...
                var data = new { inspType, adrtype, noticeType, objType, oktmo, reasonType, riskType, inspectionName, carryoutEvents, subjectAddress, dateStart, prosOffice, goals, kindKnd, ACT_DATE_CREATE,
                    REPRESENTATIVE_FULL_NAME,
                    REPRESENTATIVE_POSITION, START_DATE, DURATION_HOURS, HasViolations};
        ...
        private XElement GetInitiationOrCorrection(GISERP requestData)
        {
            ...
            if (requestData.KindKND == KindKND.LicenseControl)
            {
                ...
                FRGU_SERV_ID_BK = "3640000010000306797";
            }
            else
            {
                ISUPERVISION_ID = "SPV_1009";
                FRGU_SERV_ID_BK = "3640000010000026981";
            }
                ...
                return new XElement(erp_typesNamespace + "Initialization",
                    new XElement(erp_typesNamespace + "INSPECTION",
                        ...
                        new XElement(erp_typesNamespace + "DOMAIN_OKATO",
                            ...
                            new XAttribute("OKATO_TER", "20"),
                            new XAttribute("FEDERAL_DISTRICT", "030")
                        ),
                        new XElement(erp_typesNamespace + "I_AUTHORITY",
                            new XAttribute("ADDRESS", "394018, г. Воронеж, ул. Кирова, д. 6а, 13 этаж"),
                            new XAttribute("FRGU_ORG_ID_BK", "3640000010000024201"),
        ...
        private List<XElement> GetResult(Disposal disposal, string ICARRYOUT_TYPE_ID, string SubjectAddress, string ADDRESS_TYPE_ID)
        {
            ...
            {
                SubjectAddress = "394018, г. Воронеж, ул. Кирова, д. 6а";
