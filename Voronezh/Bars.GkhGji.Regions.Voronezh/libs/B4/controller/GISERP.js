Ext.define('B4.controller.GISERP', {
    ...
    aspects: [
        {
            ...
            buttonSelector: 'giserpgrid #btnExport',
            controllerName: 'GISERPExecute',
            actionName: 'Export'
        },
        {
            ...
            otherActions: function (actions) {
                ...
                actions['giserpgrid #dfDateStart'] = { 'change': { fn: this.onChangeDateStart, scope: this } };
                actions['giserpgrid #dfDateEnd'] = { 'change': { fn: this.onChangeDateEnd, scope: this } };
    ...
    init: function () {
        var me = this;
        me.params = {};
        this.getStore('smev.GISERP').on('beforeload', this.onBeforeLoadDoc, this);
    ...
    onLaunch: function () {
        ...
        if (this.params && this.params.get('Id') > 0) {
            this.getAspect('giserpgridButtonExportAspect').editRecord(this.params);
            this.params = null;
        }
    },
    ...
    onLaunch: function () {
        var grid = this.getMainView();
        if (this.params && this.params.get('Id') > 0) {
            this.getAspect('giserpGridAspect').editRecord(this.params);
            this.params = null;
        }
    },
    ////////////////////
