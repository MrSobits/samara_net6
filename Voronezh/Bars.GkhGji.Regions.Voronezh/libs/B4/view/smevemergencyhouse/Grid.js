Ext.define('B4.view.smevemergencyhouse.Grid', {
    extend: 'B4.ux.grid.Panel',
    
    alias: 'widget.smevemergencyhousegrid',
    ...
    title: 'Реестр запросов о признании дома аварийным',
    store: 'smevemergencyhouse.SMEVEmergencyHouse',
    closable: true,
