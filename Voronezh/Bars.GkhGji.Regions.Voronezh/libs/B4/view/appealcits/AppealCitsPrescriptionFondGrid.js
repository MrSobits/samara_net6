Ext.define('B4.view.appealcits.AppealCitsPrescriptionFondGrid', {
    extend: 'B4.ux.grid.Panel',
    
    alias: 'widget.appealCitsPrescriptionFondGrid',
    ...
    title: 'Предписания',
    store: 'appealcits.AppealCitsPrescriptionFond',
    itemId: 'appealCitsPrescriptionFondGrid',
