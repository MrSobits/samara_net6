namespace Bars.GisIntegration.Base.DataExtractors
{
    ...
    public abstract class BaseDataExtractor<TRisEntity, TExternalEntity> : IDataExtractor<TRisEntity>, IDataSelector<TExternalEntity>
        where TRisEntity: BaseRisEntity, new()
        where TExternalEntity : PersistentObject
    {
        ...
        public List<TRisEntity> Extract(DynamicDictionary parameters = null)
        {
            ...
            this.AfterSaveRisEntities(result);
        ...
        /// <summary>
        /// Выполнить обработку после сохранения Ris сущностей
        /// Например, сохранить зависимые сущности
        /// </summary>
        /// <param name="risEntities">Ris сущности</param>
        protected virtual void AfterSaveRisEntities(List<TRisEntity> risEntities)
        {
        }
