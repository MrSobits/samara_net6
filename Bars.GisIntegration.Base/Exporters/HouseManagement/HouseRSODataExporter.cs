namespace Bars.GisIntegration.Base.Exporters.HouseManagement
{
    ...
    /// </summary>
    public class HouseRSODataExporter : BaseDataExporter
    {
        /// <summary>
        /// Наименование метода
        /// </summary>
        public override string Name => "Экспорт сведений о доме для ресурсоснабжающих организаций";
        ...
        /// </summary>
        public override Type SendDataTaskType => typeof(HouseRSOExportDataTask);

        /// <summary>
        /// Тип задачи подготовки данных
        /// </summary>
        public override Type PrepareDataTaskType => typeof(HouseRSOPrepareDataTask);
    }
}
