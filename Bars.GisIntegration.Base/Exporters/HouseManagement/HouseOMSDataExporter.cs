namespace Bars.GisIntegration.Base.Exporters.HouseManagement
{
    ...
    /// </summary>
    public class HouseOMSDataExporter: BaseDataExporter
    {
        /// <summary>
        /// Наименование метода
        /// </summary>
        public override string Name => "Экспорт сведений о доме для органов местного самоуправления";
        ...
        /// </summary>
        public override Type SendDataTaskType => typeof(HouseOMSExportDataTask);

        /// <summary>
        /// Тип задачи подготовки данных
        /// </summary>
        public override Type PrepareDataTaskType => typeof(HouseOMSPrepareDataTask);
    }
}
