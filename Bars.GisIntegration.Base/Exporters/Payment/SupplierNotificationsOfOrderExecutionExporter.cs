namespace Bars.GisIntegration.Base.Exporters.Payment
{
    ...
    public class SupplierNotificationsOfOrderExecutionExporter : BaseDataExporter
    {
        ...
        /// </summary>
        public override Type SendDataTaskType => typeof(ExportSupplierNotificationsOfOrderExecutionTask);

        /// <summary>
        /// Тип задачи подготовки данных
        /// </summary>
        public override Type PrepareDataTaskType => typeof(SupplierNotificationsOfOrderExecutionPrepareDataTask);
    }
}
