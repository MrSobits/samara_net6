namespace Bars.GisIntegration.Base.Map.Infrastructure
{
    ...
    public class RisRkiItemMap : BaseRisEntityMap<RisRkiItem>
    {
        ...
        protected override void Map()
        {
            ...
            this.Reference(x => x.FiasAddress, "FiasAddress").Column("FIAS_ADDRESS_ID").Fetch();
            ...
            this.Property(x => x.CommissioningYear, "CommissioningYear").Column("COMMISSIONING_YEAR");
        }
    }
}
