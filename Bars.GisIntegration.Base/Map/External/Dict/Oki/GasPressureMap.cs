namespace Bars.GisIntegration.Base.Map.External.Dict.Oki
{
    ...
    /// <summary>
    /// Маппинг для Bars.Ris.Contragent.Entities.GasPressure
    /// </summary>
    public class GasPressureMap : BaseEntityMap<GasPressure>
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public GasPressureMap() :
            base("NSI_GAS_PRESSURE")
        {
            ...
            this.Id(x => x.Id, m =>
            {
                m.Column("GAS_PRESSURE_ID");
                m.Generator(Generators.Native);
            });
            this.Map(x => x.Value, "GAS_PRESSURE");
