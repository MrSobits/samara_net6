namespace Bars.GisIntegration.Base.Map.HouseManagement
{
    ...
    /// <summary>
    /// Маппинг для "Bars.GisIntegration.RegOp.Entities.HouseManagement.RisHouse"
    /// </summary>
    public class RisHouseMap : BaseRisEntityMap<RisHouse>
    {
        public RisHouseMap() :
            base("Bars.GisIntegration.RegOp.Entities.HouseManagement.RisHouse", "RIS_HOUSE")
        {
        }
        ...
        protected override void Map()
        {
            ...
            this.Property(x => x.ConditionalNumber, "ConditionalNumber").Column("CONDITIONAL_NUMBER");
            this.Property(x => x.Value, "Value").Column("VALUE");
            this.Property(x => x.Code, "Code").Column("CODE");
            this.Property(x => x.Type, "Type").Column("TYPE");
            this.Property(x => x.RegNumber, "RegNumber").Column("REG_NUMBER");
            this.Property(x => x.RegDate, "RegDate").Column("REG_DATE");
        }
    }
}