namespace Bars.GisIntegration.Base.Map.HouseManagement
{
    ...
    public class RisPublicPropertyContractMap : BaseRisEntityMap<RisPublicPropertyContract>
    {
        ...
        {
            this.Property(x => x.ProtocolGuid, "ProtocolGuid").Column("PROTOCOLGUID").Length(50);
            ...
            this.Reference(x => x.AddAgreementPayment, "AddAgreementPayment").Column("ADDAGREEMENTPAYMENT_ID").Fetch();
        }
    }
}
