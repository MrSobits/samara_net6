namespace Bars.GisIntegration.Base.Tasks.PrepareData.Payment
{
    ...
    public class SupplierNotificationsOfOrderExecutionPrepareDataTask : BasePrepareDataTask<importSupplierNotificationsOfOrderExecutionRequest>
    {
        ...
        {
            var itemElementName = string.IsNullOrEmpty(notification.ServiceID) ? ItemChoiceType1.PaymentDocumentID : ItemChoiceType1.ServiceID;
        ...
        private List<IEnumerable<NotificationOfOrderExecution>> GetPortions()
        {
            ...
            if (this.notifications.Count > 0)
            {
                ...
                do
                {
                    result.Add(this.notifications.Skip(startIndex).Take(SupplierNotificationsOfOrderExecutionPrepareDataTask.Portion));
                    startIndex += SupplierNotificationsOfOrderExecutionPrepareDataTask.Portion;
                }
