namespace Bars.GisIntegration.Base.Tasks.SendData.Payment
{
    ...
    /// <summary>
    /// Задача отправки данных документов «Извещение о принятии к исполнению распоряжения»
    /// </summary>
    public class ExportNotificationsOfOrderExecutionTask : BaseSendDataTask<importNotificationsOfOrderExecutionRequest, getStateResult, PaymentPortsTypeAsyncClient, RequestHeader>
    {
        /// <summary>
        ...
        protected override string ExecuteRequest(RequestHeader header, importNotificationsOfOrderExecutionRequest request)
        {
            ...
            if (soapClient != null)
            {
                soapClient.importNotificationsOfOrderExecution(header, request, out result);
            }
