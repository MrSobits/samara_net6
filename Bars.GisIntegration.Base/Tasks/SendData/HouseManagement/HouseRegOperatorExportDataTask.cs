namespace Bars.GisIntegration.Base.Tasks.SendData.HouseManagement
{
    ...
    /// <summary>
    /// Задача отправки данных по домам для регионального оператора (используется метод импорта домов для РСО)
    /// </summary>
    public class HouseRegOperatorExportDataTask : BaseExportHouseDataTask<importHouseRSORequest>
    {
        /// <summary>
