namespace Bars.GisIntegration.Base.Tasks.SendData.Bills
{
    ...
    /// </summary>
    public class ExportAcknowledgmentTask : BaseSendDataTask<importAcknowledgmentRequest, getStateResult, BillsPortsTypeAsyncClient, RequestHeader>
    {
        /// <summary>
        ...
        protected override string ExecuteRequest(RequestHeader header, importAcknowledgmentRequest request)
        {
            AckRequest result;
            ...
            soapClient.importAcknowledgment(header, request, out result);
