...
namespace Bars.GkhGji.Regions.Zabaykalye.Interceptors
{
    ...
    public class ResolutionDefInterceptor : ResolutionDefinitionInterceptor<ZabaykalyeResolutionDefinition>
    {
        public IDefinitionService DefinitionService { get; set; }

        public override IDataResult BeforeUpdateAction(IDomainService<ZabaykalyeResolutionDefinition> service, ZabaykalyeResolutionDefinition entity)
        {
        ...
        public override IDataResult BeforeCreateAction(IDomainService<ZabaykalyeResolutionDefinition> service, ZabaykalyeResolutionDefinition entity)
        {
            return CreateNumber(entity);
        }

        private IDataResult CreateNumber(ZabaykalyeResolutionDefinition entity)
        {
