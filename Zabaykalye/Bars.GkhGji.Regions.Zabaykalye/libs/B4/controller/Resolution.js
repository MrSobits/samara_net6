Ext.define('B4.controller.Resolution', {
    ...
    aspects: [
        ...
        },
        {
            ...
            */
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                this.controller.getAspect('resolutionAdminOffenseBlobDescriptionAspect').doInjection();
        ...
        },
        {
            ...
            name: 'resolutionAdminOffenseBlobDescriptionAspect',
            fieldSelector: '#taDescriptionResolution',
            editPanelAspectName: 'resolutionEditPanelAspect',
            editPanelSelector: 'resolutionRequisitePanel',
            controllerName: 'ZabaykalyeResolution',
