Ext.define('B4.controller.ProtocolGji', {
    ...
    views: [
        ...
        'protocolgji.ViolationGroupGrid',
        'protocolgji.ViolationGroupEditWindow'
    ],
    ...
    aspects: [
        ...
        {   /*
            ...
            */
            ...
            onSelectRealityObjViolationGrid: function (rowModel, record, index, opt) {
                ...
                this.controller.getStore('protocolgji.ViolationGroup').load();
            },
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                this.controller.getAspect('protocolAdminOffenseBlobDescriptionAspect').doInjection();
        ...
        },
        {
            ...
            */
            xtype: 'grideditwindowaspect',
            name: 'protocolgjiViolGroupAspect',
            gridSelector: 'protocolgjiViolationGroupGrid',
            editFormSelector: 'protocolgjiViolationGroupEditWindow',
            storeName: 'protocolgji.ViolationGroup',
            modelName: 'violationgroup.ViolationGroup',
            editWindowView: 'protocolgji.ViolationGroupEditWindow',
        ...
        },
        {
            ...
            name: 'protocolgjiBlobDescriptionAspect',
            fieldSelector: '[name=Description]',
            editPanelAspectName: 'protocolgjiViolGroupAspect',
        ...
        {
            xtype: 'gkhblobtextaspect',
            name: 'protocolAdminOffenseBlobDescriptionAspect',
            fieldSelector: '#taDescriptionProtocol',
            editPanelAspectName: 'protocolEditPanelAspect',
            editPanelSelector: 'protocolgjiRequisitePanel',
            controllerName: 'ZabaykalyeProtocol',
            valueFieldName: 'Description',
            previewLength: 250,
            autoSavePreview: true,
            previewField: 'Description',
    ...
    init: function () {
        this.getStore('protocolgji.ViolationGroup').on('beforeload', this.onBeforeLoadViolGroup, this);
    ...
    onLoadRealityObjectViolation: function (store) {
        var storeViol = this.getStore('protocolgji.Violation'),
            storeViolGroup = this.getStore('protocolgji.ViolationGroup');
