Ext.define('B4.controller.ActSurvey', {
    ...
    requires: [
        ...
        'B4.aspects.permission.ZabaykalyeActSurvey',
    ...
    views: [
        ...
        'actsurvey.ConclusionGrid',
        'actsurvey.ConclusionEditWindow',
        'actsurvey.OwnerGrid',
        'actsurvey.PhotoGrid',
    ...
    aspects: [
            ...
            */
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                B4.Ajax.request(B4.Url.action('GetInfo', 'ActSurvey', {
                    ...
                    var coclusionGrid = panel.down('actSurveyConclusionGrid');
                    if (obj.disposalCode === 8) {
                        coclusionGrid.tab.show();
                    } else {
                        coclusionGrid.tab.hide();
                    }
                ...
                me.controller.getAspect('actSurveyStateButtonAspect').setStateData(rec.get('Id'), rec.get('State'));
                //обновляем стор отчетов
                me.controller.getAspect('actSurveyPrintAspect').loadReportStore();
        ...
        {
            /*
            Аспект взаимодействия Таблицы заключений с формой редактирования
            */
            xtype: 'grideditwindowaspect',
            name: 'actSurveyConclusionAspect',
            gridSelector: 'actSurveyConclusionGrid',
            editFormSelector: 'actSurveyConclusionEditWindow',
            storeName: 'actsurvey.Conclusion',
            modelName: 'actsurvey.Conclusion',
            editWindowView: 'actsurvey.ConclusionEditWindow',
            listeners: {
                getdata: function (asp, record) {
                    if (!record.get('Id')) {
                        record.set('ActSurvey', this.controller.params.documentId);
    ...
    init: function () {
        ...
        this.getStore('actsurvey.Conclusion').on('beforeload', this.onObjectBeforeLoad, this);
    },
    ...
    onLaunch: function () {
        if (this.params) {
            ...
            //Обновляем стор фотографий
            this.getStore('actsurvey.Conclusion').load();
        }
    },
