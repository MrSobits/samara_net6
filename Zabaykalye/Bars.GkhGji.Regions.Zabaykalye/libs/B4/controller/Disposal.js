    ...
    aspects: [
        {
            ...
            */
            ...
            onValidateUserParams: function (params) {
                ...
                if (params.ruleId == 'DisposalToActCheckByRoRule' || params.ruleId == 'DisposalToActSurveyRule' || params.ruleId == 'ZabaykalyeDisposalToActViewRule') {
                    return false;
                }
        ...
        },
        {
            ...
            */
            ...
            otherActions: function(actions) {
                ...
                actions[this.editPanelSelector + ' #DocumentDate'] = { 'change': { fn: this.onChangeDocumentDate, scope: this } };
            },
            ...
            onChangeDocumentDate: function (field, newValue) {
                var me = this;
                if (newValue && Ext.isDate(newValue)) {
                    me.getPanel().down('#dfDateStart').setValue(Ext.Date.add(newValue, Ext.Date.DAY, 1));
                    me.getPanel().down('#dfDateEnd').setValue(Ext.Date.add(newValue, Ext.Date.DAY, 19));
                }
            },
        ...
        },
        {
            ...
            buttonSelector: '#disposalEditPanel [ruleId=ZabaykalyeDisposalToActViewRule]',
