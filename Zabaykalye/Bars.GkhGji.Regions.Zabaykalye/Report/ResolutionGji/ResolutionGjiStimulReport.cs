namespace Bars.GkhGji.Regions.Zabaykalye.Report
{
    ...
    public class ResolutionGjiStimulReport : GjiBaseStimulReport
    {
        ...
        public ResolutionGjiStimulReport()
            : base(new ReportTemplateBinary(Properties.Resources.ZabaykalyeResolution))
        {
        }
            ...
            return new List<TemplateInfo>
                       {
                           new TemplateInfo
                               {
                                   Code = "ZabaykalyeResolution_1",
                                   Name = "ZabaykalyeResolution_1",
                                   Description =
                                       "Постановление предупреждение (Вид санкции: 'Предупреждение''\''устное замечание')",
                                   Template = Properties.Resources.ZabaykalyeResolution
                               },
                           new TemplateInfo
                               {
                                   Code = "ZabaykalyeResolution_2",
                                   Name = "ZabaykalyeResolution_2",
                                   Description =
                           ...
                           new TemplateInfo
                               {
                                   Code = "ZabaykalyeResolution_3",
                                   Name = "ZabaykalyeResolution_3",
                                   Description =
                           ...
                           new TemplateInfo
                               {
                                   Code = "ZabaykalyeResolution_4",
                                   Name = "ZabaykalyeResolution_4",
                                   Description =
        ...
        private void GetCodeTemplate()
        {
            ...
            try
            {
                this.CodeTemplate = "ZabaykalyeResolution_1";
                ...
                if (this.Document.Sanction != null)
                {
                    switch (this.Document.Sanction.Name)
                    {
                        ...
                        case "Административный штраф":
                            this.CodeTemplate = "ZabaykalyeResolution_2";
                            break;

                        case "Прекращено":
                            {
                                this.CodeTemplate = "ZabaykalyeResolution_3";
                                ...
                                {
                                    this.CodeTemplate = "ZabaykalyeResolution_4";
                                }
                            }
