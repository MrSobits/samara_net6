namespace Bars.GkhGji.Regions.Zabaykalye.Report
{
    ...
    public class ActSurveyGjiReport : GjiBaseStimulReport
    {
        ...
        public IDomainService<ZabaykalyeActSurvey> ZabaykalyeActSurveyDomain { get; set; }
        ...
        {
            var actSurvey = ZabaykalyeActSurveyDomain.Load(DocumentId);
            if (actSurvey == null)
            {
