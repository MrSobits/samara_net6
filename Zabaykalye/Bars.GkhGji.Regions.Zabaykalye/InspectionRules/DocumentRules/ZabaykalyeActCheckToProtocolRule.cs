namespace Bars.GkhGji.Regions.Zabaykalye.InspectionRules
{
    ...
    /// В САХЕ меняется работа с нарушениями потому что выбираются не нарушения а описания
    /// </summary>
    public class ZabaykalyeActCheckToProtocolRule : IDocumentGjiRule
    {
        ...
        public IDataResult ValidationRule(DocumentGji document)
        {
            ...
            {
                return new BaseDataResult(false, "В Сахе для Акта проверки предписания нельзя формировать протокол");
            }
