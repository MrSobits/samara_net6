...
namespace Bars.GkhGji.Regions.Zabaykalye.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Zabaykalye.Entities.ResolutionLongDescription"</summary>
    public class ResolutionLongDescriptionMap : BaseEntityMap<ResolutionLongDescription>
    {
        
        public ResolutionLongDescriptionMap() : 
                base("Bars.GkhGji.Regions.Zabaykalye.Entities.ResolutionLongDescription", "GJI_RESOLUTION_LONGDESC")
        {
        }
