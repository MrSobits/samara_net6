...
namespace Bars.GkhGji.Regions.Zabaykalye.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Zabaykalye.Entities.ResolProsDefinition"</summary>
    public class ResolProsDefinitionMap : BaseEntityMap<ResolProsDefinition>
    {
        
        public ResolProsDefinitionMap() : 
                base("Bars.GkhGji.Regions.Zabaykalye.Entities.ResolProsDefinition", "GJI_RESOL_PROS_DEFINITION")
        {
        }
