...
namespace Bars.GkhGji.Regions.Zabaykalye.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Zabaykalye.Entities.DocumentViolGroupLongText"</summary>
    public class DocumentViolGroupLongTextMap : BaseEntityMap<DocumentViolGroupLongText>
    {
        
        public DocumentViolGroupLongTextMap() : 
                base("Bars.GkhGji.Regions.Zabaykalye.Entities.DocumentViolGroupLongText", "GJI_DOC_VIOLGROUP_LTEXT")
        {
        }
