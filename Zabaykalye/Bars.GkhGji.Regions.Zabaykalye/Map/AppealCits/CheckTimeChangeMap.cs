...
/// namespace Bars.GkhGji.Regions.Zabaykalye.Map.AppealCits
/// {
...
namespace Bars.GkhGji.Regions.Zabaykalye.Map.AppealCits
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Zabaykalye.Entities.AppealCits.CheckTimeChange"</summary>
    public class CheckTimeChangeMap : BaseEntityMap<CheckTimeChange>
    {
        
        public CheckTimeChangeMap() : 
                base("Bars.GkhGji.Regions.Zabaykalye.Entities.AppealCits.CheckTimeChange", "GJI_CHECK_TIME_CH")
        {
        }
