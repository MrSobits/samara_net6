...
namespace Bars.GkhGji.Regions.Zabaykalye.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Zabaykalye.Entities.ActSurveyLongDescription"</summary>
    public class ActSurveyLongDescriptionMap : BaseEntityMap<ActSurveyLongDescription>
    {
        
        public ActSurveyLongDescriptionMap() : 
                base("Bars.GkhGji.Regions.Zabaykalye.Entities.ActSurveyLongDescription", "GJI_ACTSURVEY_LONGDESC")
        {
        }
