...
namespace Bars.GkhGji.Regions.Zabaykalye.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Zabaykalye.Entities.ActSurveyConclusion"</summary>
    public class ActSurveyConclusionMap : BaseEntityMap<ActSurveyConclusion>
    {
        
        public ActSurveyConclusionMap() : 
                base("Bars.GkhGji.Regions.Zabaykalye.Entities.ActSurveyConclusion", "GJI_ACTSURVEY_CONCLUSION")
        {
        }
