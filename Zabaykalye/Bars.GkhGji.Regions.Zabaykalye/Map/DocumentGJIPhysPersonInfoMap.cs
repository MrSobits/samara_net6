...
namespace Bars.GkhGji.Regions.Zabaykalye.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Zabaykalye.Entities.DocumentGJIPhysPersonInfo"</summary>
    public class DocumentGJIPhysPersonInfoMap : BaseEntityMap<DocumentGJIPhysPersonInfo>
    {
        
        public DocumentGJIPhysPersonInfoMap() : 
                base("Bars.GkhGji.Regions.Zabaykalye.Entities.DocumentGJIPhysPersonInfo", "GJI_ZBKL_DOCGJI_PERSINFO")
        {
        }
