...
{    
    ...
    public partial class ResourceManifest : ResourceManifestBase
    {
        ...
        {  
            ...
            AddResource(container, "libs/B4/aspects/permission/ZabaykalyeActSurvey.js");
        ...
        private void AddResource(IResourceManifestContainer container, string path)
		{
            ...
            container.Add(path, string.Format("Bars.GkhGji.Regions.Zabaykalye.dll/Bars.GkhGji.Regions.Zabaykalye.{0}", path.Replace("/", ".")));
        }
    }
}
