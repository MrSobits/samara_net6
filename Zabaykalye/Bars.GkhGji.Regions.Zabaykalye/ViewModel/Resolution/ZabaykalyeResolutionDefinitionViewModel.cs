namespace Bars.GkhGji.Regions.Zabaykalye.ViewModel
{
    ...
    public class ZabaykalyeResolutionDefinitionViewModel : Bars.GkhGji.DomainService.ResolutionDefinitionViewModel<ZabaykalyeResolutionDefinition>
    {
        public override IDataResult List(IDomainService<ZabaykalyeResolutionDefinition> domainService, BaseParams baseParams)
        {
        ...
        public override IDataResult Get(IDomainService<ZabaykalyeResolutionDefinition> domainService, BaseParams baseParams)
        {
