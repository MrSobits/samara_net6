namespace Bars.GkhGji.Regions.Zabaykalye.ViewModel
{
    ...
    public class ZabaykalyeProtocolDefinitionViewModel : GkhGji.ViewModel.ProtocolDefinitionViewModel<ZabaykalyeProtocolDefinition>
    {
        public override IDataResult List(IDomainService<ZabaykalyeProtocolDefinition> domainService, BaseParams baseParams)
        {
        ...
        public override IDataResult Get(IDomainService<ZabaykalyeProtocolDefinition> domainService, BaseParams baseParams)
        {
