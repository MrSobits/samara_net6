Ext.define('B4.view.providerpassport.myoki.Grid', {    
    alias: 'widget.myokiprovpaspgrid',
    ...
    requires: [
        ...
        'B4.store.PeriodYear',
        'B4.store.providerpassport.MyOki',
        
        'B4.view.button.Sign'
    ],

    title: 'Мои паспорта ОКИ',
    closable: true,
    year: null,
    month: null,
    ...
    initComponent: function() {
        var me = this,
            store = Ext.create('B4.store.providerpassport.MyOki'),
