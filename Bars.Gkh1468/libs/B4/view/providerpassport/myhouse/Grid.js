Ext.define('B4.view.providerpassport.myhouse.Grid', {
    alias: 'widget.myhouseprovpaspgrid',
    ...
    requires: [
        ...
        'B4.form.ComboBox',
        'B4.store.providerpassport.MyHouse',
        'B4.store.PeriodYear',
        'B4.view.button.Sign'
    ],

    title: 'Мои паспорта домов',
    closable: true,
    ...
    initComponent: function() {
        var me = this,
            store = Ext.create('B4.store.providerpassport.MyHouse'),
