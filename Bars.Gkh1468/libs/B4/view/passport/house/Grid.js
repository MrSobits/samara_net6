Ext.define('B4.view.passport.house.Grid', {
    alias: 'widget.housepaspgrid',
    ...
    requires: [
        ...
        'B4.store.PeriodYear',
        'B4.store.passport.House'
    ],

    title: 'Реестр паспортов дома',
    closable: true,
    ...
    initComponent: function() {
        var me = this,
            store = Ext.create('B4.store.passport.House'),
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                {
                    xtype: 'numbercolumn',
                    index: 'NumberNotCreated',
                    dataIndex: 'NumberNotCreated',
                    format: '0',
                    width: 250,
                    text: 'Контрагенты, не создавшие паспорта',
                    sortable: false
                },
                {
                    xtype: 'gridcolumn',
