namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class MailingAddressDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "MailingAddressDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            var contractData = this.Container.Resolve<IDomainService<ManOrgContractRealityObject>>()
                ...
                .Select(x => new { x.ManOrgContract.Id, x.ManOrgContract.ManagingOrganization.Contragent.MailingAddress })
                .AsEnumerable()
                .Distinct()
                .ToDictionary(x => x.Id, x => x.MailingAddress);
