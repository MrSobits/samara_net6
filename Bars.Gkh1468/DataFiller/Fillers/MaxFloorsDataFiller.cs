namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class MaxFloorsDataFiller : IDataFiller
    {
            ...
            Result.Add(new BaseProviderPassportRow
                       {
                           ...
                           Value = RealityObject.MaximumFloors.HasValue ? RealityObject.MaximumFloors.Value.ToStr() : string.Empty
                       });
        }
