namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class ContragentKppDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "ContragentKppDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            var contractData = this.Container.Resolve<IDomainService<ManOrgContractRealityObject>>()
                ...
                .Select(x => new { x.ManOrgContract.Id, x.ManOrgContract.ManagingOrganization.Contragent.Kpp })
                .AsEnumerable()
                .Distinct()
                .ToDictionary(x => x.Id, x => x.Kpp);
