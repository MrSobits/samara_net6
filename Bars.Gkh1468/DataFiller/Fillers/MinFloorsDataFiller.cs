namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class MinFloorsDataFiller : IDataFiller
    {
            ...
            Result.Add(new BaseProviderPassportRow
                       {
                           ...
                           Value = RealityObject.Floors.HasValue ? RealityObject.Floors.Value.ToStr() : string.Empty
                       });
        }
