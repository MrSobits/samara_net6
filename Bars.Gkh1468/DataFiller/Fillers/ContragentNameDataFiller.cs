namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class ContragentNameDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "ContragentNameDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            var contractData = this.Container.Resolve<IDomainService<ManOrgContractRealityObject>>()
                ...
                .Select(x => new { x.ManOrgContract.Id, x.ManOrgContract.ManagingOrganization.Contragent.Name })
                .AsEnumerable()
                .Distinct()
