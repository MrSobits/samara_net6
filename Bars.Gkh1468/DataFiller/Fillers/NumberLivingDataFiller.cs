namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class NumberLivingDataFiller : IDataFiller
    {
        ...
        public void To1468()
        {
            ...
            Result.Add(new BaseProviderPassportRow
            {
                ...
                Value = RealityObject.NumberLiving.HasValue ? RealityObject.NumberLiving.Value.ToStr() : string.Empty
            });
        }
