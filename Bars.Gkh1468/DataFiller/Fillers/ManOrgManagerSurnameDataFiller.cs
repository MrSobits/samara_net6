namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    /// </summary>
    public class ManOrgManagerSurnameDataFiller : IDataFiller
    {
        /// <summary>
        /// Code
        /// </summary>
        public static string Code
        {
            get
            {
                return "ManOrgManagerSurnameDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            if (contractData.Count > 1)
            {
                ...
                if (contractId.HasValue)
                {
                    ...
                    {
                        var managerSurname = this.Container.Resolve<IDomainService<ContragentContact>>().GetAll()
