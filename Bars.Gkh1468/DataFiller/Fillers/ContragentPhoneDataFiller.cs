namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class ContragentPhoneDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "ContragentPhoneDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            var contractData = this.Container.Resolve<IDomainService<ManOrgContractRealityObject>>()
                ...
                .Select(x => new { x.ManOrgContract.Id, x.ManOrgContract.ManagingOrganization.Contragent.Phone })
                .AsEnumerable()
                .Distinct()
                .ToDictionary(x => x.Id, x => x.Phone);
