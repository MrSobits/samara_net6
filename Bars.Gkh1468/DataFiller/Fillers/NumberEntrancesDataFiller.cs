namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class NumberEntrancesDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "NumberEntrancesDataFiller";
            }
        }
            ...
            Result.Add(new BaseProviderPassportRow
                       {
                           ...
                           Value = RealityObject.NumberEntrances.HasValue ? RealityObject.NumberEntrances.Value.ToStr() : string.Empty
                       });
        }
