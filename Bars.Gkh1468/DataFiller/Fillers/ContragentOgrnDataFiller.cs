namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class ContragentOgrnDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "ContragentOgrnDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            var contractData = this.Container.Resolve<IDomainService<ManOrgContractRealityObject>>()
                ...
                .Select(x => new { x.ManOrgContract.Id, x.ManOrgContract.ManagingOrganization.Contragent.Ogrn })
                .AsEnumerable()
                .Distinct()
                .ToDictionary(x => x.Id, x => x.Ogrn);
