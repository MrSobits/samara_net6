...
namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    class PostalAddressDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "PostalAddressDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            Result.Add(new BaseProviderPassportRow
            {
                ...
                Value = RealityObject.FiasAddress != null ?  RealityObject.FiasAddress.AddressName : string.Empty
            });
        }
