namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class AreaMkdDataFiller : IDataFiller
    {
        ...
        public void To1468()
        {
            ...
            Result.Add(new BaseProviderPassportRow
            {
                ...
                Value = RealityObject.AreaMkd.HasValue ? RealityObject.AreaMkd.Value.ToStr() : string.Empty
            });
        }
