namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    public class JuridicalAddressDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "JuridicalAddressDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            var contractData = this.Container.Resolve<IDomainService<ManOrgContractRealityObject>>()
                ...
                .Select(x => new { x.ManOrgContract.Id, value = x.ManOrgContract.ManagingOrganization.Contragent.JuridicalAddress })
                .AsEnumerable()
                .Distinct()
