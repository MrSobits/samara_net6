...
namespace Bars.Gkh1468.DataFiller.Fillers
{
    ...
    class ProjectTypeAndSeriesDataFiller : IDataFiller
    {
        ...
        public static string Code
        {
            get
            {
                return "ProjectTypeAndSeriesDataFiller";
            }
        }
        ...
        public void To1468()
        {
            ...
            Result.Add(new BaseProviderPassportRow
            {
                ...
                Value = RealityObject.TypeProject != null ? RealityObject.TypeProject.Name : string.Empty 
            });
        }
