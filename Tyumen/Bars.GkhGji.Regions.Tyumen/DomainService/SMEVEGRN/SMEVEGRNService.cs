        ...
        new XElement(tns + "header",
                ...
                new XElement(tns + "declarant",
                    ...
                    new XElement(subj + "other",
                        new XElement(subj + "name", "ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ТЮМЕНСКОЙ ОБЛАСТИ \"ЦЕНТР ИНФОРМАЦИОННЫХ ТЕХНОЛОГИЙ ТЮМЕНСКОЙ ОБЛАСТИ\""),
                        new XElement(subj + "inn", "7202190205"),
                        new XElement(subj + "ogrn", "1087232038794"),
                        new XElement(subj + "kpp", "720301001"),
                        new XElement(subj + "regDate", "2008-09-24")),
