namespace Bars.GkhGji.Regions.Tyumen.Migrations.Version_2022060200
{
    ...
    [MigrationDependsOn(typeof(Bars.GkhGji.Regions.Tyumen.Migrations.Version_2018120700.UpdateSchema))]
...
('72', 'Тюменская область', 0, '{date}'::date, '{date}'::date)");
