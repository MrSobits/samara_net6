Ext.define('B4.controller.import.KamchatkaRealtyObject', {
    extend: 'B4.base.Controller',
    views: ['import.KamchatkaRealtyObjectPanel'],
    mainView: 'import.KamchatkaRealtyObjectPanel',
    mainViewSelector: 'kamchatkarobjectimportpanel',
    ...
    refs: [{
        ref: 'mainView',
        selector: 'kamchatkarobjectimportpanel'
    }],
    ...
    init: function () {
        ...
        this.control({
            'kamchatkarobjectimportpanel button': {
    ...
    index: function () {
        var view = this.getMainView() || Ext.widget('kamchatkarobjectimportpanel');
    ...
    loadButtonClick: function () {
        ...
        me.params = {};
        me.params.importId = 'KamchatkaRealtyObjectImport';
