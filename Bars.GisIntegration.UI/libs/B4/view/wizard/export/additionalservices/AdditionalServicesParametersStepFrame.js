Ext.define('B4.view.wizard.export.additionalservices.AdditionalServicesParametersStepFrame', {
    ...
    init: function () {
        ...
        me.wizard.down('b4selectfield[name=AdditionalServices]').setDisabled(multiSuppliers);
    },

    firstInit: function () {
        var me = this,
            sf = me.wizard.down('b4selectfield[name=AdditionalServices]');
    ...
    getParams: function () {
        var me = this,
            multiSuppliers = me.wizard.dataSupplierIds && me.wizard.dataSupplierIds.length > 1;
        return {
            selectedList: multiSuppliers ? 'ALL' : me.wizard.down('b4selectfield[name=AdditionalServices]').getValue()
        };
    }
});