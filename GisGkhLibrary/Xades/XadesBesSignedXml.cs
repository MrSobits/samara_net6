...
using GisGkhLibrary.Xades;
using GisGkhLibrary.Xades.Exceptions;
using GisGkhLibrary.Xades.Helpers;
using GisGkhLibrary.Xades.Models;
//using Microsoft.Xades;

namespace GisGkhLibrary.Xades
{
    public class XadesBesSignedXml
    //public class XadesBesSignedXml : XadesSignedXml
    {
        ...
        public XadesBesSignedXml(XmlDocument document)
        {
        ...
        /* public XadesBesSignedXml(XmlDocument document) : base(document) { }
         ...
         public void ComputeSignature(X509Certificate2 certificate, string privateKeyPassword)
         {
             ...
             AddXades2012Object(xadesObject);

             SignedInfo.CanonicalizationMethod = XmlDsigExcC14NTransformUrl;
             SignedInfo.SignatureMethod = CPSignedXml.XmlDsigGost3410_2012_256Url;
             ComputeSignature();
