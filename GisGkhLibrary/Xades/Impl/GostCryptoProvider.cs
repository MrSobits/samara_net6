...
namespace GisGkhLibrary.Xades.Implementations
{
    // TODO: Расскоментировать
    public class GostCryptoProvider
    //public class GostCryptoProvider : ICryptoProvider
    {
        ...
        public GostCryptoProvider()
        {
            HashAlgorithmMap = new Dictionary<string, string>
            {
                ...
                { "urn:ietf:params:xml:ns:cpxmlsec:algorithms:gostr34112012-256", "GOST3411_2012_256" }
            };
        }
...
#pragma warning restore 612
            ...
            else if (certificate.PrivateKey is Gost3410_2012_256CryptoServiceProvider)
            {
