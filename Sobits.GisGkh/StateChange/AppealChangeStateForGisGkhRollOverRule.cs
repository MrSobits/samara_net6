namespace Sobits.GisGkh.StateChange
{
    ...
    public class AppealChangeStateForGisGkhRollOverRule : IRuleChangeStatus
    {
        ...
        public string Id => "gji_appeal_citizens_for_gis_gkh_roll_over_rule";

        public string Name => "Формирование запроса в ГИС ЖКХ при продлении срока рассмотрения обращения";
        ...
        public virtual ValidateResult Validate(IStatefulEntity statefulEntity, State oldState, State newState)
        {
            ...
            if (appeal.GisWork)
            {
                ...
                try
                {
                    importAnswerService.SaveRollOverRequest(req, appeal, thisOperator.GisGkhContragent.GisGkhOrgPPAGUID);
