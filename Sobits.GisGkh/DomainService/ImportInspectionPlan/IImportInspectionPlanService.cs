...
namespace Sobits.GisGkh.DomainService
{
    ...
    /// </summary>
    public interface IImportInspectionPlanService
    {
        /// <summary>
        /// Сохранить запрос
        /// </summary>
        ...
        void SaveRequest(GisGkhRequests req, string[] reqParams);
        ...
        /// <param name="req">Запрос</param>
        /// <param name="orgPPAGUID">GUID организации</param>
        void SaveCurrentRequest(GisGkhRequests req, string[] reqParams, string OrgPPAGUID);
