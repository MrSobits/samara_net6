...
{
    public class ExportRegionalProgramService : IExportRegionalProgramService
    {
        #region Constants
        ...
        public ExportRegionalProgramService(IWindsorContainer container, IFileManager fileManager, ITaskManager taskManager)
        {
        ...
        public void SaveRequest(GisGkhRequests req, string OKTMO)
        {
            try
            {
                var request = HcsCapitalRepairAsync.exportRegionalProgramReq(OKTMO);
                ...
                try
                {
                    ...
                    if (fileInfo != null)
                    {
                        ...
                        foreach (var responseItem in response.Items)
                        {
                            ...
                            else if (responseItem is ExportRegionalProgramType)
                            {

                                var regProg = (ExportRegionalProgramType)responseItem;
