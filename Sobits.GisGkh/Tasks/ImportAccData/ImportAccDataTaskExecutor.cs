...
namespace Sobits.GisGkh.Tasks.ProcessGisGkhAnswers
{
    ...
    /// </summary>
    public class ImportAccDataTaskExecutor : ITaskExecutor
    {
        #region Properties
        ...
        public ImportAccDataTaskExecutor(IImportAccountDataService ImportAccountDataService)
        {
            ...
            try
            {
               ...
               .ToList();
                foreach (var RO in RObjects)
                {
                    ...
                    try
                    {
                        _ImportAccountDataService.SaveRequest(req, RO.Id.ToString());
                    }
                    catch (Exception e)
                    {
