namespace Bars.Gkh.PrintForm.Utils
{
    ...
    public class BaseStampStrategy
    {
        ...
        public PdfSignatureAppearance Stamp(PdfReader reader, Stream os)
        {
            ...
            this.Left = this.StampOffsetX.HasValue ? this.StampOffsetX.Value : this.Left;
            this.Bottom = this.StampOffsetY.HasValue ? this.StampOffsetY.Value : this.Bottom;
        ...
        protected virtual void AddSignatureArea(PdfSignatureAppearance appearance, PdfReader reader)
        {
            ...
            appearance.SetVisibleSignature(rectangle, this.StampPage.HasValue ? this.StampPage.Value : reader.NumberOfPages, this.ContextGuid);
        }
        ...
        {
            var img = Image.GetInstance(Resources.TatarstanBlazon);
            layout.AddImage(img, rectangle.Width, 0, 0, rectangle.Height, rectangle.Left, rectangle.Bottom);
        }
