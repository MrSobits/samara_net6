Ext.define('B4.view.claimwork.actviolidentification.EditPanel', {
    ...
    width: 500,
    bodyPadding: 5,
    alias: 'widget.actviolidentifeditpanel',
    title: 'Акт выявления нарушений',
    autoScroll: true,
    frame: true,
    requires: [
        'B4.form.EnumCombo',
        'B4.ux.button.Save',
        'B4.enums.FactOfReceiving',
        'B4.enums.ActViolIdentificationType',
