Ext.define('B4.view.claimwork.lawsuit.DocumentationGrid', {
    extend: 'B4.ux.grid.Panel',
    alias: 'widget.claimworklawsuitdocumentationgrid',
    requires: [
        'B4.ux.button.Add',
        'B4.ux.button.Update',
        ...
        'B4.store.claimwork.lawsuit.LawsuitDocument'
    ],
    minHeight: 350,

    initComponent: function () {
        var me = this,
            store = Ext.create('B4.store.claimwork.lawsuit.LawsuitDocument');
