namespace Bars.Gkh.ClaimWork.CodedReports
{
    ...
    /// </summary>
    public class PretensionBuilderReport : BaseCodedReport, IClaimWorkCodedReport
    {
        private string _outputFileName = "Претензия";
        ...
        public string Id
        {
            get { return "PretensionBuilder"; }
        }

        public override string Name
        {
            get { return "Претензия подрядчику"; }
        }
        ...
        public override IEnumerable<IDataSource> GetDataSources()
        {
            ...
            {
                new CodedDataSource("Претензии", provider)
            };
        }
