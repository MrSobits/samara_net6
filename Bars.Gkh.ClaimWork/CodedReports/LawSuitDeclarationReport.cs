namespace Bars.Gkh.ClaimWork.CodedReports
{
    ...
    /// </summary>
    public class LawSuitDeclarationReport : BaseCodedReport, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "LawSuitDeclaration";

        public override string Name => "Заявление о вынесении судебного приказа";

        public override string Description => this.Name;

        public string CodeForm => "CourtClaim";

        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа";
        ...
        public override IEnumerable<IDataSource> GetDataSources()
        {
            ...
            {
                new CodedDataSource("Заявление о вынесении судебного приказа", provider)
            };
        }
        ...
        public void Generate()
        {
            ...
            try
            {
                ...
                this.OutputFileName = string.Format(
                    "Заявление о вынесении судебного приказа ({0}{1}).doc",
