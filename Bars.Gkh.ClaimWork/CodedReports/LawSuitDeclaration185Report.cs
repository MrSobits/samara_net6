namespace Bars.Gkh.ClaimWork.CodedReports
{
    ...
    /// </summary>
    public class LawSuitDeclaration185Report : BaseCodedReport, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "LawSuitDeclaration185";

        public override string Name => "Заявление о вынесении судебного приказа 185 ФЗ";

        public override string Description => this.Name;

        public string CodeForm => "CourtClaim185";

        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа 185 ФЗ";
        ...
        public override IEnumerable<IDataSource> GetDataSources()
        {
            ...
            {
                new CodedDataSource("Заявление о вынесении судебного приказа 185 ФЗ", provider)
            };
        }
        ...
        public void Generate()
        {
            ...
            try
            {
                ...
                this.OutputFileName = string.Format(
                    "Заявление о вынесении судебного приказа 185 ФЗ({0}{1}).doc",
