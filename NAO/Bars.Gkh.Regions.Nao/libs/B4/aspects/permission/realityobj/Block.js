﻿Ext.define('B4.aspects.permission.realityobj.Block', {
    ...
    permissions: [
        ...
        */
        ...
        //{
        //    name: 'Gkh.RealityObject.Register.Block.Fields.AreaFederalOwned_View',
        //    applyTo: '[name=AreaFederalOwned]',
        //    selector: 'blockeditwindow',
        //    applyBy: function (component, allowed) {
        //        if (allowed) component.show();
        //        else component.hide();
        ...
        //},
        //{
        //    name: 'Gkh.RealityObject.Register.Block.Fields.AreaCommercialOwned_View',
        //    applyTo: '[name=AreaCommercialOwned]',
        //    selector: 'blockeditwindow',
        //    applyBy: function (component, allowed) {
        //        if (allowed) component.show();
        //        else component.hide();
