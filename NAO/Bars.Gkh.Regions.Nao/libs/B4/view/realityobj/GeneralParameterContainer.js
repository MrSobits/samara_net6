                                            ...
                                            items: [
                                                {
                                                    xtype: 'numberfield',
                                                    name: 'AreaFederalOwned',
                                                    fieldLabel: 'Площадь федеральной собственности  (кв.м.)',
                                                    hideTrigger: true,
                                                    keyNavEnabled: false,
                                                    mouseWheelEnabled: false,
                                                    itemId: 'nfAreaFederalOwned',
                                                    decimalSeparator: ',',
                                                    minValue: 0,
                                                    flex: 1
                                                }
                                            ...
                                            items: [
                                                {
                                                    xtype: 'numberfield',
                                                    name: 'AreaCommercialOwned',
                                                    fieldLabel: 'Площадь коммерческой собственности  (кв.м.)',
                                                    hideTrigger: true,
                                                    keyNavEnabled: false,
                                                    mouseWheelEnabled: false,
                                                    itemId: 'nfAreaCommercialOwned',
                                                    decimalSeparator: ',',
                                                    minValue: 0,
                                                    flex: 1
                                                }
                                                ...
                                                //    margin: '0 0 0 5',
                                                //    text: 'Заполнить',
                                                //    action: 'FillAreaCommercialOwned'
                                                //}
                                            ]
                                        },
                                        {
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                                    ...
                                                    itemId: 'cbASSberbankClient',
                                                    textProperty: 'Код клиента в АС Клиент-Сбербанк',
                                                    fieldLabel: 'Код клиента в АС Клиент-Сбербанк',
                                                    labelAlign: 'right',
                                                    store: 'B4.store.ASSberbankClient',
                                                    textProperty: 'ClientCode',
                                                    columns: [
                                                        {text: 'Код клиента', dataIndex: 'ClientCode', flex: 1, filter: { xtype: 'textfield' } }
                                                    ],
                                                    flex: 1
                                        },
                                        {
                                            xtype: 'textfield',
                                            name: 'UnomCode',
                                            fieldLabel: 'Код услуги в АС Клиент-Сбербанк',
                                            itemId: 'tfUnomCode',
                                            maxLength: 100,
                                        },
                                        {
