namespace Bars.Gkh.Quartz.Scheduler.Listeners
{
    ...
    public class LoggingJobHistoryPlugin : ISchedulerPlugin, IJobListener
    {
        ...
        private Logger log = LogManager.GetLogger(typeof(LoggingJobHistoryPlugin).FullName);
        ...
        {
            get { return this.jobSuccessMessage; }
            set { this.jobSuccessMessage = value; }
        }
        ...
        {
            get { return this.jobFailedMessage; }
            set { this.jobFailedMessage = value; }
        }
        ...
        {
            get { return this.jobToBeFiredMessage; }
            set { this.jobToBeFiredMessage = value; }
        }
        ...
        {
            get { return this.jobWasVetoedMessage; }
            set { this.jobWasVetoedMessage = value; }
        }
        ...
        public virtual void JobToBeExecuted(IJobExecutionContext context)
        {
            ...
            this.Log.Info(String.Format(CultureInfo.InvariantCulture, this.JobToBeFiredMessage, args));
        }
        ...
        public virtual void JobWasExecuted(IJobExecutionContext context, JobExecutionException jobException)
        {
            ...
            else
            {
                ...
                this.Log.Info(String.Format(CultureInfo.InvariantCulture, this.JobSuccessMessage, args));
            }
        }
        ...
        public virtual void JobExecutionVetoed(IJobExecutionContext context)
        {
            ...
            this.Log.Info(String.Format(CultureInfo.InvariantCulture, this.JobWasVetoedMessage, args));
        }
    }
}