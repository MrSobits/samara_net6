namespace Bars.Gkh.Quartz.Scheduler.Listeners
{
    ...
    public class LoggingTriggerHistoryPlugin : ISchedulerPlugin, ITriggerListener
    {
        ...
        private Logger log = LogManager.GetLogger(typeof (LoggingTriggerHistoryPlugin).FullName);
        ...
        {
            get { return this.triggerCompleteMessage; }
            set { this.triggerCompleteMessage = value; }
        }
        ...
        {
            get { return this.triggerFiredMessage; }
            set { this.triggerFiredMessage = value; }
        }
        ...
        {
            get { return this.triggerMisfiredMessage; }
            set { this.triggerMisfiredMessage = value; }
        }
        ...
        public virtual void TriggerFired(ITrigger trigger, IJobExecutionContext context)
        {
            ...
            this.Log.Info(String.Format(CultureInfo.InvariantCulture, this.TriggerFiredMessage, args));
        }
        ...
        public virtual void TriggerMisfired(ITrigger trigger)
        {
            ...
            this.Log.Info(String.Format(CultureInfo.InvariantCulture, this.TriggerMisfiredMessage, args));
        }
        ...
        public virtual void TriggerComplete(ITrigger trigger, IJobExecutionContext context, SchedulerInstruction triggerInstructionCode)
        {
            ...
            this.Log.Info(String.Format(CultureInfo.InvariantCulture, this.TriggerCompleteMessage, args));
        }
