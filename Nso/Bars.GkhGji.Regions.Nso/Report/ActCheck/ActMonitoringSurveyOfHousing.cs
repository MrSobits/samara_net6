namespace Bars.GkhGji.Regions.Nso.Report.ActCheck
{
    ...
    public class ActMonitoringSurveyOfHousing : GjiBaseReport
    {
        ...
        public ActMonitoringSurveyOfHousing()
            : base(new ReportTemplateBinary(Properties.Resources.ActMonitoringSurveyOfHousing))
        {
        }
                           ...
                           new TemplateInfo
                               {
                                   ...
                                   Template = Properties.Resources.ActMonitoringSurveyOfHousing
                               }
                       };
        }
