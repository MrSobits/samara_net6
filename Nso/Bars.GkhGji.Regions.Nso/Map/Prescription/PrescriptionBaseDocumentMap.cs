...
namespace Bars.GkhGji.Regions.Nso.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Nso.Entities.PrescriptionBaseDocument"</summary>
    public class PrescriptionBaseDocumentMap : BaseEntityMap<PrescriptionBaseDocument>
    {
        
        public PrescriptionBaseDocumentMap() : 
                base("Bars.GkhGji.Regions.Nso.Entities.PrescriptionBaseDocument", "GJI_PRESCR_BASE_DOC")
        {
        }
