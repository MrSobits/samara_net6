namespace Bars.GkhGji.Regions.Nso.ExecutionAction
{
    using System;
    ...
    public class MigrateActCheckRemovalToActRemovalAction : BaseExecutionAction
    {
        ...
        public IDomainService<NsoActCheck> ActCheckDomain { get; set; }

        public IDomainService<NsoActRemoval> ActRemovalDomain { get; set; }
                    ...
                    actChecksRemoval.ForEach(
                        x =>
                        {
                            if (x.Stage != null)
                            {
                                ...
                                var actRemoval =
                                    Utils.GetChildDocumentByType(this.DocumentGjiChildrenDomain, x, TypeDocumentGji.ActRemoval) as NsoActRemoval;
                                if (actRemoval != null)
                                {
