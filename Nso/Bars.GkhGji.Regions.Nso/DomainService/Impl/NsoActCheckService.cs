namespace Bars.GkhGji.Regions.Nso.DomainService.Impl
{
	...
	/// </summary>
	public class NsoActCheckService : INsoActCheckService
	{
		...
		private readonly IDomainService<NsoActCheck> actDomain;
        ...
        private readonly IDomainService<NsoDocumentLongText> nsoDocumentLongTextDomain;
        ...
        public NsoActCheckService(
            IDomainService<NsoActCheck> actDomain,
            ...
            IDomainService<NsoDocumentLongText> nsoDocumentLongTextDomain,
		...
		/// <returns>Результат выполнения запроса</returns>
		public bool IsAnyHasViolation(NsoActCheck act)
        {
		...
		private void MergeViolationDescs(ActCheck targetAct, long[] sourceActIds)
		{
			var targetLongText = this.nsoDocumentLongTextDomain.GetAll()
				.FirstOrDefault(y => y.DocumentGji.Id == targetAct.Id)
			                     ?? new NsoDocumentLongText {DocumentGji = targetAct};
			...
			nsoDocumentLongTextDomain.SaveOrUpdate(targetLongText);
		}
