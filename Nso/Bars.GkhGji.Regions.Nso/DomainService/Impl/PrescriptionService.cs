namespace Bars.GkhGji.Regions.Nso.DomainService.Impl
{
    ...
    public class NsoPrescriptionService : Bars.GkhGji.DomainService.PrescriptionService
    {
        public override IDataResult GetInfo(long? documentId)
        {
            var serviceDisposalInspector = Container.Resolve<IDomainService<DocumentGjiInspector>>();
            var docChildrenDomain = Container.ResolveDomain<DocumentGjiChildren>();
            var activityDirectionDomain = Container.ResolveDomain<PrescriptionActivityDirection>();
            ...
            {
                Container.Release(serviceDisposalInspector);
