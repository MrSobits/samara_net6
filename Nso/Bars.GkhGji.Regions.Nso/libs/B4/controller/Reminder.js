Ext.define('B4.controller.Reminder', {
    ...
    init: function () {
        ...
        actions['reminderPanel[typeReminder = "head"] reminderfilterpnl #cbActCheck'] = { 'change': { fn: this.onChangeActCheck, scope: this } };
        actions['reminderPanel[typeReminder = "head"] reminderfilterpnl #cbNoticeOfInspection'] = { 'change': { fn: this.onChangeNoticeOfInspection, scope: this } };
        ...
        actions['reminderPanel[typeReminder = "inspector"] reminderfilterpnl #cbActCheck'] = { 'change': { fn: this.onChangeActCheck, scope: this } };
        actions['reminderPanel[typeReminder = "inspector"] reminderfilterpnl #cbNoticeOfInspection'] = { 'change': { fn: this.onChangeNoticeOfInspection, scope: this } };
    ...
    reminderInspector: function () {
        ...
        if (!pnl) {
            ...
            pnl.params.isActCheck = true;
            pnl.params.isNoticeOfInspection = true;
    ...
    reminderTaskState: function (colorType, typeReminder) {
        ...
        if (!pnl) {
            ...
            switch (type) {
                case 30: {
                    lableText = 'Состояние по задачам с типом \"Приказа\"';
                }
                    break;
                ...
                case 60: {
                    lableText = 'Состояние по задачам с типом \"Акт проверки\"';
                }
                    break;
                    
                case 70: {
                    lableText = 'Состояние по задачам с типом \"Уведомление о проверке\"';
                }
                    break;
    ...
    fillDopFilter: function (pnl) {
        ...
        B4.Ajax.request(B4.Url.action('GetInfo', 'Reminder', {
            ...
            isActCheck: pnl.params.isActCheck,
            isNoticeOfInspection: pnl.params.isNoticeOfInspection,
    ...
    onChangeActCheck: function (field, newValue) {
        field.up('reminderPanel').params.isActCheck = newValue;
    },
    
    onChangeNoticeOfInspection: function (field, newValue) {
        field.up('reminderPanel').params.isNoticeOfInspection = newValue;
    },
    ...
    onBeforeLoad: function (store, operation) {
        ...
        if (params) {
            ...
            operation.params.isActCheck = params.isActCheck;
            operation.params.isNoticeOfInspection = params.isNoticeOfInspection;
