    ...
    aspects: [
        ...
        },
        {
            ...
            otherActions: function(actions) {
                ...
                actions[this.editFormSelector + ' [name = SuretyResolve]'] = { 'change': { fn: this.onChangeSuretyResolve, scope: this } };
            },
            ...
            onChangeSuretyResolve: function (field, newValue) {
                var wnd = Ext.ComponentQuery.query(this.controller.editWindowSelector)[0];
                var appContr = wnd.down('[name = ApprovalContragent]');
                if (appContr && newValue) {
                    if (newValue.Code != 4) {
                        appContr.setDisabled(true);
                        appContr.setValue(null);
                    } else {
                        appContr.setDisabled(false);
                    }
                }
            },
