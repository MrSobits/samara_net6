namespace Bars.GkhGji.Regions.Nso.Migrations.Version_2015071500
{
	using global::Bars.B4.Modules.Ecm7.Framework;
	using System.Data;

	[global::Bars.B4.Modules.Ecm7.Framework.Migration("2015071500")]
    [global::Bars.B4.Modules.Ecm7.Framework.MigrationDependsOn(typeof(global::Bars.GkhGji.Regions.Nso.Migrations.Version_2015052901.UpdateSchema))]
    public class UpdateSchema : global::Bars.B4.Modules.Ecm7.Framework.Migration
    {
        public override void Up()
        {
	        Database.AddTable("GJI_DISPOSAL_PROVDOC_NSO",
			...
			Database.AddForeignKey("FK_DISP_PROVDOC_ID", "GJI_DISPOSAL_PROVDOC_NSO", "ID", "GJI_DISPOSAL_PROVDOC", "ID");
        ...
        {
			Database.RemoveConstraint("GJI_DISPOSAL_PROVDOC_NSO", "FK_DISP_PROVDOC_ID");
			Database.RemoveTable("GJI_DISPOSAL_PROVDOC_NSO");
        }
    }
}