namespace Bars.GkhGji.Regions.Nso.Migrations.Version_2015072101
{
    using System.Data;
    ...
    [global::Bars.B4.Modules.Ecm7.Framework.MigrationDependsOn(typeof(global::Bars.GkhGji.Regions.Nso.Migrations.Version_2015072100.UpdateSchema))]
    public class UpdateSchema : global::Bars.B4.Modules.Ecm7.Framework.Migration
    {
        public override void Up()
        {
			Database.AddEntityTable("GJI_REALITY_OBJECT_FANTOM",
	        ...
	        Database.AddEntityTable("GJI_MKD_CHANGE_NOTIFICATION",
        ...
        {
			Database.RemoveTable("GJI_REALITY_OBJECT_FANTOM");
			Database.RemoveTable("GJI_MKD_CHANGE_NOTIFICATION");
        }
    }
}