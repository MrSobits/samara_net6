namespace Bars.GkhGji.Regions.Nso.Migrations.Version_2015072200
{
    using System.Data;
    ...
    [global::Bars.B4.Modules.Ecm7.Framework.MigrationDependsOn(typeof(global::Bars.GkhGji.Regions.Nso.Migrations.Version_2015072101.UpdateSchema))]
    public class UpdateSchema : global::Bars.B4.Modules.Ecm7.Framework.Migration
    {
        public override void Up()
        {
	        Database.AddEntityTable("GJI_MKD_CHANGE_NOTIFICATION_FILE",
        ...
        {
			Database.RemoveTable("GJI_MKD_CHANGE_NOTIFICATION_FILE");
        }
    }
}