namespace Bars.GkhGji.Regions.Nso.StateChange
{
    ...
    public class ActCheckRemoveDateStateRule : IRuleChangeStatus
    {
        public virtual IWindsorContainer Container { get; set; }

        public string Id
        {
            get { return "ActCheckRemoveDateStateRule"; }
        }

        public string Name { get { return "Удаление значение поля \"Дата прошлой проверки\" цели"; } }
        public string TypeId { get { return "gji_document_actcheck"; } }
        public string Description
        {
            get
            {
                return "При переводе статуса будет удалено значение поля \"Дата прошлой проверки\" цели в карточке Контрагента";
            }
        }
        ...
        public ValidateResult Validate(IStatefulEntity statefulEntity, State oldState, State newState)
        {
            ...
            try
            {
                ...
                foreach (var auditPuropse in auditPuropses)
                {
                    ...
                    contrAuditPurp.LastInspDate = (DateTime?)null;
