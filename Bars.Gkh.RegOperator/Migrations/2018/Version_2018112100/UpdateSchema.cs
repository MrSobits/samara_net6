namespace Bars.Gkh.RegOperator.Migrations._2018.Version_2018112100
{
    ...
    public class UpdateSchema : Migration
    {
        ...
        public void UpdateView()
        {
            Database.ExecuteQuery(@"
                ...
                COST 100
                ROWS 1000;
                ALTER FUNCTION getviewindividualclaimwork()
                  OWNER TO postgres;

                -- View: view_clw_individual_claim_work

                -- DROP VIEW view_clw_individual_claim_work;

                CREATE OR REPLACE VIEW view_clw_individual_claim_work AS
                  SELECT getviewindividualclaimwork.id,
                         ...
                         getviewindividualclaimwork.underage,
                         getviewindividualclaimwork.user_id
                  FROM getviewindividualclaimwork() getviewindividualclaimwork (id, debtor_state, state_id, municipality, registration_address, account_owner_name, accounts_number, accounts_address, cur_charge_base_tariff_debt, cur_charge_decision_tariff_debt, cur_charge_debt, cur_penalty_debt, is_debt_paid, debt_paid_date, pir_create_date, first_document_date, has_charges_185fz, min_share, underage, user_id);

                ALTER TABLE view_clw_individual_claim_work
                  OWNER TO postgres;
