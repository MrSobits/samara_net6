namespace Bars.Gkh.RegOperator.Distribution
{
    ...
    /// Платеж КР
    /// </summary>
    public partial class TransferCrDistribution : AbstractPersonalAccountDistribution
    {
        ...
        /// Код распределения
        /// </summary>
        public override DistributionCode DistributionCode => DistributionCode.TransferCrDistribution;
