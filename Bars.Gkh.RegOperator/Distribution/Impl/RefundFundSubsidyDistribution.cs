namespace Bars.Gkh.RegOperator.Distribution.Impl
{
    ...
    public class RefundFundSubsidyDistribution : AbstractRealtyAccountRefundDistribution
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        /// <param name="ropayAccDomain">DomainService <see cref="RefundFundSubsidyDistribution" /></param>
        ...
        public RefundFundSubsidyDistribution(
        ...
        /// Код распределения
        /// </summary>
        public override DistributionCode DistributionCode => DistributionCode.RefundFundSubsidyDistribution;

        /// <summary>
        /// Идентификатор права доступа
        /// </summary>
        public override string PermissionId => "GkhRegOp.Accounts.SuspenseAccount.EnrollmentTypes.RefundFundSubsidy";
        ...
        protected override IEnumerable<RealityObjectPaymentAccount> GetPaymentAccounts(IQueryable<Transfer> query)
        {
            return this.RopayAccDomain.GetAll()
                .Where(y => query.Any(x => x.SourceGuid == y.FundSubsidyWallet.WalletGuid))
                .ToArray();
        }
    }
}