namespace Bars.Gkh.RegOperator.Tasks.PaymentDocuments.V2
{
    ...
    /// </summary>
    internal class LegalOneHouseOwnerDocumentSnapshotExecutor : BaseDocumentExecutor
    {
        /// <summary>
        ...
        public LegalOneHouseOwnerDocumentSnapshotExecutor(IWindsorContainer container, IDomainService<ChargePeriod> periodDomainService)
            : base(container)
        {
