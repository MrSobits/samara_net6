namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class CourtOrderUnderageDirectedReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "CourtOrderClaimDirectedUnderage";

        public override string Name => "Заявление о вынесении судебного приказа. По подсудности (несовершеннолетний)";
        ...
        public string CodeForm => "CourtClaimDirectedUnderage";

        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа. По подсудности (несовершеннолетний)";
        ...
        public void Generate()
        {
            ...
            try
            {
                ...
                this.OutputFileName =
                    $"Заявление о выдаче судебного приказа (несов.) ({ReportInfo.Info} - {DateTime.Now.Date.ToShortDateString()}).{format}"
                        .Replace("\"", "");
