namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class CourtOrderUnderageReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "CourtOrderClaimUnderage";

        public override string Name => "Заявление о вынесении судебного приказа (несовершеннолетний)";
        ...
        public string CodeForm => "CourtClaimUnderage";

        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа (несовершеннолетний)";
