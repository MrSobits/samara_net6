namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class CourtOrderSharedOwnershipReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "CourtClaimShared";

        public override string Name => "Заявление о вынесении судебного приказа (совместная собственность)";
        ...
        public string CodeForm => "CourtClaimShared";

        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа (совместная собственность)";
