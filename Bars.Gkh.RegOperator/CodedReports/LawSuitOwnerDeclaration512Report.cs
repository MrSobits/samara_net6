namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class LawSuitOwnerDeclaration512Report : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "LawSuitOwnerDeclaration512Report";

        public override string Name => "Заявление о вынесении судебного приказа 512 ФЗ (сведения о собственниках)";

        public override string Description => this.Name;

        public string CodeForm => "CourtClaimOwner512";

        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа 512 ФЗ (сведения о собственниках)";
        ...
        public void Generate()
        {
            ...
            try
            {
                ...
                this.OutputFileName =
                    $"Заявление о вынесении судебного приказа 512 ФЗ ({ownerInfo.PersonalAccount.Room.RealityObject.Address} - {ownerInfo.Name} - {ownerInfo.PersonalAccount.PersonalAccountNum}"
