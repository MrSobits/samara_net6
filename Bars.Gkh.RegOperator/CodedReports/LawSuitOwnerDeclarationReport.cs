namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class LawSuitOwnerDeclarationReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "LawSuitOwnerDeclaration";

        public override string Name => "Заявление о вынесении судебного приказа (сведения о собственниках)";

        public override string Description => this.Name;

        public string CodeForm => "CourtClaimOwner";

        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа (сведения о собственниках)";
