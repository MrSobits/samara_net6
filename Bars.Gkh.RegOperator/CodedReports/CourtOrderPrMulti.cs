namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class CourtOrderPrMulti : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "CourtOrderPrMulti";

        public override string Name => "Судебный приказ";
        ...
        public string CodeForm => "CourtOrderPrMulti";

        public string OutputFileName { get; set; } = "Судебный приказ";
