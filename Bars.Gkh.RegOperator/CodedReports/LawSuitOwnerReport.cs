namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class LawSuitOwnerReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "LawSuitOwner";

        public override string Name => "Исковое заявление (сведения о собственниках)";

        public override string Description => this.Name;

        public string CodeForm => "LawSuitOwner";

        public string OutputFileName { get; set; } = "Исковое заявление (сведения о собственниках)";
