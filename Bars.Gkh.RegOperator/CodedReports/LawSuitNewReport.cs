namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class LawSuitNewReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "LawSuitNewReport";

        public override string Name => "Новый шаблон";
        ...
        public string OutputFileName { get; set; } = "Новый шаблон";
