namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class LawSuitUnknownOwnerReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "LawSuitUnknownOwnerReport";

        public override string Name => "Заявление о вынесении судебного приказа (собственник не определен)";
        ...
        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа (собственник не определен)";
