namespace Bars.Gkh.RegOperator.CodedReports
{
    ...
    /// </summary>
    public class LawSuitOwnerDeclarationDirectedReport : ExportFormatHelper, IClaimWorkCodedReport
    {
        /// <summary>
        /// Container
        /// </summary>
        ...
        public string Id => "LawSuitOwnerDirectedDeclaration";

        public override string Name => "Заявление о вынесении судебного приказа. По подсудности (сведения о собственниках)";
        ...
        public string CodeForm => "CourtClaimOwnerDirected";

        public string OutputFileName { get; set; } = "Заявление о вынесении судебного приказа. По подсудности. (сведения о собственниках)";
        ...
        public void Generate()
        {
            ...
            try
            {
                ...
                this.OutputFileName =
                    $"Заявление о вынесении судебного приказа ({ownerInfo.Name} - {ownerInfo.PersonalAccount.PersonalAccountNum}"
