Ext.define('B4.view.transferfunds.ObjectGrid', {
    ...
    requires: [
        ...
        'B4.store.transferfunds.Object',
        'B4.ux.grid.filter.YesNo',
        'B4.grid.feature.Summary'
    ],
    alias: 'widget.transferfundsobjectgrid',
    title: 'Реестр жилых домов включенных в договор',

    initComponent: function() {
        var me = this,
            store = Ext.create('B4.store.transferfunds.Object'),
            ...
            columns: [
                {
                    ...
                    tooltip: 'Перейти к счету дома',
                    width: 20,
                    hideable: false,
                    handler: function(grid, rowIndex, colIndex, el, e, rec) {
                        var origScope = this.origScope;
                        origScope.fireEvent('rowaction', origScope, 'account', rec);
                    },
                    scope: me
                },
                {
