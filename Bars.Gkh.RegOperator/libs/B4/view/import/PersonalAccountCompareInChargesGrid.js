/**
* Форма ручного сопоставления записи из журнала предупреждений при импортах начислений в закрытый период
*/
Ext.define('B4.view.import.PersonalAccountCompareInChargesGrid', {
    extend: 'B4.form.Window',
    alias: 'widget.compareinchargesgrid',
    itemId: 'compareinchargesgrid',
