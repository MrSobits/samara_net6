﻿/**
 * Форма импорта начислений в закрытый период
 */
Ext.define('B4.view.import.ChargesToClosedPeriodsPanel', {
    ...
    title: 'Импорт начислений (в закрытые периоды)',
    alias: 'widget.chargestoclosedperiodspanel',
    closable: true,
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    name: 'chargesToClosedPeriodsImportForm', // Указывается в аспекте импорта
                                    itemId: 'importForm',
                                    layout: {
                                        type: 'hbox'
                                    },
