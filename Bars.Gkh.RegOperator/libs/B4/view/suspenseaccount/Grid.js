Ext.define('B4.view.suspenseaccount.Grid', {
    extend: 'B4.ux.grid.Panel',

    alias: 'widget.suspenseaccountgrid',
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            ...
            columns: [
                ...
                {
                    xtype: 'b4enumcolumn',
                    dataIndex: 'SuspenseAccountStatus',
                    enumName: 'B4.enums.SuspenseAccountStatus', // перечисление
                    filter: true, // создать фильтр
                    width: 130,
                    text: 'Статус'
                },
