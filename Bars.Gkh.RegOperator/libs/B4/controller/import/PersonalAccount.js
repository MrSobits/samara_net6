Ext.define('B4.controller.import.PersonalAccount', {
    extend: 'B4.base.Controller',

    views: ['Import.PersonalAccount'],

    mainView: 'Import.PersonalAccount',
    mainViewSelector: 'personalaccountimport',

    refs: [{
        ref: 'mainView',
        selector: 'personalaccountimport'
    }],
    ...
    loadButtonClick: function () {
        ...
        me.params = {};
        me.params.importId = 'Bars.Gkh.Import.BillingGkuDataImport';
