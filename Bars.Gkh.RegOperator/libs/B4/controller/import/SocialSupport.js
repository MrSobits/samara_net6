Ext.define('B4.controller.import.SocialSupport', {
    extend: 'B4.base.Controller',

    views: ['Import.SocialSupport'],

    mainView: 'Import.SocialSupport',
    mainViewSelector: 'socialsupportimport',

    refs: [{
        ref: 'mainView',
        selector: 'socialsupportimport'
    }],
    ...
    loadButtonClick: function () {
        ...
        me.params = {};
        me.params.importId = 'Bars.Gkh.RegOperator.Imports.SocialSupport.SocialSupportImport';
    ...
    index: function () {
        var view = this.getMainView() || Ext.widget('personalaccountimport');
