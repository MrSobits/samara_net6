Ext.define('B4.controller.report.OwnersRoInLongTermPr', {
    extend: 'B4.controller.BaseReportController',

    mainView: 'B4.view.report.OwnersRoInLongTermPrPanel',
    mainViewSelector: '#ownersRoInLongTermPrPanel',
    ...
    parentMuTriggerFieldSelector: '#ownersRoInLongTermPrPanel #tfParentMu',
    municipalityTriggerFieldSelector: '#ownersRoInLongTermPrPanel #tfMunicipality',
    actualityDateFieldSelector: '#ownersRoInLongTermPrPanel #dfActualityDate',

    aspects: [
        {
            xtype: 'gkhtriggerfieldmultiselectwindowaspect',
            name: 'ParentMuMultiselectwindowaspect',
            fieldSelector: '#ownersRoInLongTermPrPanel #tfParentMu',
        ...
        },
        {
            ...
            fieldSelector: '#ownersRoInLongTermPrPanel #tfMunicipality',
            multiSelectWindow: 'SelectWindow.MultiSelectWindow',
            ...
            onBeforeLoad: function (store, operation) {
                var parentMuField = Ext.ComponentQuery.query('#ownersRoInLongTermPrPanel #tfParentMu')[0];
