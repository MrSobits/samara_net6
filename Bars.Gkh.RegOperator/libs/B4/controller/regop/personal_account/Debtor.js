Ext.define('B4.controller.regop.personal_account.Debtor', {
    ...
    aspects: [
        {
            ...
            permissions: [
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.ClaimWorkForm', applyTo: 'button[action="CreateClaimWork"]', selector: 'debtorgrid',
                ...
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.Columns.BaseTariffDebtSum', applyTo: '[dataIndex=DebtBaseTariffSum]', selector: 'debtorgrid',
                    applyBy: function (component, allowed) {
                        if (component) component.setVisible(allowed);
                    }
                },
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.Columns.DecisionTariffDebtSum', applyTo: '[dataIndex=DebtDecisionTariffSum]', selector: 'debtorgrid',
                    applyBy: function (component, allowed) {
                        if (component) component.setVisible(allowed);
                    }
                },
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.Columns.DebtSum', applyTo: '[dataIndex=DebtSum]', selector: 'debtorgrid',
                    applyBy: function (component, allowed) {
                        if (component) component.setVisible(allowed);
                    }
                },
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.Column.MonthCount', applyTo: '[dataIndex=ExpirationMonthCount]', selector: 'debtorgrid',
                    applyBy: function (component, allowed) {
                ...
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.Column.HasClaimWork', applyTo: '[dataIndex=HasClaimWork]', selector: 'debtorclaimworkgrid',
                    applyBy: function (component, allowed) {
                        if (allowed) component.show();
                        else component.hide();
                    }
                ...
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.Column.CourtType', applyTo: '[dataIndex=CourtType]', selector: 'debtorgrid',
                    applyBy: function (component, allowed) {
                        if (allowed) component.show();
                        else component.hide();
                    }
                ...
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.Column.JurInstitution', applyTo: '[dataIndex=JurInstitution]', selector: 'debtorgrid',
                    applyBy: function (component, allowed) {
                        if (allowed) component.show();
                        else component.hide();
                    }
                ...
                {
                    name: 'GkhRegOp.PersonalAccountOwner.Debtor.UpdateJurInstitution', applyTo: 'button[action=UpdateJurInstitution]', selector: 'debtorgrid',
                    applyBy: function (component, allowed) {
                        if (allowed) {
                            component.show();
                        } else {
    ...
    createClaimWorksByAccNum: function (btn) {
        var me = this,
            ...
            postParams = Ext.applyIf(filters, {
                ids: selected
            });
