namespace Bars.Gkh.RegOperator.Domain.ImportExport.ImportMaps
{
    ...
    public class PersonalAccountInfoSberNoFioMap : AbstractImportMap<PersonalAccountInfoProxy>
    {
        public override string ProviderCode
        {
            get { return "sber_no_fio"; }
        }

        public override string ProviderName
        {
            get { return "Сбер (без ФИО)"; }
        }
        ...
        public PersonalAccountInfoSberNoFioMap()
        {
