namespace Bars.Gkh.RegOperator.ViewModels.Import
{
    ...
    /// </summary>
    public class AccountWarningInClosedPeriodsImportViewModel : BaseViewModel<AccountWarningInClosedPeriodsImport>
    {
        /// <summary>
        /// Журнал импорта
        /// </summary>
        ...
        /// </summary>
        /// <param name="domainService">Доменный сервис для AccountWarningInClosedPeriodsImport</param>
        /// <param name="baseParams">Параметры от браузера</param>
        /// <returns>Набор данных для грида</returns>
        public override IDataResult List(IDomainService<AccountWarningInClosedPeriodsImport> domainService, BaseParams baseParams)
        {
