...
16|Поле "Способ формирования фонда КР"|Для выбора предполагаемого способа формирования фонда КР в доме (на спец.счете или на счете регионального оператора)|Нажмите кнопку{@img element8.png}выберите значение из выпадающего списка 
