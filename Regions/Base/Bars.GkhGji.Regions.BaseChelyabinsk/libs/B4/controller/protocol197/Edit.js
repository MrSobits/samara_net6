Ext.define('B4.controller.protocol197.Edit', {
    ...
    views: [
        ...
        'protocol197.DefinitionEditWindow',
        'protocol197.DefinitionGrid',
        'SelectWindow.MultiSelectWindow',
        'SelectWindow.MultiSelectWindowTree',
        'dict.physicalpersondoctype.Grid'
    ],
    ...
    aspects: [
        {
            ...
            name: 'protocol197CreateButtonAspect',
            buttonSelector: '#protocol197EditPanel gjidocumentcreatebutton',
            containerSelector: '#protocol197EditPanel',
            typeDocument: 140 // Тип документа Протокол МЖК
        },
        {
            /*
        ...
        {   /*
            ...
            */
            ...
            otherActions: function (actions) {
                ...
                actions[this.editPanelSelector + ' #ecPlaceOffense'] = { 'change': { fn: this.onChangePlaceOffense, scope: this } };
            },
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                this.controller.getAspect('protocol197CreateButtonAspect').setData(rec.get('Id'));
                asp.controller.afterset = true;
            },
            ...
            onChangePlaceOffense: function (field, value) {
                var me = this;
                var panel = this.getPanel(),
                    protocolFiasPlaceAddressField = panel.down('#protocolFiasPlaceAddressField'),
                    judsectorField = panel.down('#sfJudSector');
                if (me.controller.afterset) {
                    if (value == 20) {
                        protocolFiasPlaceAddressField.setValue('');
                        judsectorField.setValue('');
                    }
                }
                //     tfAddressViolation.setDisabled(!value || value == 10);
            },
            ...
            setTypeExecutantPermission: function (typeExec) {
                var me = this,
                    ...
                    dfPhysicalPersonDocType = panel.down('#dfPhysicalPersonDocType'),
                    dfPhysicalPersonDocumentSerial = panel.down('#dfPhysicalPersonDocumentSerial'),
                    dfPhysicalPersonDocumentNumber = panel.down('#dfPhysicalPersonDocumentNumber'),
                    dfPhysicalPersonIsNotRF = panel.down('#dfPhysicalPersonIsNotRF'),
                ...
                dfPhysicalPersonDocType.setDisabled(true);
                dfPhysicalPersonDocumentSerial.setDisabled(true);
                dfPhysicalPersonDocumentNumber.setDisabled(true);
                dfPhysicalPersonIsNotRF.setDisabled(true);
                ...
                if (typeExec) {
                    ...
                    dfPhysicalPersonDocType.setDisabled(!(type === 1 || type === 3 || type === 4));
                    dfPhysicalPersonDocumentSerial.setDisabled(!(type === 1 || type === 3 || type === 4));
                    dfPhysicalPersonDocumentNumber.setDisabled(!(type === 1 || type === 3 || type === 4));
                    dfPhysicalPersonIsNotRF.setDisabled(!(type === 1 || type === 3 || type === 4));
        ...
        {
            xtype: 'gkhbuttonprintaspect',
            name: 'protocol197DefinitionPrintAspect',
            buttonSelector: '#protocol197DefinitionEditWindow #btnPrint',
            codeForm: 'Protocol197Definition',
            getUserParams: function (reportId) {
                var me = this,
        ...
        },
        {
            ...
            */
            xtype: 'grideditwindowaspect',
            name: 'protocol197DefinitionAspect',
            gridSelector: 'protocol197DefinitionGrid',
            editFormSelector: '#protocol197DefinitionEditWindow',
            storeName: 'protocol197.Definition',
            modelName: 'protocol197.Definition',
            editWindowView: 'protocol197.DefinitionEditWindow',
            ...
            setDefinitionId: function (id) {
                ...
                if (id) {
                  me.controller.getAspect('protocol197DefinitionPrintAspect').loadReportStore();
                }
            }
        },
        {
    ...
    init: function () {
        ...
        me.getStore('protocol197.Definition').on('beforeload', me.onBeforeLoad, me);
    ...
    onLaunch: function () {
        ...
        if (me.params) {
          ...
          //  me.params.documentId = me.params.documentId;
            ...
            me.getStore('protocol197.Definition').load();
        }
    },
