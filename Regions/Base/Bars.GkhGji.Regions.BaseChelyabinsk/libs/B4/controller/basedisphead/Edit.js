Ext.define('B4.controller.basedisphead.Edit', {
    ...
    aspects: [
        ...
        },
        {
            ...
            permissions: [
                {
                    name: 'GkhGji.Inspection.BaseDispHead.Register.RealityObject.Column.RoomNums', applyTo: '[dataIndex=RoomNums]', selector: '#baseDispHeadRealityObjectGrid',
        ...
        },
        {
            ...
            */
            ...
            gridSelector: 'baseDispHeadRealityObject',
            ...
            addRoomNumsButtonHandler: function() {
                var me = this,
                    selectedArray = me.controller.getMainView().down('baseDispHeadRealityObject').selModel.getSelection();
