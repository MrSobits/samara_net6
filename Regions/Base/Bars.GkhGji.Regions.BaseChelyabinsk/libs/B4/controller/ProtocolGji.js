Ext.define('B4.controller.ProtocolGji', {
    ...
    aspects: [
           ...
           //     tfAddressViolation.setDisabled(!value || value == 10);
            ...
            setTypeExecutantPermission: function (typeExec) {
                var me = this,
                    ...
                    dfBirthDay = panel.down('#dfBirthDay'),
                ...
                if (typeExec) {
                    ...
                    B4.Ajax.request({
                        ...
                        dfBirthDay.setDisabled(!(type === 1 || type === 3 || type === 4) || !perm[1]);
                        tfPhysPerson.allowBlank = tfPhysPerson.disabled;
                        dfPhysicalPersonDocType.setDisabled(!(type=== 1 || type === 3 || type === 4) || !perm[1]);
                        dfPhysicalPersonDocumentSerial.setDisabled(!(type=== 1 || type === 3 || type === 4) || !perm[1]);
                        dfPhysicalPersonDocumentNumber.setDisabled(!(type === 1 || type === 3 || type === 4) || !perm[1]);
                        dfPhysicalPersonDocumentSerial.allowBlank = dfPhysicalPersonDocumentSerial.disabled;
                        dfPhysicalPersonDocumentNumber.allowBlank = dfPhysicalPersonDocumentNumber.disabled;
                        dfPhysicalPersonIsNotRF.setDisabled(!(type=== 1 || type === 3 || type === 4) || !perm[1]);

                        // только для должностных лиц
                        tfPosition.setDisabled(type !== 1);
                        tfPosition.allowBlank = tfPosition.disabled;
            ...
            onChangeTypePresence: function (_, value) {
                ...
                tfRepresentative.setDisabled(value < 10);
        ...
        },
        {
            ...
            controllerName: 'ChelyabinskProtocol',
