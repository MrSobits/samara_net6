Ext.define('B4.view.prescription.EditPanel', {
    ...
    requires: [
        ...
        'B4.view.prescription.OfficialReportGrid',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    fieldLabel: 'Дата решения о продлении',
                                    format: 'd.m.Y',
                                    allowBlank: true,
                                    labelWidth: 180,
                                    width: 300
                    ...
                    items: [
                        {
                            ...
                            bodyStyle: Gkh.bodyStyle,
                            title: 'Реквизиты',
                            itemId: 'prescriptionRequisitesTab',
                            border: false,
                            bodyPadding: 5,
                            defaults: {
                                labelAlign: 'right',
                        ...
                        },
                        {
                            ...
                            title: 'Деятельность',
                            border: false,
                            itemId: 'prescriptionDirectionsTab',
                            bodyPadding: 5,
                            defaults: {
                                labelAlign: 'right',
                                labelWidth: 170
                        ...
                        {
                            xtype: 'prescriptionofficialreportgrid',
                            flex: 1
                        }
                    ]
                }
