namespace Bars.GkhGji.Regions.BaseChelyabinsk.Report
{
    ...
    /// Отчет для приказа
    /// </summary>
    public class ChelyabinskDisposalStimulReport : GjiBaseStimulReport
    {
        #region .ctor
        ...
        /// Конструктор
        /// </summary>
        public ChelyabinskDisposalStimulReport() : base(new ReportTemplateBinary(Properties.Resources.ChelyabinskDisposal))
        {
        }
        ...
        {
            get { return "ChelyabinskDisposal"; }
        }
