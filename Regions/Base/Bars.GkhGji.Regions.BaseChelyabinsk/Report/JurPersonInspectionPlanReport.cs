namespace Bars.GkhGji.Regions.BaseChelyabinsk.Report
{
    ...
    public class JurPersonInspectionPlanReport : BasePrintForm
    {
        ...
        public JurPersonInspectionPlanReport(
            ...
            : base(new ReportTemplateBinary(Resources.JurPersonInspectionPlanReport))
        {
            this._jurPersonDomain = jurPersonDomain;
            this._inspectionRoDomain = inspectionRoDomain;
            this._inspectionContragentDomain = inspectionContragentDomain;
        }
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            var jurPersons = this._jurPersonDomain.GetAll()
                .Where(x => x.DateStart != null 
                    && x.DateStart.Value.Year == this.year)
                .ToList();

            var inspectionRos =
                this._inspectionRoDomain.GetAll().ToList();

            var inspectionContragents = 
                this._inspectionContragentDomain.GetAll().ToList();
            ...
            foreach (var jurPerson in jurPersons)
            {
                ...
                if (jurPerson.Contragent != null)
                {
                    ...
                    {
                        var lastCheck = this._jurPersonDomain.GetAll()
