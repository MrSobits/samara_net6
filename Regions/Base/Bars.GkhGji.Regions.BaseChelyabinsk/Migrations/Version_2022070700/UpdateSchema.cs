namespace Bars.GkhGji.Regions.BaseChelyabinsk.Migrations.Version_2022070700
{
    ...
    public class UpdateSchema : Migration
    {
        public override void Up()
        {
            ...
            "GJI_CH_SMEV_MVDPLACEREG",
              ...
              new RefColumn("FILE_ID", ColumnProperty.None, "GJI_CH_SMEV_MVDPLACEREG_FILE_ID", "B4_FILE_INFO", "ID"),
              new RefColumn("INSPECTOR_ID", ColumnProperty.NotNull, "GJI_CH_SMEV_MVDPLACEREG_INSPECTOR_ID", "GKH_DICT_INSPECTOR", "ID"),
            ...
            Database.AddEntityTable(
           "GJI_CH_SMEV_MVDPLACEREG_FILE",
           new Column("FILE_TYPE", DbType.Int32, 4, ColumnProperty.NotNull),
           new RefColumn("MVDPLACEREG_ID", ColumnProperty.None, "GJI_CH_SMEV_MVDPLACEREG_FILE_MVD_ID", "GJI_CH_SMEV_MVDPLACEREG", "ID"),
           new RefColumn("FILE_INFO_ID", ColumnProperty.NotNull, "GJI_CH_SMEV_MVDPLACEREG_FILE_FILE_INFO_ID", "B4_FILE_INFO", "ID"));
        }

        public override void Down()
        {
            Database.RemoveTable("GJI_CH_SMEV_MVDPLACEREG_FILE");
            Database.RemoveTable("GJI_CH_SMEV_MVDPLACEREG");
        }
