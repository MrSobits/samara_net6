namespace Bars.GkhGji.Regions.BaseChelyabinsk.Controllers.ActRemoval
{
    ...
    public class ActRemovalAnnexController : ActRemovalAnnexController<ActRemovalAnnex>
    {
    ...
    public class ActRemovalAnnexController<T> : B4.Alt.DataController<T>
        where T : ActRemovalAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public ActRemovalAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
