namespace Bars.GkhGji.Regions.BaseChelyabinsk.Controllers.Prescription
{
    ...
    /// </summary>
    public class ChelyabinskPrescriptionController : PrescriptionController<ChelyabinskPrescription>
    {
        /// <summary>
