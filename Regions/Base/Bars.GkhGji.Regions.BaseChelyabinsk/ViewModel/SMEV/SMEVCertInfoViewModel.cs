namespace Bars.GkhGji.Regions.BaseChelyabinsk.ViewModel
{
    ...
    public class SMEVCertInfoViewModel : BaseViewModel<SMEVCertInfo>
    {
        public override IDataResult List(IDomainService<SMEVCertInfo> domainService, BaseParams baseParams)
        {
