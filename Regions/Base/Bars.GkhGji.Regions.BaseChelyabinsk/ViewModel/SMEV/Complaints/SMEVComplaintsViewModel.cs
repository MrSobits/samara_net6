namespace Bars.GkhGji.Regions.BaseChelyabinsk.ViewModel
{
    ...
    public class SMEVComplaintsViewModel : BaseViewModel<SMEVComplaints>
    {
        public override IDataResult List(IDomainService<SMEVComplaints> domainService, BaseParams baseParams)
        {
            ...
            var data = domainService.GetAll()
                .Select(x => new
                {
                    ...
                    x.ComplaintDate,
                    x.RequesterRole,
                    RequesterName = x.RequesterContragent != null ? x.RequesterContragent.Name : x.RequesterFIO,
                    x.AppealNumber,
                    x.Answer,
                    x.FileInfo
                })
