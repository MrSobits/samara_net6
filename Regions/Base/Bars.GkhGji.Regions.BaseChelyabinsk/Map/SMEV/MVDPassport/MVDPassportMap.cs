namespace Bars.GkhGji.Regions.BaseChelyabinsk.Map
{
    ...
    public class MVDPassportMap : BaseEntityMap<MVDPassport>
    {
        
        public MVDPassportMap() : 
                base("Запрос к ВС МВД", "GJI_CH_SMEV_MVDPASSPORT")
        {
        }
        ...
        protected override void Map()
        {
            ...
            Property(x => x.MVDPassportRequestType, "Тип запроса").Column("REQUEST_TYPE");
