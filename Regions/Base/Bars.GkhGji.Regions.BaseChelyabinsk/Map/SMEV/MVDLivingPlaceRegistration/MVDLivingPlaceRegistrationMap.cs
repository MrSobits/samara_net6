namespace Bars.GkhGji.Regions.BaseChelyabinsk.Map
{
    ...
    public class MVDLivingPlaceRegistrationMap : BaseEntityMap<MVDLivingPlaceRegistration>
    {
        
        public MVDLivingPlaceRegistrationMap() : 
                base("Запрос к ВС МВД", "GJI_CH_SMEV_MVDPLACEREG")
        {
        }
