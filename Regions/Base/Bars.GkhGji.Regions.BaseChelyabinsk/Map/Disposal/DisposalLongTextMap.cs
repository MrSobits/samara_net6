...
namespace Bars.GkhGji.Regions.BaseChelyabinsk.Map.Disposal
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Chelyabinsk.Entities.Disposal.DisposalLongText"</summary>
    public class DisposalLongTextMap : BaseEntityMap<DisposalLongText>
    {
        
        public DisposalLongTextMap() : 
                base("Bars.GkhGji.Regions.Chelyabinsk.Entities.Disposal.DisposalLongText", "GJI_NSO_DISP_LTEXT")
        {
        }
        
        protected override void Map()
        {
            this.Reference(x => x.Disposal, "Disposal").Column("DISPOSAL_ID").NotNull();
