namespace Bars.GkhGji.Regions.BaseChelyabinsk.DomainService.Impl
{
    ...
    /// </summary>
	public class ChelyabinskProtocolService : ProtocolService, IChelyabinskProtocolService
    {
        /// <summary>
        ...
        public override IDataResult GetInfo(long? documentId)
        {
            ...
            var reqService = this.Container.ResolveDomain<ChelyabinskProtocolSurveySubjectRequirement>();
            ...
            try
            {
                ...
                return
                    new BaseDataResult(
                        new ChelyabinskProtocolGetInfoProxy
                            {
        ...
        public IDataResult AddRequirements(BaseParams baseParams)
        {
            ...
            var domain = this.Container.ResolveDomain<ChelyabinskProtocolSurveySubjectRequirement>();
            try
            {
                var reqs =
                    domain.GetAll()
                    ...
                    () =>
                        {
                            ...
                            foreach (var reqId in reqIds)
                            {
                                ...
                                domain.Save(
                                    new ChelyabinskProtocolSurveySubjectRequirement
                                        {
                                            Protocol =
                                                new ChelyabinskProtocol { Id = documentId },
                                            Requirement =
                            ...
                            foreach (var dirId in dirIds)
                            {
                                ...
                                domain.Save(
                                    new ProtocolActivityDirection
                                        {
                                            Protocol = new ChelyabinskProtocol { Id = documentId },
                                            ActivityDirection =
    ...
    /// </summary>
    public class ChelyabinskProtocolGetInfoProxy : ProtocolGetInfoProxy
    {
        /// <summary>
