...
namespace Bars.GkhGji.Regions.BaseChelyabinsk.StateChange
{
    ...
    public class PrescriptionStateChangeChelyabinskRule : IRuleChangeStatus
    {
        ...
        public ValidateResult Validate(IStatefulEntity statefulEntity, State oldState, State newState)
        {
            ...
            {
                var prescriptionViolQuery = this.PrescriptionViolDomain.GetAll()
                    .Where(x => x.Document.Id == prescription.Id);

                var anyPrescriptionWithSameViols = this.PrescriptionViolDomain.GetAll()
                ...
                var anyPrescriptionVithSameViolsAndState = anyPrescriptionWithSameViols
                    .Where(x => this.PrescriptionDomain.GetAll().Any(y => y.Id == x.documentId && y.State == newState))
