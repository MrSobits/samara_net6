namespace Bars.GkhGji.Regions.BaseChelyabinsk.Interceptors.Inspection
{
    using System;
    using System.Linq;
    ...
    public class BaseJurPersonServiceInterceptor : BaseJurPersonServiceInterceptor<BaseJurPerson>
    {
        ...
        {
            string msg;
            if (!this.Validation(service, entity, out msg))
            {
        ...
        {
            var jurPersonContragentDomain = this.Container.Resolve<IDomainService<BaseJurPersonContragent>>();
            ...
            try
            {
                ...
                {
                    jurPersonContragentDomain.Delete(jurPersonContragent.Id);
                }
            ...
            {
                this.Container.Release(jurPersonContragentDomain);
            }
        }
        ...
        private bool Validation(IDomainService<BaseJurPerson> service, BaseJurPerson entity, out string message)
        {
            ...
            var serviceBusinesactivity = this.Container.Resolve<IDomainService<BusinessActivity>>();
            ...
            {
                this.Container.Release(serviceBusinesactivity);
            }
