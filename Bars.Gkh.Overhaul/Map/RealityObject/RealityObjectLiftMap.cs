namespace Bars.Gkh.Overhaul.Map
{
    ...
    /// <summary>
    /// Маппинг <see cref="OvrhlRealityObjectLift"/>
    /// </summary>
    public class RealityObjectLiftMap : BaseImportableEntityMap<OvrhlRealityObjectLift>
    {
        /// <summary>
        /// .ctor
        /// </summary>
        ...
        protected override void Map()
        {
            ...
            this.Reference(x => x.RealityObjectStructuralElement, "RO_STRUCT_EL_ID").Column("RO_STRUCT_EL_ID").Fetch();
        }
    }
}