Ext.define('B4.view.realityobj.structelement.HistoryGrid', {
    ...
    alias: 'widget.rostructelhistorygrid',

    title: 'История изменений',

    initComponent: function () {
        var me = this,
            store = Ext.create("B4.store.realityobj.StructElHistory");
        ...
        Ext.apply(me, {
            ...
            columns: [
                ...
                { text: 'Конструктивный элемент', dataIndex: 'EntityDescription', flex: 2, renderer: function (val) { return val.substring(val.indexOf('-') + 1); }, filter: {xtype: 'textfield'} },
                {
                    xtype: 'datecolumn',
                    text: 'Дата/время',
