namespace Bars.Gkh.Domain.PaymentDocumentNumber.Impl
{
    ...
    /// <summary>
    /// Правило для добавления символа '-' дефис
    /// </summary>
    internal class PaymentDocumentNumberRuleDash: PaymentDocumentNumberRuleBase
    {
        /// <summary>
        /// Конструктор класса
        /// </summary>
        /// <param name="container">IoC контейнер</param>
        public PaymentDocumentNumberRuleDash(IWindsorContainer container) 
            : base(container)
        {
        }
