namespace Bars.Gkh.Services.DataContracts.HousesInfo
{
    ...
    public class HouseInfo
    {
        ...
        /// </summary>
        [DataMember]
        [XmlElement(ElementName = "ArrayOfHouseLift")]
        public LiftArray HouseLifts { get; set; }

        /// <summary>
        /// Сведения по приборам учёта
        /// </summary>
        [DataMember]
        [XmlElement(ElementName = "ArrayOfHouseMeteringDevice")]
        public MeteringDeviceArray MeteringDevices { get; set; }
        ...
        /// <summary>
        /// Сведения о газоснабжении МКД
        /// </summary>
        [DataMember]
        [XmlElement(ElementName = "GasInfo")]
        public GasInfo GasInfo { get; set; }

        /// <summary>
        /// Сведения о пожатротушении МКД
        /// </summary>
        [DataMember]
        [XmlElement(ElementName = "FirefightingInfo")]
        public FirefightingInfo FirefightingInfo { get; set; }

        /// <summary>
        /// Сведения о Вентиляции МКД
        /// </summary>
        [DataMember]
        [XmlElement(ElementName = "VentilationInfo")]
        public VentilationInfo VentilationInfo { get; set; }
    }
    ...
    public class GasInfo
    {
        ...
        /// <summary>
        /// Год последнего капремонта системы газоснабжения
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "GasLastYear")]
        public string GasLastYear { get; set; }
    }
    ...
    /// </summary>
    [DataContract]
    [XmlType(TypeName = "FirefightingInfo")]
    public class FirefightingInfo
    {
        /// <summary>
        /// Пожаротушение
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "FirefightingType")]
        public string FirefightingType { get; set; }
    }

    [DataContract]
    [XmlType(TypeName = "TypesWork")]
    public class TypesWork
    {
        /// <summary>
        /// Наименование работы последнего капитального ремонта
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "TypesWorkOverhaul")]
        ...
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "DatePerformance")]
        public string DatePerformance { get; set; }
    ...
    /// </summary>
    [DataContract]
    [XmlType(TypeName = "ArrayOfHouseLifts")]
    public class LiftArray
    {
        ...
        /// </summary>
        [DataMember]
        [XmlElement(ElementName = "HouseLift")]
        public LiftInfo[] HouseLifts { get; set; }
    }
    ...
    public class LiftInfo
    {
        ...
        /// <summary>
        /// Год ввода в экплуатацию
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "CommissioningУear")]
        public int CommissioningУear { get; set; }

        /// <summary>
        /// Тип лифта	
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "HouseLiftType")]
        public string HouseLiftType { get; set; }
    }
    ...
    /// </summary>
    [DataContract]
    [XmlType(TypeName = "ArrayOfHouseMeteringDevice")]
    public class MeteringDeviceArray
    {
        /// <summary>
        /// Сведения по приборам учета
        /// </summary>
        ...
        public MeteringDeviceInfo[] MeteringDevices { get; set; }
    }
    ...
    /// </summary>
    [DataContract]
    [XmlType(TypeName = "MeteringDevice")]
    public class MeteringDeviceInfo
    {
        /// <summary>
        /// Номер прибора учета
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "NumberOfMeteringDevice")]
        public string NumberOfMeteringDevice { get; set; }

        /// <summary>
        /// Вид коммунального ресурса
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "TypePublicLife")]
        public string TypePublicLife { get; set; }

        /// <summary>
        /// Наличие прибора учета
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "MetersInstalled")]
        public string MetersInstalled { get; set; }
        ...
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "UnitAccountingDevice")]
        public string UnitAccountingDevice { get; set; }

        /// <summary>
        /// Дата ввода в эксплуатацию
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "DateOfCommissioningMeteringDevice")]
        public DateTime DateOfCommissioningMeteringDevice { get; set; }

        /// <summary>
        /// Дата проверки/замены
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "DateReplacingMeteringDevice")]
        public DateTime DateReplacingMeteringDevice { get; set; }
    }
    ...
    /// </summary>
    [DataContract]
    [XmlType(TypeName = "VentilationInfo")]
