namespace Bars.Gkh.Migrations._2018.Version_2018060600
{
    using System.Data;
    using Bars.B4.Modules.Ecm7.Framework;
    using Bars.B4.Modules.NH.Migrations.DatabaseExtensions;

    [Migration("2018060600")]
    [MigrationDependsOn(typeof(Version_2018060500.UpdateSchema))]
            ...
            Database.ExecuteQuery(@"
                ...
                CREATE OR REPLACE VIEW public.view_clw_individual_claim_work AS 
                 SELECT getviewindividualclaimwork.id,
                    ...
                    getviewindividualclaimwork.debt_paid_date,
                    getviewindividualclaimwork.user_id
                   FROM getviewindividualclaimwork() getviewindividualclaimwork(id, debtor_state, state_id, municipality, registration_address, account_owner_name, accounts_number, accounts_address, cur_charge_base_tariff_debt, cur_charge_decision_tariff_debt, cur_charge_debt, cur_penalty_debt, is_debt_paid, debt_paid_date, user_id);
