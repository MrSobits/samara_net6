...
namespace Bars.Gkh.Report
{
    ...
    class ReferenceOnGroundsAccident : BasePrintForm
    {
        ...
        public ReferenceOnGroundsAccident()
            : base(new ReportTemplateBinary(Properties.Resources.ReferenceOnGroundsAccident))
        {
        }
        ...
        public override string Name
        {
            get
            {
                return "Справка по основаниям аварийности (Приложение 4)";
            }
        }
        ...
        public override string ParamsController
        {
            get
            {
                return "B4.controller.report.ReferenceOnGroundsAccident";
            }
        }
        ...
        public override string RequiredPermission
        {
            get
            {
                return "Reports.GKH.ReferenceOnGroundsAccident";
            }
        }
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            var infoEmergRealObjByCountFloors = serviceEmergencyObject.GetAll()
                         ...
                         .Where(x => x.ReasonInexpedient != null)
                         .GroupBy(x => x.ReasonInexpedient.Code)
                         .Select(x => new
                         {
                             x.Key,
            ...
            var infoEmergRealObjByFinPrCountFloors = serviceEmerObjResettlementProgram.GetAll()
                        ...
                        .Where(x => x.EmergencyObject.ReasonInexpedient != null)
                        .GroupBy(x => new { ReasonInexpedientCode = x.EmergencyObject.ReasonInexpedient.Code, x.ResettlementProgramSource.Code })
                        .Select(x => new
                        {
                            x.Key,
                        ...
                        .ToDictionary(x => x.Key, x => x
                               .GroupBy(y => y.Key.ReasonInexpedientCode)
            ...
            var columns = Enumerable.Range(1, 6).Select(x => x.ToStr()).ToList();
