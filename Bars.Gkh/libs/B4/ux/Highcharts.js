...
Ext.define('B4.ux.Highcharts', {
    ...
    basicSerieCls: 'B4.ux.Highcharts.Serie',
    ...
    afterRender: function () {
        ...
        Ext.applyIf(_this.chartConfig, {
            xAxis: [{}],
            credits: {
                // Если нужна ссылочка в нижнем правом углу, то этот конфиг можно доопределеить во вьюхе
                href: null,
                text: null
            }
        });
