Ext.define('B4.controller.servorg.Activity', {
    ...
    views: ['servorg.ActivityPanel'],
    
    mainView: 'servorg.ActivityPanel',
    mainViewSelector: 'servorgactivitypanel',
    ...
    aspects: [
        {
            xtype: 'gkheditpanel',
            name: 'servorgActivityPanelAspect',
            editPanelSelector: 'servorgactivitypanel',
            ...
            btnActivityPanelRefresh: function() {
                this.setData(this.controller.getContextValue(this.controller.getMainView(), 'servorgId'));
            },
            listeners: {
    ...
    index: function (id) {
        var me = this,
            view = me.getMainView() || Ext.widget('servorgactivitypanel');

        me.bindContext(view);
        me.setContextValue(view, 'servorgId', id);
        me.application.deployView(view, 'serv_org');

        me.getAspect('servorgActivityPanelAspect').setData(id);
    }
});