Ext.define('B4.controller.report.NoteByReestrHouses', {
    extend: 'B4.controller.BaseReportController',

    mainView: 'B4.view.report.NoteByReestrHousesPanel',
    mainViewSelector: '#noteByReestrHousesPanel',
    ...
    municipalityTriggerFieldSelector: '#noteByReestrHousesPanel #tfMunicipality',
    reportDateFieldSelector:'#noteByReestrHousesPanel #dfReportDate',

    aspects: [
        {
            xtype: 'gkhtriggerfieldmultiselectwindowaspect',
            name: 'MunMultiselectwindowaspect',
            fieldSelector: '#noteByReestrHousesPanel #tfMunicipality',
            multiSelectWindow: 'SelectWindow.MultiSelectWindow',
            multiSelectWindowSelector: '#noteByReestrHousesPanelMunicipalitySelectWindow',
