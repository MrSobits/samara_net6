Ext.define('B4.controller.import.oktmo.MunicipalityFiasOktmo', {
    extend: 'B4.base.Controller',

    views: ['Import.oktmo.MunicipalityFiasOktmo'],

    mainView: 'Import.oktmo.MunicipalityFiasOktmo',
    mainViewSelector: 'municipalityfiasoktmoimport',

    refs: [{
        ref: 'mainView',
        selector: 'municipalityfiasoktmoimport'
    }],
    ...
    init: function () {
        ...
        this.control({
            'municipalityfiasoktmoimport button': {
    ...
    loadButtonClick: function () {
        ...
        me.params = {};
        me.params.importId = 'Bars.Gkh.Import.ImportOktmo.MunicipalityFiasOktmoImport';
    ...
    index: function () {
        var view = this.getMainView() || Ext.widget('municipalityfiasoktmoimport');
