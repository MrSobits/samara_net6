Ext.define('B4.view.Import.ManagingOrganizationPanel', {
    extend: 'Ext.panel.Panel',
    requires: [
        'B4.form.FileField'
    ],
    title: 'Импорт лицензий',
    alias: 'widget.managingorganizationimportpanel',
    layout: 'anchor',
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                },
                {
                    ...
                    labelWidth: 200,
                    name: 'IsDebtPaid',
                    fieldLabel: 'Удалить данные перед импортом'
                },
                {
                    xtype: 'form',
                    border: false,
