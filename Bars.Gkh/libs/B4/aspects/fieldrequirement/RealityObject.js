Ext.define('B4.aspects.fieldrequirement.RealityObject', {
    ...
    init: function () {
        this.requirements = [
            ...
            { name: 'Gkh.RealityObject.Field.IsIncludedRegisterCHO_Rqrd', applyTo: 'field[name=IsIncludedRegisterCHO]', selector: 'realityobjEditPanel' },
            { name: 'Gkh.RealityObject.Field.IsIncludedListIdentifiedCHO_Rqrd', applyTo: 'field[name=IsIncludedListIdentifiedCHO]', selector: 'realityobjEditPanel' },
            { name: 'Gkh.RealityObject.Field.IsDeterminedSubjectProtectionCHO_Rqrd', applyTo: 'field[name=IsDeterminedSubjectProtectionCHO]', selector: 'realityobjEditPanel' },
            ...
            { name: 'Gkh.RealityObject.Field.NumberNonResidentialPremises_Rqrd', applyTo: '#nfNumberNonResidentialPremises', selector: 'realityobjEditPanel' }
        ];
