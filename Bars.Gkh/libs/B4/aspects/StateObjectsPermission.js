Ext.define('B4.aspects.StateObjectsPermission', {
    extend: 'B4.aspects.TreePermission',
    alias: 'widget.stateobjectspermissionaspect',
    ...
    init: function (controller) {
        var asp = this,
            ...
            winSelector = 'copyrolewindow[ctxKey='
                + controller.getCurrentContextKey() + '][name=CopyStateObjectPermissions]';
    ...
    savePermissions: function () {
        var asp = this,
            ...
            url = asp.saveUrl || '/State/UpdateObjectPermissions';
    ...
    onCopyRole: function () {
        var asp = this,
            ...
            win = Ext.widget('copyrolewindow', {
                name: 'CopyStateObjectPermissions',
                roleStore: store,
    ...
    copyRolePermissions: function (btn) {
        var asp = this,
            ...
            url = asp.copyUrl || '/State/CopyPermissions';
