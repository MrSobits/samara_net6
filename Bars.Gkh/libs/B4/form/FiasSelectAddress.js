...
Ext.define('B4.form.FiasSelectAddress', {
    ...
    validateForm: function (wind) {
        ...
        if (me.chbNoHouse.checked && me.tfHouse.getValue().trim() == "" && me.tfLetter.getValue().trim() == "" ) {
    ...
    createControls: function () {
        ...
        if (!me.win) {
            ...
            me.tfHouse.regex = regs.tfHouse ? regs.tfHouse.regex : /^\d+[А-Яа-я]{0,1}((\/)\d*[А-Яа-я]{0,1}){0,3}?$/;
            me.tfHouse.regexText = regs.tfHouse ? regs.tfHouse.regexText : 'В это поле можно вводить значение следующих форматов: 33/22, 33/А, 33/22А, 33А, 17а/1, 23б/3а, 2/4/1, 1а/13в/1, 33/22/1/33А.<br>Длина не должна превышать 20 символов.';
