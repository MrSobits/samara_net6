namespace Bars.Gkh.Entities.Suggestion
{
    ...
    /// </summary>
    public partial class SuggestionComment
    {
            ...
            return ExecutorCrFund != null
                ...
                : ExecutorManagingOrganization != null
                    ...
                    : ExecutorMunicipality != null
                        ? ExecutorType.Mu
                        : ExecutorZonalInspection != null ? ExecutorType.Gji : this.CitizenSuggestion.Rubric.FirstExecutorType;
        }
        ...
        public virtual void ApplyTransition(Transition transition, Rubric rubric = null)
        {
            ...
            if (transition != null)
            {
                ...
                if (Container.Kernel.HasComponent(typeof(ISuggestionChangeHandler)))
                {
                    ...
                    handler.ApplyChange(this, transition);
                }
            }
        }
        ...
        protected virtual void ApplyExecutor(Transition transition)
        {
            switch (transition.TargetExecutorType)
            {
                ...
                case ExecutorType.Mu:
                    ...
                    ExecutorManagingOrganization = null;
                    ExecutorZonalInspection = null;
                    ExecutorMunicipality = this.CitizenSuggestion.RealityObject.Municipality;
                    break;
        ...
        public virtual void ApplyDeadline(Transition transition)
        {
            var nextTransition = NextTransition(transition);

            if (nextTransition != null)
            {
                this.CitizenSuggestion.Deadline = DateTime.Now.AddDays(nextTransition.Return(x => x.ExecutionDeadline));
            }
        }
        ...
        public virtual ManagingOrganization GetExecutorManagingOrganization()
        {
            var manorgReality = Container.Resolve<IManagingOrgRealityObjectService>().GetCurrentManOrg(this.CitizenSuggestion.RealityObject);
        ...
        public virtual ZonalInspection GetExecutorZonalInspection()
        {
            var zonalInsp = Container.ResolveDomain<ZonalInspectionMunicipality>().GetAll()
                .FirstOrDefault(x => x.Municipality.Id == this.CitizenSuggestion.RealityObject.Municipality.Id && x.ZonalInspection != null);
        ...
        public virtual ContragentContact GetExecutorExecutorCrFund()
        {
