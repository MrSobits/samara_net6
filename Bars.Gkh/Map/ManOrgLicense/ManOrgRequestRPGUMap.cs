namespace Bars.Gkh.Map
{
    ...
    public class ManOrgRequestRPGUMap : BaseImportableEntityMap<ManOrgRequestRPGU>
    {

        public ManOrgRequestRPGUMap() : 
                base("Заявка по лицензированию", "GKH_MANORG_REQ_RPGU")
        {
        }
