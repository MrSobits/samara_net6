namespace Bars.Gkh.FormatDataExport.ExportableEntities.Impl
{
    ...
    /// <summary>
    /// 2.11.6. Работы/услуги по уставу
    /// </summary>
    public class UstavServiceExportableEntity : BaseExportableEntity
    {
        /// <inheritdoc />
        public override string Code => "USTAVSERVICE";
        ...
        {
            return this.ProxySelectorFactory.GetSelector<UstavServiceProxy>()
                .ExtProxyListCache
