namespace Bars.GkhGjiCr.Report
{
    ...
    public class Form1StateHousingInspection : BasePrintForm
    {
        ...
        // Конструктор для тех кто в других регионах создает на основе этого отчета другой отчет
        public Form1StateHousingInspection(IReportTemplate reportTemplate)
            : base( reportTemplate )
        {
        }
