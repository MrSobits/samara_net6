namespace Bars.GkhCr.Map
{
    ...
    public class TypeWorkCrMap : BaseImportableEntityMap<TypeWorkCr>
    {

        public TypeWorkCrMap()
            : base("Вид работы КР", "CR_OBJ_TYPE_WORK")
        {
        }
        ...
        protected override void Map()
        {
            ...
            this.Property(x => x.CountWorker, "Чиленность рабочих(дробное так как м.б. смысл поля как пол ставки)")
                .Column("COUNT_WORKER");
