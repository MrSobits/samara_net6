namespace Bars.GkhCr.Map
{
    ...
    public class ViewSpecialObjectCrMap : PersistentObjectMap<ViewSpecialObjectCr>
    {
        
        public ViewSpecialObjectCrMap() : 
                base("Вьюха на Объект КР для спец счетов", "VIEW_CR_SPECIAL_OBJECT")
        {
        }
