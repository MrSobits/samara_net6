namespace Bars.GkhCr.Map
{
    ...
    /// </summary>
    public class SpecialAdditionalParametersMap : BaseImportableEntityMap<SpecialAdditionalParameters>
    {
        /// <summary>
        /// .ctor
        /// </summary>
        public SpecialAdditionalParametersMap()
            : base("Bars.GkhCr.Entities.AdditionalParameters", "CR_SPECIAL_OBJ_ADDITIONAL_PARAMS")
        {
        }
