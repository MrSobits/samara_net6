namespace Bars.GkhCr.Map
{
    ...
    public class SpecialContractCrTypeWorkMap : BaseImportableEntityMap<SpecialContractCrTypeWork>
    {
        public SpecialContractCrTypeWorkMap()
            :base("Виды работ договора подряда КР", "CR_SPECIAL_CONTR_CR_TYPE_WRK")
        {
        }
