namespace Bars.GkhCr.Map
{
    ...
    public class SpecialBuildContractMap : BaseImportableEntityMap<SpecialBuildContract>
    {

        public SpecialBuildContractMap() :
                base("Договор подряда КР", "CR_SPECIAL_OBJ_BUILD_CONTRACT")
        {
        }
