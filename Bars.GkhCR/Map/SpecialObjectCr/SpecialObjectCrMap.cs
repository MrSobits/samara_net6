namespace Bars.GkhCr.Map.ObjectCr
{
    ...
    public class SpecialObjectCrMap : BaseImportableEntityMap<SpecialObjectCr>
    {
        
        public SpecialObjectCrMap() : 
                base("Объект капитального ремонта для специальных счетов", "CR_SPECIAL_OBJECT")
        {
        }
