namespace Bars.GkhCr.Map
{
    ...
    public class SpecialPerformedWorkActPaymentMap : BaseImportableEntityMap<SpecialPerformedWorkActPayment>
    {
        public SpecialPerformedWorkActPaymentMap()
            :
            base("Распоряжение к оплате акта.", "CR_SPECIAL_OBJ_PER_ACT_PAYMENT")
        {
        }
