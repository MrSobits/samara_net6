namespace Bars.GkhCr.DomainService.SpecialObjectCr
{
    ...
    /// <summary>
    /// Домен-сервис <see cref="SpecialDesignAssignment"/>
    /// </summary>
    public class SpecialDesignAssignmentDomainService : FileStorageDomainService<SpecialDesignAssignment>
    {
        /// <summary>
        ...
        {
            var values = new List<SpecialDesignAssignment>();
            this.InTransaction(() =>
            {
        ...
        private void SaveTypeWorks(SpecialDesignAssignment value, long[] ids)
        {
            ...
            {
                var typeWork = new SpecialDesignAssignmentTypeWorkCr
                {
                    DesignAssignment = value,
                    TypeWorkCr = new SpecialTypeWorkCr { Id = id }
                };
