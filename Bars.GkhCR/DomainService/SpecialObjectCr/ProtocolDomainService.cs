namespace Bars.GkhCr.DomainService
{
    ...
    public class SpecialProtocolCrDomainService : FileStorageDomainService<SpecialProtocolCr>
    {
        public override IDataResult Update(BaseParams baseParams)
        {
            var values = new List<SpecialProtocolCr>();
            ...
            this.InTransaction(() =>
            {
                ...
                foreach (var record in saveParam.Records)
                {
                    ...
                    baseParams.Files.ForEach(fileData => filesForDelete[fileData.Key] = this.SetFileInfoValue(value, fileData));
