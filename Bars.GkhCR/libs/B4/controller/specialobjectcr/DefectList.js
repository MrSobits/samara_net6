Ext.define('B4.controller.specialobjectcr.DefectList', {
    /*
    ...
    */
    ...
    requires: [
        ...
        'B4.aspects.permission.specialobjectcr.DefectList',
    ...
    models: [
        'specialobjectcr.DefectList'
    ],
    stores: [
        'specialobjectcr.DefectList'
    ],
    views: [
        'specialobjectcr.DefectListEditWindow',
        'specialobjectcr.DefectListGrid'
    ],

    refs: [
        {
            ref: 'mainView',
            selector: 'specialobjectcrdefectlistgrid'
        }
    ],
    ...
    aspects: [
        {
            xtype: 'defectlistspecialobjectcrperm',
        ...
        },
        {
            ...
            permissions: [
                { name: 'GkhCr.SpecialObjectCr.Register.DefectListViewCreate.Create', applyTo: 'b4addbutton', selector: 'specialobjectcrdefectlistgrid' }
            ]
        },
        {
            xtype: 'gkhstatepermissionaspect',
            ...
            permissions: [
                { name: 'GkhCr.SpecialObjectCr.Register.DefectList.Delete' }
            ]
        },
        {
            /**
            ...
            */
            ...
            stateButtonSelector: 'specialobjectcrdefectlistwin #btnState',
            listeners: {
        ...
        },
        {
            ...
            */
            ...
            gridSelector: 'specialobjectcrdefectlistgrid',
            stateType: 'special_cr_obj_defect_list',
        ...
        },
        {
            ...
            */
            ...
            gridSelector: 'specialobjectcrdefectlistgrid',
            editFormSelector: 'specialobjectcrdefectlistwin',
            modelName: 'specialobjectcr.DefectList',
            editWindowView: 'specialobjectcr.DefectListEditWindow',
            listeners: {
    ...
    init: function () {
        ...
        me.control({
            'specialobjectcrdefectlistwin fieldcontainer button[action=Calculate]': {
                'click': {
                    fn: me.calculate,
                    scope: me
                }
            },
            'specialobjectcrdefectlistgrid': {
                'afterrender': {
                    fn: me.onAfterRenderGrid,
                    scope: me
                }
            },
            'specialobjectcrdefectlistwin [type=DpkrSum]': { 'change': { fn: me.onChangeSum, scope: me } },
            'specialobjectcrdefectlistwin [name=CostPerUnitVolume]': { 'change': { fn: me.onChangeCostPerUnitVolume, scope: me } },
            'specialobjectcrdefectlistwin [name=Work]': { 'beforeload': { fn: me.beforeLoadWork, scope: me } },
            'specialobjectcrdefectlistwin [name=Volume]': { 'change': { fn: me.onChangeVolume, scope: me } }
        });
    ...
    onChangeVolume: function (fld, newValue, oldValue) {
        var win = fld.up('specialobjectcrdefectlistwin'),
    ...
    index: function (id) {
        var me = this,
            view = me.getMainView() || Ext.widget('specialobjectcrdefectlistgrid'),
            json,
            store,
        ...
        B4.Ajax.request({
            url: B4.Url.action('GetDefectListViewValue', 'Defect', { //??? дпкр!
                objectCrId: id
            })
        }).next(function (response) {
        ...
        view.getStore('specialobjectcr.DefectList').load();
