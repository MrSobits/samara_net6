    ...
    refs: [
        {
            ...
            selector: 'objectcr_type_work_cr_history_grid'
        },
        {
            ref: 'editWindow',
            selector: 'typeworkcreditwindow'
        },
        {
            ref: 'reasonSuspensionChangeValBtn',
            selector: 'typeworkcreditwindow changevalbtn[propertyName=ReasonSuspension]'
        }
    ],
  ...
  pleaseDoMove: function (btn) {              
    ...
    init: function () {
        ...
        me.getAspect('TypeWorkCrAddButtonAspect').on('savetypework', function () {
            var view = this.controller.getMainComponent(),
                gridStore = view.down('objectcr_type_work_cr_grid[_active]').getStore();
            gridStore.clearFilter(true);
            gridStore.filter('objectCrId', me.getContextValue(view, 'objectcrId'));
        });
    ...
    onAfterRenderMainView: function (view) {
        ...
        B4.Ajax.request({
            ...
            if (groupColumn && groupColumn.isVisible()) {
