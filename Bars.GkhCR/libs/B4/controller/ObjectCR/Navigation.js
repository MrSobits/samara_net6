Ext.define('B4.controller.objectcr.Navigation', {
    /*
    * Контроллер навигационной панели объекта КР
    */
    ...
    mainView: 'objectcr.NavigationPanel',
    mainViewSelector: 'objectcrNavigationPanel',
    ...
    refs: [
        { ref: 'menuTree', selector: '#objectCrMenuTree' },
        { ref: 'infoLabel', selector: '#objectCrInfoLabel' },
        { ref: 'mainTab', selector: '#objectCrMainTab' }
    ],
    ...
    aspects: [
        {
            ...
            */
            ...
            name: 'objectCrNavigationAspect',
            panelSelector: 'objectcrNavigationPanel',
            treeSelector: '#objectCrMenuTree',
            tabSelector: '#objectCrMainTab',
    ...
    onLaunch: function () {
        ...
        if (me.params) {
            ...
            me.getInfoLabel().update({ text: Ext.isEmpty(roName) ? "" : roName });
            me.getMainComponent().setTitle(me.title);

            me.getAspect('objectCrNavigationAspect').reload();
            ...
            if (me.params.childController) {
                ...
                me.loadController(me.params.childController, me.params, "#objectCrMainTab", me.hideMask);
            }
        }
    }
});