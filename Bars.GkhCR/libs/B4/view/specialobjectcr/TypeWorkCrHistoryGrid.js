Ext.define('B4.view.specialobjectcr.TypeWorkCrHistoryGrid', {
    ...
    alias: 'widget.typeworkspecialcrhistorygrid',
    
    title: 'Журнал изменений',
    closable: false,
    cls: 'x-large-head',
    
    // необходимо для того чтобы не работали восстановления для грида посколкьу колонки показываются и скрываются динамически
    provideStateId: Ext.emptyFn,
    stateful: false,
    
    initComponent: function () {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.TypeWorkCrHistory');
