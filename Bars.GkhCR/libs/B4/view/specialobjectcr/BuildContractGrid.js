Ext.define('B4.view.specialobjectcr.BuildContractGrid', {
    extend: 'B4.ux.grid.Panel',
    alias: 'widget.specialobjectcrbuildcontractgrid',
    requires: [
        'B4.ux.button.Add',
        'B4.ux.button.Update',
    ...
    initComponent: function () {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.BuildContract');
