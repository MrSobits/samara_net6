Ext.define('B4.view.specialobjectcr.AddWindow', {
    ...
    width: 500,
    bodyPadding: 5,
    alias: 'widget.specialobjectcraddwindow',
    ...
    requires: [
        ...
        'B4.store.specialobjectcr.ProgramCrObj',
            ...
            items: [
                {
                    ...
                    textProperty: 'Name',
                    anchor: '100%',
                    store: 'B4.store.specialobjectcr.ProgramCrObj',
                    columns: [
                        {
