Ext.define('B4.view.specialobjectcr.ProtocolEditWindow', {
    ...
    alias: 'widget.specialobjectcrprotocolwin',
    ...
    requires: [
        ...
        'B4.view.specialobjectcr.ProtocolTypeWorkCrGrid',
        'B4.enums.YesNo'
    ],
            ...
            items: [
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        items: [
                            {
                                xtype: 'protocoltypeworkspecialcrgrid'
                            }
                        ]
                    }
                ]
