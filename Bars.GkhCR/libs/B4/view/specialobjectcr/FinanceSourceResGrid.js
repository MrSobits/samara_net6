Ext.define('B4.view.specialobjectcr.FinanceSourceResGrid', {
    extend: 'B4.ux.grid.Panel',
    alias:'widget.specialobjectcrfinancesourceresgrid',
    requires: [
        'B4.ux.button.Add',
        'B4.ux.button.Update',
    ...
    initComponent: function () {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.FinanceSourceRes');
