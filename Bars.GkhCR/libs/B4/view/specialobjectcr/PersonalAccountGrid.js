Ext.define('B4.view.specialobjectcr.PersonalAccountGrid', {
    ...
    title: 'Лицевые счета',
    alias: 'widget.specialobjectcrpersonalaccountgrid',
    closable: true,

    initComponent: function () {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.PersonalAccount');
