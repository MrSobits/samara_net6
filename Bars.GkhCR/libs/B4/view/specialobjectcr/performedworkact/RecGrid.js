Ext.define('B4.view.specialobjectcr.performedworkact.RecGrid', {
    ...
    alias: 'widget.specialobjectcrperfworkactrecgrid',
    
    initComponent: function() {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.performedworkact.Record');
