Ext.define('B4.view.specialobjectcr.estimate.ResStatGrid', {
    extend: 'B4.ux.grid.Panel',
    alias: 'widget.specialobjectcrresstatgrid',
    requires: [
    ...
    initComponent: function() {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.estimate.ResStat');
