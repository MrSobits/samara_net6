Ext.define('B4.view.specialobjectcr.estimate.EstimateCalculationGrid', {
    ...
    alias: 'widget.specialobjectcrestimateregdetailgrid',
    title: 'Сметный расчет по работе',
    closable: true,

    initComponent: function () {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.estimate.EstimateRegisterDetail');
