Ext.define('B4.view.specialobjectcr.CompetitionGrid', {
    extend: 'B4.ux.grid.Panel',
    requires: [
        'B4.ux.button.Update',
        'B4.store.specialobjectcr.Competition',
    ...
    title: 'Конкурсы',
    alias: 'widget.specialobjectcrcompetitiongrid',
    closable: true,

    initComponent: function () {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.Competition');
