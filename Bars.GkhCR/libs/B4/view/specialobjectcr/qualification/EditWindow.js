Ext.define('B4.view.specialobjectcr.qualification.EditWindow', {
    extend: 'B4.form.Window',

    alias: 'widget.specialobjectcrqualeditwindow',
    ...
    requires: [
        ...
        'B4.ux.button.Close',
        'B4.ux.button.Save',
        'B4.view.specialobjectcr.qualification.VoiceMemberGrid'
    ],
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            items: [
                ...
                {
                    xtype: 'specialobjectcrqualvoicemembergrid',
                    anchor: '100% -55'
                }
            ],
            dockedItems: [
