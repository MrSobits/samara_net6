Ext.define('B4.view.specialobjectcr.qualification.VoiceMemberGrid', {
    extend: 'B4.ux.grid.Panel',
    alias: 'widget.specialobjectcrqualvoicemembergrid',
    requires: [
        'B4.ux.button.Add',
        'B4.ux.button.Update',
        ...
        'B4.store.specialobjectcr.qualification.VoiceMember'
    ],
    ...
    initComponent: function() {
        var me = this,
            store = Ext.create('B4.store.specialobjectcr.qualification.VoiceMember');
