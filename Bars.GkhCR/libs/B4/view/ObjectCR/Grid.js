        ...
        Ext.applyIf(me, {
                    ...
                    filter: {
                        ...
                        listeners: {
                            storebeforeload: function (field, store, options) {
                                options.params.typeId = 'cr_obj_monitoring_cmp';
                            },
                            storeloaded: {
                                fn: function (me) {
            ...
            viewConfig: {
                ...
                getRowClass: function (record) {
                    var Iscluttered = record.get('Iscluttered');
                    var DeadlineMissed = record.get('DeadlineMissed');
                    if (Iscluttered == true || DeadlineMissed == true) {
