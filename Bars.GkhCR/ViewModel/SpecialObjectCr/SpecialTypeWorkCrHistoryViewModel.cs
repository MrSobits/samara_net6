namespace Bars.GkhCr.DomainService
{
    ...
    public class SpecialTypeWorkCrHistoryViewModel : BaseViewModel<SpecialTypeWorkCrHistory>
    {
        public IDomainService<SpecialTypeWorkCrRemoval> TypeRemovalDomain { get; set; }  

        public override IDataResult List(IDomainService<SpecialTypeWorkCrHistory> domainService, BaseParams baseParams)
        {
            var loadParams = this.GetLoadParam(baseParams);
            var objectCrId = baseParams.Params.GetAs<long?>("objectCrId") ?? loadParams.Filter.GetAs<long>("objectCrId");

            var dict = this.TypeRemovalDomain.GetAll()
