namespace Bars.GkhCr.DomainService
{
    ...
    public class SpecialEstimateViewModel : BaseViewModel<SpecialEstimate>
    {
        public override IDataResult List(IDomainService<SpecialEstimate> domainService, BaseParams baseParams)
        {
