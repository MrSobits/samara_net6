namespace Bars.GkhCr.ViewModel
{
    ...
    public class SpecialContractCrTypeWorkViewModel : BaseViewModel<SpecialContractCrTypeWork>
    {
        public override IDataResult List(IDomainService<SpecialContractCrTypeWork> domainService, BaseParams baseParams)
        {
