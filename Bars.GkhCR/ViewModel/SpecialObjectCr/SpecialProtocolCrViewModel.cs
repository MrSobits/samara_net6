namespace Bars.GkhCr.DomainService
{
    ...
    public class SpecialProtocolCrViewModel : BaseViewModel<SpecialProtocolCr>
    {
        public override IDataResult List(IDomainService<SpecialProtocolCr> domainService, BaseParams baseParams)
        {
