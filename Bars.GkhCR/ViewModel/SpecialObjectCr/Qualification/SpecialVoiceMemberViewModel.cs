namespace Bars.GkhCr.DomainService
{
    ...
    /// <summary>
    /// Представление для <see cref="SpecialVoiceMember"/>
    /// </summary>
    public class SpecialVoiceMemberViewModel : BaseViewModel<SpecialVoiceMember>
    {
        /// <summary>Получить список</summary>
        /// <param name="domainService">Домен</param>
        /// <param name="baseParams">Базовые параметры</param>
        /// <returns>Результат получения списка</returns>
        public override IDataResult List(IDomainService<SpecialVoiceMember> domainService, BaseParams baseParams)
        {
            ...
            var periodId = this.Container.Resolve<IDomainService<Entities.SpecialObjectCr>>().GetAll()
