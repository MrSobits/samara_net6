namespace Bars.GkhCr.DomainService
{
    ...
    public class PaymentOrderOutViewModel : BaseViewModel<PaymentOrderOut>
    {
        public override IDataResult List(IDomainService<PaymentOrderOut> domainService, BaseParams baseParams)
        {
