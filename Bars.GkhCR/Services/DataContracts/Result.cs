namespace Bars.GkhCr.Services.DataContracts
{
    ...
    public class Result
    {
        ...
        public static Result IncorrectToken
        {
            get
            {
                return new Result { Code = "05", Name = "INCORRECT TOKEN" };
            }
        }
        ...
        public static Result IncorrectPassword
        {
            get
            {
                return new Result { Code = "06", Name = "INCORRECT_PASSWORD" };
            }
        }

        public static Result NotClose
        {
            get
            {
                return new Result { Code = "07", Name = "Расстояние до объекта превышает 200 метров" };
            }
        }
    }
}