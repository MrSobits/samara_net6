    ...
    aspects: [
         ...
         */
        {
            ...
            permissions: [
                ...
                {
                    name: 'Import.ProgramCrImport.FinanceCut', applyTo: '#DateAcceptCrGji', selector: 'objectcrgrid',
                    applyBy: function (component, allowed) {
                        var me = this;
                        me.controller.isFinanceCutAllowed = allowed;
                    }
                }
            ]
        },
            ...
            listeners: {
                aftercreatewindow: function (window, importId) {
                    ...
                    if (importId === 'Bars.GkhCr.Import.ProgramCrImport') {
                        ...
                        chk2.show();
                        chk3.show();
                        financeCut.setVisible(me.controller.isFinanceCutAllowed);
                        financeCut.allowBlank = !me.controller.isFinanceCutAllowed;
                    } else {
                        chk1.hide();
                        chk2.hide();
                        chk3.hide();
                        financeCut.hide();
                        financeCut.setDisabled(true);
                    }
                }
            }
        },
