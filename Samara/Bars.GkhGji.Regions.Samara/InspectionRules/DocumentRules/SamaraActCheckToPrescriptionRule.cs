namespace Bars.GkhGji.Regions.Samara.Interceptors
{
    ...
    public class SamaraActCheckToPrescriptionRule : ActCheckToPrescriptionRule
    {
        ...
        public override IDataResult ValidationRule(DocumentGji document)
        {
            ...
            {
                return new BaseDataResult(false, "В Самаре для Акта проверки предписания нельзя формировать предписание");
            }
