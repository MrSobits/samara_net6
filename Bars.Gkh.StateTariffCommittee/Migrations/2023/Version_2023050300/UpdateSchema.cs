namespace Bars.Gkh.StateTariffCommittee.Migrations._2023.Version_2023050300
{

    using Bars.B4.Modules.Ecm7.Framework;
    using Bars.Gkh.SqlExecutor;

    [MigrationDependsOn(typeof(Version_2023031000.UpdateSchema))]
    [Migration("2023050300")]
        ...
        public override void Up()
        {
            using (var sqlExecutor = new RisDatabaseSqlExecutor())
            {
                sqlExecutor.ExecuteSql(@"
					CREATE OR REPLACE FUNCTION tariff.create_ls_account_info_table(table_name character varying, oktmo_mo character varying, date_s date)
					RETURNS void
					LANGUAGE plpgsql
					AS $function$
					DECLARE
					...
					BEGIN
						...
						SELECT DISTINCT ON (fh.fias_house_guid)
							   gh.house_id,
						...
						ORDER BY fh.fias_house_guid, gh.object_edit_date DESC;
