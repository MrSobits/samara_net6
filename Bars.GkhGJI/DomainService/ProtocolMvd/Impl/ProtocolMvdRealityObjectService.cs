namespace Bars.GkhGji.DomainService
{
    ...
    public class ProtocolMvdRealityObjectService : IProtocolMvdRealityObjectService
    {
        ...
        public IDataResult AddRealityObjects(BaseParams baseParams)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(objectIds))
                {
                    ...
                    var serviceRealityObject = Container.Resolve<IDomainService<ProtocolMvdRealityObject>>();
                    ...
                    foreach (var id in objectIds.Split(','))
                    {
                        ...
                        var newObj = new ProtocolMvdRealityObject
                                         {
