namespace Bars.GkhGji.DomainService
{
    ...
    public class ProtocolMhcArticleLawService : IProtocolMhcArticleLawService
    {
        public IWindsorContainer Container { get; set; }

        public IDataResult AddArticles(BaseParams baseParams)
        {
            var serviceArticles = Container.Resolve<IDomainService<ProtocolMhcArticleLaw>>();
            ...
            try
            {
                ...
                var listToSave = new List<ProtocolMhcArticleLaw>();
                ...
                foreach (var id in articleIds)
                {
                    ...
                    var newObj = new ProtocolMhcArticleLaw
                                        {
