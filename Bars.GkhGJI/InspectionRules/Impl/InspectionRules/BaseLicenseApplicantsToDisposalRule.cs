namespace Bars.GkhGji.InspectionRules
{
    ...
    /// </summary>
    public class BaseLicenseApplicantsToDisposalRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseLicenseApplicantsToDisposalRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Распоряжения из основания проверки соискателя лицензии"; }
        }
