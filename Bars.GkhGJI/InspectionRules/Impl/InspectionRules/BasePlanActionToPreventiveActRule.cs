namespace Bars.GkhGji.InspectionRules
{
    ...
    /// </summary>
    public class BasePlanActionToPreventiveActRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BasePlanActionToPreventiveActRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Акт профилактического визита по основанию проверки по плану мероприятий"; }
        }
        ...
        public virtual IDataResult CreateDocument(InspectionGji inspection)
        {
            ...
            var actPV = new PreventiveVisit()
            {
                ...
                TypePreventiveAct = TypePreventiveAct.Plan,
