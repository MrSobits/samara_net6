namespace Bars.GkhGji.InspectionRules
{
    ...
    /// <summary>
    /// Правило создания документа Распоряжение для основания деятельности ТСЖ
    /// </summary>
    public class BaseActivityTsjToDisposalRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseActivityTsjToDisposalRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Распоряжения по основанию Проверка деятельности ТСЖ"; }
        }
        ...
        {
            get { return TypeBase.ActivityTsj; }
        }
