namespace Bars.GkhGji.InspectionRules
{
    ...
    /// <summary>
    /// Правило создания документа Распоряжение для основания Инспекционная проверка
    /// </summary>
    public class BaseInsCheckToDisposalRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseInsCheckToDisposalRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Распоряжения по основанию инспекционной проверки"; }
        }
        ...
        {
            get { return TypeBase.Inspection; }
        }
