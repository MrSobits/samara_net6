namespace Bars.GkhGji.InspectionRules
{
    ...
    /// </summary>
    public class BaseStatementToPreventiveActRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseStatementToPreventiveActRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Акт профилактического визита из основания проверки по обращению"; }
        }
        ...
        public virtual IDataResult CreateDocument(InspectionGji inspection)
        {
            ...
            var actPV = new PreventiveVisit()
            {
                ...
                TypePreventiveAct = TypePreventiveAct.Appeal,
