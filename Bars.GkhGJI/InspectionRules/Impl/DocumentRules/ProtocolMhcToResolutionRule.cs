namespace Bars.GkhGji.InspectionRules
{
    ...
    /// </summary>
    public class ProtocolMhcToResolutionRule : IDocumentGjiRule
    {
        ...
        public string Id
        {
            get { return "ProtocolMhcToResolutionRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа 'Постановления' из документа 'Протокола МЖК'"; }
        }
        ...
        {
            get { return TypeDocumentGji.ProtocolMhc; }
        }
        ...
        public IDataResult CreateDocument(DocumentGji document)
        {
            ...
            var resolPros = ProtocolMhcDomain.GetAll()
            ...
            if (resolPros == null)
            {
                throw new Exception("Неудалось получить протокол мжк");
            }
