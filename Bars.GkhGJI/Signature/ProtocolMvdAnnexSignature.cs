namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class ProtocolMvdAnnexSignature : ISignature<ProtocolMvdAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public ProtocolMvdAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<ProtocolMvdAnnex> DomainService { get; set; }
