namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class PresentationAnnexSignature : ISignature<PresentationAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public PresentationAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<PresentationAnnex> DomainService { get; set; }
