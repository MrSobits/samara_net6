namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class AppealCitsRequestAnswerSignature : ISignature<AppealCitsRequestAnswer>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public AppealCitsRequestAnswerSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<AppealCitsRequestAnswer> DomainService { get; set; }
