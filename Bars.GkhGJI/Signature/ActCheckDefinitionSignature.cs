namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class ActCheckDefinitionSignature : ISignature<ActCheckDefinition>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public ActCheckDefinitionSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<ActCheckDefinition> DomainService { get; set; }
