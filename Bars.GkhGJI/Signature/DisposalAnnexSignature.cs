namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class DisposalAnnexSignature : ISignature<DisposalAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public DisposalAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<DisposalAnnex> DomainService { get; set; }
