namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class ProtocolRSOAnnexSignature : ISignature<ProtocolRSOAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public ProtocolRSOAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<ProtocolRSOAnnex> DomainService { get; set; }
