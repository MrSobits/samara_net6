namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class ProtocolMhcAnnexSignature : ISignature<ProtocolMhcAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public ProtocolMhcAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<ProtocolMhcAnnex> DomainService { get; set; }
