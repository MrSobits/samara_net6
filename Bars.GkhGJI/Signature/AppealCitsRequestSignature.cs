namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class AppealCitsRequestSignature : ISignature<AppealCitsRequest>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public AppealCitsRequestSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
