namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class ProtocolAnnexSignature : ISignature<ProtocolAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public ProtocolAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<ProtocolAnnex> DomainService { get; set; }
