namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class DecisionAnnexSignature : ISignature<DecisionAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public DecisionAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<DecisionAnnex> DomainService { get; set; }
