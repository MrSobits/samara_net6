namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class ResolutionAnnexSignature : ISignature<ResolutionAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public ResolutionAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<ResolutionAnnex> DomainService { get; set; }
