namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class ResolProsAnnexSignature : ISignature<ResolProsAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public ResolProsAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<ResolProsAnnex> DomainService { get; set; }
