namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class MKDLicRequestQueryAnswerSignature : ISignature<MKDLicRequestQueryAnswer>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public MKDLicRequestQueryAnswerSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
