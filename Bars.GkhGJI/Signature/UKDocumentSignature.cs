namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class UKDocumentSignature : ISignature<UKDocument>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public UKDocumentSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<UKDocument> DomainService { get; set; }
