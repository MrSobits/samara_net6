namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class ResolutionRospotrebnadzorAnnexSignature : ISignature<ResolutionRospotrebnadzorAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public ResolutionRospotrebnadzorAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<ResolutionRospotrebnadzorAnnex> DomainService { get; set; }
