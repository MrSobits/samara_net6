namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class PrescriptionAnnexSignature : ISignature<PrescriptionAnnex>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public PrescriptionAnnexSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<PrescriptionAnnex> DomainService { get; set; }
