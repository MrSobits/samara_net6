namespace Bars.GkhGji.DomainService.Impl
{
    ...
    public class AppealCitsAnswerSignature : ISignature<AppealCitsAnswer>
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;

        public AppealCitsAnswerSignature(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        public IDomainService<AppealCitsAnswer> DomainService { get; set; }
