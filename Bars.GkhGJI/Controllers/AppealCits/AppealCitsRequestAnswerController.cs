namespace Bars.GkhGji.Controllers
{
    ...
    public class AppealCitsRequestAnswerController : AppealCitsRequestAnswerController<AppealCitsRequestAnswer>
    {
        public AppealCitsRequestAnswerController(IFileManager fileManager, IDomainService<FileInfo> fileDomain) : base(fileManager, fileDomain)
        {
        }
    }

    public class AppealCitsRequestAnswerController<T> : FileStorageDataController<T>
        where T : AppealCitsRequestAnswer
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public AppealCitsRequestAnswerController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
