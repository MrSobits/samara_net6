namespace Bars.GkhGji.Controllers
{
    ...
    public class ProtocolMvdAnnexController : ProtocolMvdAnnexController<ProtocolMvdAnnex>
    {
        public ProtocolMvdAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain) : base(fileManager, fileDomain)
        {
        }
    }

    public class ProtocolMvdAnnexController<T> : FileStorageDataController<T>
        where T : ProtocolMvdAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public ProtocolMvdAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
