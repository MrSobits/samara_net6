namespace Bars.GkhGji.Controllers
{
    ...
    public class ProtocolRSOAnnexController : ProtocolRSOAnnexController<ProtocolRSOAnnex>
    {
    ...
    public class ProtocolRSOAnnexController<T> : FileStorageDataController<T>
        where T : ProtocolRSOAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public ProtocolRSOAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
