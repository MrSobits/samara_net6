namespace Bars.GkhGji.Controllers
{
    ...
    public class ActCheckAnnexController : ActCheckAnnexController<ActCheckAnnex>
    {
        public ActCheckAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain) : base(fileManager, fileDomain)
        {
        }
    }

    public class ActCheckAnnexController<T> : FileStorageDataController<T>
        where T : ActCheckAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public ActCheckAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
