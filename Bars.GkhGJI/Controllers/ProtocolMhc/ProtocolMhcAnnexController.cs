namespace Bars.GkhGji.Controllers
{
    ...
    public class ProtocolMhcAnnexController : ProtocolMhcAnnexController<ProtocolMhcAnnex>
    {
        public ProtocolMhcAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain) : base(fileManager, fileDomain)
        {
        }
    }

    public class ProtocolMhcAnnexController<T> : FileStorageDataController<T>
        where T : ProtocolMhcAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public ProtocolMhcAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
