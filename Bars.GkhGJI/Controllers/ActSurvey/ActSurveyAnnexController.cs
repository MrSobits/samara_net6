namespace Bars.GkhGji.Controllers
{
    ...
    public class ActSurveyAnnexController : ActSurveyAnnexController<ActSurveyAnnex>
    {
    ...
    public class ActSurveyAnnexController<T> : B4.Alt.DataController<T>
        where T : ActSurveyAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public ActSurveyAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
