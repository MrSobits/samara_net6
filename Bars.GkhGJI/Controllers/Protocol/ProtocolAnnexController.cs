namespace Bars.GkhGji.Controllers
{
    ...
    public class ProtocolAnnexController : ProtocolAnnexController<ProtocolAnnex>
    {
    ...
    public class ProtocolAnnexController<T> : FileStorageDataController<T>
        where T : ProtocolAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public ProtocolAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
