namespace Bars.GkhGji.Controllers
{
    ...
    public class MKDLicRequestQueryAnswerController : MKDLicRequestQueryAnswerController<MKDLicRequestQueryAnswer>
    {
        public MKDLicRequestQueryAnswerController(IFileManager fileManager, IDomainService<FileInfo> fileDomain) : base(fileManager, fileDomain)
        {
        }
    }

    public class MKDLicRequestQueryAnswerController<T> : FileStorageDataController<T>
        where T : MKDLicRequestQueryAnswer
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public MKDLicRequestQueryAnswerController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
