namespace Bars.GkhGji.Controllers
{
    ...
    public class MKDLicRequestQueryController : MKDLicRequestQueryController<MKDLicRequestQuery>
    {
    ...
    public class MKDLicRequestQueryController<T> : FileStorageDataController<T>
        where T : MKDLicRequestQuery
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public MKDLicRequestQueryController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
        ...
        {
            var export = Container.Resolve<IDataExportService>("MKDLicRequestQueryDataExport");
