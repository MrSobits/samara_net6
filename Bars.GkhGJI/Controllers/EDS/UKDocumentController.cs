namespace Bars.GkhGji.Controllers
{
    ...
    public class UKDocumentController : UKDocumentController<UKDocument>
    {
        public UKDocumentController(IFileManager fileManager, IDomainService<FileInfo> fileDomain) : base(fileManager, fileDomain)
        {
        }
    }

    public class UKDocumentController<T> : FileStorageDataController<T>
        where T : UKDocument
    {
        ...
        public UKDocumentController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
