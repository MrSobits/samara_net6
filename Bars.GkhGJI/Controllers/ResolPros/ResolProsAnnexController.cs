namespace Bars.GkhGji.Controllers
{
    ...
    public class ResolProsAnnexController : ResolProsAnnexController<ResolProsAnnex>
    {
    ...
    public class ResolProsAnnexController<T> : FileStorageDataController<T>
        where T : ResolProsAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public ResolProsAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
