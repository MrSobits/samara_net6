namespace Bars.GkhGji.Controllers
{
    ...
    public class ResolutionRospotrebnadzorAnnexController : ResolutionRospotrebnadzorAnnexController<ResolutionRospotrebnadzorAnnex>
    {
    ...
    public class ResolutionRospotrebnadzorAnnexController<T> : FileStorageDataController<T>
        where T : ResolutionRospotrebnadzorAnnex
    {
        ...
        public ResolutionRospotrebnadzorAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
