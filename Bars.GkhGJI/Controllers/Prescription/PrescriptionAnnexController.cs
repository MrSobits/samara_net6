namespace Bars.GkhGji.Controllers
{
    ...
    public class PrescriptionAnnexController : PrescriptionAnnexController<PrescriptionAnnex>
    {
    ...
    public class PrescriptionAnnexController<T> : FileStorageDataController<T>
        where T : PrescriptionAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public PrescriptionAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
