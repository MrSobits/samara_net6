namespace Bars.GkhGji.Controllers
{
    ...
    public class PresentationAnnexController : PresentationAnnexController<PresentationAnnex>
    {
    ...
    public class PresentationAnnexController<T> : FileStorageDataController<T>
        where T : PresentationAnnex
    {
        private IFileManager _fileManager;
        private IDomainService<FileInfo> _fileDomain;
        protected Bitmap stamp = Properties.Resources.stamp2;

        public PresentationAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
