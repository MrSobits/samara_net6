namespace Bars.GkhGji.Controllers
{
   ...
   // using Image = iTextSharp.text.Image;
    ...
    public class ResolutionAnnexController : ResolutionAnnexController<ResolutionAnnex>
    {
    ...
    public class ResolutionAnnexController<T> : FileStorageDataController<T>
        where T : ResolutionAnnex
    {
        ...
        public ResolutionAnnexController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
