Ext.define('B4.view.resolutionrospotrebnadzor.RelationsGrid', {
    ...
    alias: 'widget.resolutionRospotrebnadzorRelationsGrid',
    store: 'resolutionrospotrebnadzor.Relations',
    itemId: 'resolutionRospotrebnadzorRelationsGrid',
