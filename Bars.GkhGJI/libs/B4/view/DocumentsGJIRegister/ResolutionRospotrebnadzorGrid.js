Ext.define('B4.view.documentsgjiregister.ResolutionRospotrebnadzorGrid', {
    ...
    store: 'view.ResolutionRospotrebnadzor',
    itemId: 'docsGjiRegisterResolutionRospotrebnadzorGrid',
    closable: true,
                    ...
                    filter: {
                        ...
                        listeners: {
                            storebeforeload: function (field, store, options) {
                                options.params.typeId = 'gji_document_resol_rosp';
                            },
                            storeloaded: {
                                fn: function (me) {
