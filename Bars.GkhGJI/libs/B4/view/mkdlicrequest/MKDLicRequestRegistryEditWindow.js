Ext.define('B4.view.mkdlicrequest.MKDLicRequestQueryRegistryEditWindow', {
    ...
    height: 500,
    bodyPadding: 5,
    itemId: 'mkdLicRequestQueryRegistryEditWindow',
    ...
    requires: [
        ...
        'B4.view.mkdlicrequest.MKDLicRequestQueryAnswerRegistryGrid',
        'B4.ux.button.Close',
        'B4.ux.button.Save'
    ],
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            items: [
                ...
                {
                    xtype: 'tabpanel',
                    itemId: 'requestRegistryQueryAnswerTabPanel',
                    flex: 1,
                    border: false,
                    items: [
                        {
                            xtype: 'mkdlicrequestqueryanswerreggrid',
                            flex: 1
                        }
                    ]
                }
