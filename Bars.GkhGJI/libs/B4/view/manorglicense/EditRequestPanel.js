Ext.define('B4.view.manorglicense.EditRequestPanel', {
    ...
    requires: [
        ...
        'B4.view.manorglicense.ManOrgRequestRPGUGrid',
        'B4.view.manorglicense.ManOrgRequestRPGUEditWindow'
    ],
            ...
            items: [
                {
                    ...
                    items: [
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            xtype: 'textfield',
                                            name: 'RPGUNumber',
                                            fieldLabel: 'Номер запроса в РПГУ',
                                            flex: 1,
                                            maxLength: 1000
                                        },
                                    ]
                        ...
                        {
                            xtype: 'manorglicenserequestrpgugrid',
                            flex: 1
                        },
                        {
                            xtype: 'manorglicenserequestsmevgrid',
                            flex: 1
                        }
                    ]
                }
