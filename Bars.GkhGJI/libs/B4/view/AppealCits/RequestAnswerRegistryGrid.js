Ext.define('B4.view.appealcits.RequestAnswerRegistryGrid', {
    extend: 'B4.ux.grid.Panel',
    
    alias: 'widget.appcitrequestanswerreggrid',
    ...
    store: 'appealcits.RequestAnswerRegistry',
    itemId: 'appcitRequestAnswerRegGrid',
