Ext.define('B4.aspects.permission.Disposal', {
    ...
    permissions: [
       ...
       //поля панели редактирования "Дата документа с результатом согласования:"
       {
        ...
        {
            name: 'GkhGji.DocumentsGji.Disposal.Field.Notice_Fieldset_View', applyTo: '[name=noticeFieldset]', selector: '#disposalEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) {
                        component.show();
        ...
        {
            name: 'GkhGji.DocumentsGji.Disposal.Field.Notice_Fieldset_Edit', applyTo: '[name=noticeFieldset]', selector: '#disposalEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
        ...
        {
            name: 'GkhGji.DocumentsGji.Disposal.Register.Notice.View', applyTo: '#tabDisposalNoticeOfInspection', selector: '#disposalEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
        ...
        {
            name: 'GkhGji.DocumentsGji.Disposal.Register.Notice.Edit', applyTo: '#tabDisposalNoticeOfInspection', selector: '#disposalEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
                    component.query('field').forEach(function (c) {
                        c.setReadOnly && c.setReadOnly(!allowed);
