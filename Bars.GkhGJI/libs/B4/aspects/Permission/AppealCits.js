Ext.define('B4.aspects.permission.AppealCits', {
    ...
    permissions: [
        ...
        {
            name: 'GkhGji.AppealCitizensState.Field.IsPrelimentaryCheck_View',
            applyTo: '[name=IsPrelimentaryCheck]',
        ...
        {
            name: 'GkhGji.AppealCitizensState.Field.IsPrelimentaryCheck_Edit',
            applyTo: '[name=IsPrelimentaryCheck]',
            selector: '#appealCitsEditWindow'
        },
    ]
