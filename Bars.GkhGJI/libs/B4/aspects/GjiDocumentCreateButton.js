...
Ext.define('B4.aspects.GjiDocumentCreateButton', {
    ...
    constructor: function (config) {
        ...
        me.on('menuloaded', me.onAfterMenuLoad, me);
    },
    ...
    onLoadStore: function (store) {
        ...
        if (btn) {
            ...
            me.fireEvent('menuloaded', btn.menu);
        }
    },
    ...
    createDocument: function (params) {
        var me = this,
            container = me.componentQuery(this.containerSelector);
        ...
        B4.Ajax.request({
           ...
           var data = Ext.decode(res.responseText),
               tree = me.componentQuery(me.controller.params.treeMenuSelector),
               docParams = {};
           ...
           if (tree) {
            ...
            if (data.typeDocument) {
                docParams.typeDocument = data.typeDocument;
            }
