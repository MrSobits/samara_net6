...
Ext.define('B4.aspects.GjiDocumentList', {
    ...
    getControllerName: function (documentType) {
        ...
        switch (documentType) {
            ...
            //Решение
            case 15: controllerName = 'B4.controller.Decision'; break;

            //Предостережение
            case 11: controllerName = 'B4.controller.WarningDoc'; break;

            //Мотивировочное заключение 
            case 12: controllerName = 'B4.controller.MotivationConclusion'; break;

            //Акт проверки
            case 20: controllerName = 'B4.controller.ActCheck'; break;

            //Акт без взаимодействия
            case 21: controllerName = 'B4.controller.ActIsolated'; break;
            ...
            case 150: controllerName = 'B4.controller.ResolutionRospotrebnadzor'; break;
        }
    ...
    getTitle: function (documentType) {
        ...
        switch (documentType) {
            ...
            //Акт без взаимодействия           
            case 21: title = 'Акт без взаимодействия'; break;
            ...
            // Постановление Роспотребнадзора
            case 150: title = 'Постановление Роспотребнадзора'; break;
        }
