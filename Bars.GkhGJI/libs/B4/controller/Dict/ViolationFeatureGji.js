Ext.define('B4.controller.dict.ViolationFeatureGji', {
...

        {
        ...
        },
         {
             ...
             permissions: [
                 ...
                 {
                     name: 'GkhGji.Dict.ViolationGroup.Create', applyTo: 'b4addbutton', selector: 'violationsgrid',
                     applyBy: function (component, allowed) {
                         if (allowed) component.show();
                         else component.hide();
                     }
                 ...
                 {
                     name: 'GkhGji.Dict.ViolationGroup.Delete', applyTo: 'b4deletecolumn', selector: 'violationsgrid',
                     applyBy: function (component, allowed) {
                        if (allowed) component.show();
                        else component.hide();
                     }
    ...
    goSaveChanges: function (record, action, parentId, callback) {
        ...
        if (action === 'delete') {
            ...
            records = [{ Id: record.get('Id') || 0, Name: record.get('Name'), Code: record.get('Code'), Parent: record.get('Parent') || parentId || 0 }];
        }
