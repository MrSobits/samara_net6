Ext.define('B4.controller.resolpros.Edit', {
                    ...
                    B4.Ajax.request(B4.Url.action('GetObjectSpecificPermissions', 'Permission', {
                        ...
                        switch (typeExec.Code) {
                            ...
                            case "19":
                                ...
                                panel.down('#tfSurname').setDisabled(false);
                                panel.down('#tfFirstName').setDisabled(false);
                                panel.down('#tfPatronymic').setDisabled(false);
                                panel.down('#tfdPhysicalPersonPosition').setDisabled(false);
                                panel.down('#dfPhysicalPersonDocType').setDisabled(false);
                                panel.down('#tfPhysicalPersonDocumentSerial').setDisabled(false);
                                panel.down('#tfPhysicalPersonDocumentNumber').setDisabled(false);
                                panel.down('#dfPhysicalPersonIsNotRF').setDisabled(false);
                            ...
                            case "21": //ИП
                                ...
                                panel.down('#tfdPhysicalPersonPosition').setDisabled(true);
                                panel.down('#dfPhysicalPersonDocType').setDisabled(true);
                                panel.down('#tfPhysicalPersonDocumentSerial').setDisabled(true);
                                panel.down('#tfPhysicalPersonDocumentNumber').setDisabled(true);
    ...
    //        this.getAspect('resolProsGridWindowAspect').editRecord(new model({ Id: this.params.recId }));
    //        this.params.recId = 0;
    //    }
    //},
