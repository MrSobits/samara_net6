namespace Bars.GkhGji.Rules
{
    ...
    /// <inheritdoc />
    public class BaseDispHeadCourtExitRule : IKindCheckRule
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public string Code => "BaseDispHeadCourtExitRule";

        /// <inheritdoc />
        public string Name => "Проверка по поручению руководителя. Основание «Передача документов в суд…», Форма проверки «Выездная»";
