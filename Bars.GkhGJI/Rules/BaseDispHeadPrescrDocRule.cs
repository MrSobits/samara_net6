namespace Bars.GkhGji.Rules
{
    ...
    /// <inheritdoc />
    public class BaseDispHeadPrescrDocRule : IKindCheckRule
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public string Code => "BaseDispHeadPrescrDocRule";

        /// <inheritdoc />
        public string Name => "Проверка по поручению руководителя. Основание «Выдача предписания…», Форма проверки «Документарная»";
