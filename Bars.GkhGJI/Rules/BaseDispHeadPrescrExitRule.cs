namespace Bars.GkhGji.Rules
{
    ...
    /// <inheritdoc />
    public class BaseDispHeadPrescrExitRule : IKindCheckRule
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public string Code => "BaseDispHeadPrescrExitRule";

        /// <inheritdoc />
        public string Name => "Проверка по поручению руководителя. Основание «Выдача предписания…», Форма проверки «Выездная»";
