namespace Bars.GkhGji.Rules
{
    ...
    /// <inheritdoc />
    public class BaseDispHeadDocRule : IKindCheckRule
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public string Code => "BaseDispHeadDocRule";

        /// <inheritdoc />
        public string Name => "Проверка по поручению руководителя. Основание «Поручение руководителей…», Форма проверки «Документарная»";
