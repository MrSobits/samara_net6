namespace Bars.GkhGji.StateChange
{
    ...
    public class ManOrgLicenseAddDateStateRule : IRuleChangeStatus
    {
        public virtual IWindsorContainer Container { get; set; }

        public string Id
        {
            get { return "ManOrgLicenseAddDateStateRule"; }
        }

        public string Name { get { return "Заполнение значение поля \"Дата получения лицензии\""; } }
        public string TypeId { get { return "gkh_manorg_license"; } }
        public string Description
        {
            get
            {
                return "При переводе статуса будет заполнено значение поля \"Дата получения лицензии\" в карточке Контрагента";
            }
        }
        ...
        public ValidateResult Validate(IStatefulEntity statefulEntity, State oldState, State newState)
        {
            ...
            try
            {
                ...
                contragent.LicenseDateReceipt = license.DateIssued;
