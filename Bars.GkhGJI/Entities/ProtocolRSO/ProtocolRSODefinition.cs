namespace Bars.GkhGji.Entities
{
    ...
    /// <summary>
    /// Определение протокола прокуратуры
    /// </summary>
    public class ProtocolRSODefinition : BaseGkhEntity
    {
        /// <summary>
        ...
        /// Тип определения
        /// </summary>
        public virtual TypeDefinitionProtocolProsecutor TypeDefinition { get; set; }
    }
}