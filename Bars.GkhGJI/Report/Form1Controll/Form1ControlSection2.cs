...
namespace Bars.GkhGji.Report.Form1Controll
{
    ...
    class Form1ControlSection2 : BaseReportSection
    {
        ...
        private TypeCheck [] kindCheckCodes_1_3_7_8 = new[] { TypeCheck.PlannedExit, TypeCheck.PlannedDocumentation, TypeCheck.PlannedDocumentationExit, TypeCheck.VisualSurvey };
        private TypeCheck[] kindCheckCodes_2_4_9 = new[] { TypeCheck.NotPlannedExit, TypeCheck.NotPlannedDocumentation, TypeCheck.NotPlannedDocumentationExit };
        ...
        public Form1ControlSection2(List<long> inspections, DateTime dateStart, DateTime dateEnd, IWindsorContainer container)
            ...
            for (int i = 0; i < inspectionsIds.Length; i += 1000)
            {
                ...
                plannedJurActCheckIds.AddRange(serviceActCheckRO.GetAll()
                         .Where(x => x.ActCheck.Inspection.TypeBase == TypeBase.PlanJuridicalPerson
                             && tmpInspectionIds.Contains(x.ActCheck.Inspection.Id) && x.HaveViolation == YesNoNotSet.No)
        ...
        private int GetCell47_7()
        {
            ...
            for (int i = 0; i < inspectionsIds.Length; i += 1000)
            {
                ...
                actCheckIds.AddRange(serviceActCheckRO.GetAll()
                         .Where(x => tmpInspectionIds.Contains(x.ActCheck.Inspection.Id) && x.HaveViolation == YesNoNotSet.No)
        ...
        int getLines39_42(IList<long> disposalStageIds, List<long> contractorType)
        {
            ...
            for (int i = 0; i < disposalStageIds.Count(); i += 1000)
            {
                ...
                count += serviceResolution.GetAll()
        ...
        decimal getResolutionPays(IList<long> resolutionIds)
        {
            decimal count = 0;
            ...
            for (int i = 0; i < resolutionIds.Count(); i += 1000)
            {
                ...
                count += c.Sum(x => x.HasValue ? x.Value : 0);
            }
        ...
        decimal getLines39(IList<long> disposalStageIds)
        {
            ...
            for (int i = 0; i < disposalStageIds.Count(); i += 1000)
            {
                ...
                resolutionIds.AddRange(serviceResolution.GetAll()
                    .Where(x => tmpDisposalIds.Contains(x.Stage.Parent.Id)
                        && (x.Executant.Code == "6" || x.Executant.Code == "7" || x.Executant.Code == "14")
                        && x.Sanction.Code == "1"
                        && x.DocumentDate >= this.dateStart
                        && x.DocumentDate <= this.dateEnd)
                    .Select(x => x.Id));
        ...
        decimal getLines40(IList<long> disposalStageIds)
        {
            ...
            for (int i = 0; i < disposalStageIds.Count(); i += 1000)
            {
                ...
                resolutionIds.AddRange( serviceResolution.GetAll()
                    .Where(x => tmpDisposalIds.Contains(x.Stage.Parent.Id)
                        && (x.Executant.Code == "1" || x.Executant.Code == "3" || x.Executant.Code == "5" || x.Executant.Code == "10"
                                || x.Executant.Code == "12" || x.Executant.Code == "12" || x.Executant.Code == "16" || x.Executant.Code == "19")
                        && x.Sanction.Code == "1"
                        && x.DocumentDate >= this.dateStart
                        && x.DocumentDate <= this.dateEnd)
                    .Select(x => x.Id));
        ...
        decimal getLines42(IList<long> disposalStageIds)
        {
            ...
            for (int i = 0; i < disposalStageIds.Count(); i += 1000)
            {
                ...
                resolutionIds.AddRange(serviceResolution.GetAll()
                    .Where(x => tmpDisposalIds.Contains(x.Stage.Parent.Id)
                        && (x.Executant.Code == "0" || x.Executant.Code == "2" || x.Executant.Code == "4" || x.Executant.Code == "8"
                                || x.Executant.Code == "9" || x.Executant.Code == "11" || x.Executant.Code == "15")
                        && x.Sanction.Code == "1"
                        && x.DocumentDate >= this.dateStart
                        && x.DocumentDate <= this.dateEnd)
                    .Select(x => x.Id));
        ...
        int getLine46(IList<long> disposalStageIds)
        {
            ...
            for (int i = 0; i < disposalStageIds.Count(); i += 1000)
            {
                ...
                count += servicePrescription.GetAll()
        ...
        int getLine47(IList<long> actSurveyIds, TypeCheck[] kindCheckCodes)
        {
            ...
            for (int i = 0; i < actSurveyIds.Count; i += 1000)
            {
                ...
                disposalIds.AddRange(serviceDocGjiChildren.GetAll()
                            .Where(
                                ...
                                && tmpActSurveyIds.Contains(x.Children.Id)
                                && x.Parent.DocumentDate >= dateStart
                                && x.Parent.DocumentDate <= dateEnd)
        ...
        void getDisposals()
        {
            ...
            for (int i = 0; i < inspectionsIds.Length; i += 1000)
            {
                ...
                var tempData = serviceDisposal.GetAll()
                                   ...
                                   .Select(x => new { x.Id, stageID = x.Stage.Id }).ToArray();
        ...
        void getRows17_37Values()
        {
            var start = 1000;

            var servProtocols = this.Container.Resolve<IDomainService<Protocol>>().GetAll()
            ...
            var servPrescriptions =
                this.Container.Resolve<IDomainService<Prescription>>()
                    .GetAll()
                    .WhereIf(this.dateStart != DateTime.MinValue, x => x.DocumentDate >= this.dateStart)
                    .WhereIf(this.dateEnd != DateTime.MinValue, x => x.DocumentDate <= this.dateEnd);
            ...
            var inspectionsProtocols =
                servProtocols.Where(x => tmpFirst.Contains(x.Inspection.Id))
                             .Select(
                                 x =>
                                 new
                                 {
            ...
            var exeDocActIds =
                servExeDocActs.Where(x => tmpFirst.Contains(x.Children.Inspection.Id))
            ...
            while (start < inspectionsIds.Length)
            {
                ...
                inspectionsProtocols.AddRange(
                    servProtocols.Where(x => tmp.Contains(x.Inspection.Id))
                             .Select(
                                 x =>
                                 new
                                 {
                ...
                inspectionsPrescriptions.AddRange(
                    servPrescriptions.Where(x => tmp.Contains(x.Inspection.Id))
                             .Select(
                                 x =>
                                 new
                                 {
                ...
                exeDocActIds.AddRange(
                    servExeDocActs.Where(x => tmp.Contains(x.Children.Inspection.Id))
                                  .Select(x => new { exeDocId = x.Children.Id, actId = x.Parent.Id })
                                  .ToList());
            ...
            var actDisposalIds =
                servActsDisposals.Where(x => tmpFirst.Contains(x.Children.Id))
            ...
            var disposalsWithExeDocs =
                servDisposals.Where(x => tmpFirst.Contains(x.Id))
                             .Select(x => new { x.Id, Code = x.KindCheck!= null ? x.KindCheck.Code : 0, x.TypeDisposal, x.Inspection.TypeBase, x.Stage })
                             .ToList();
            ...
            while (start < tempDisposalsIds.Length)
            {
                ...
                disposalsWithExeDocs.AddRange(
                    servDisposals.Where(x => tmp.Contains(x.Id))
                    .Select(x => new { x.Id, Code = x.KindCheck!= null ? x.KindCheck.Code : 0, x.TypeDisposal, x.Inspection.TypeBase, x.Stage })
                                 .ToList());
            ...
            var exeDocsDisposalsIds =
                actDisposalIds.Join(
                    exeDocActIds, x => x.actId, y => y.actId, (x, y) => new { x.disposalId, y.exeDocId }).ToList();

            var disposalsIdsRow17 =
                disposalsWithExeDocs.Where(
                    x =>
                    x.Code == TypeCheck.PlannedExit || x.Code == TypeCheck.PlannedDocumentation
                    || x.Code == TypeCheck.PlannedDocumentationExit || x.Code == TypeCheck.VisualSurvey)
                                    .Select(x => x.Id)
                                    .ToList();
            ...
            var exeDocsWithViolations =
                servExeDocsWithViol.Where(x => tmpFirst.Contains(x.Document.Id))
                                   .Select(
                                       x =>
                                       new
                                       {
            ...
            while (start < tempExeDocsIds.Length)
            {
                ...
                exeDocsWithViolations.AddRange(
                    servExeDocsWithViol.Where(x => tmp.Contains(x.Document.Id))
                                       .Select(
                                           x =>
                                           new
                                           {
            ...
            var disposalsIdsCell18_7 =
                disposalsWithExeDocs.Where(
                    x =>
                    x.Code == TypeCheck.NotPlannedExit || x.Code == TypeCheck.NotPlannedDocumentation
            ...
            var exeDocWithViolationsCell18_7 =
                exeDocsDisposalsIds.Where(x => disposalsIdsCell18_7Ids.Contains(x.disposalId))
                                   .Where(x => exeDocsWithViolationsIds.Contains(x.exeDocId))
                                   .Select(x => x.exeDocId)
                                   .Distinct()
                                   .ToList();
            ...
            this.violationsCountCell20_6 =
                exeDocsWithViolations.Where(x => x.TypeBase == TypeBase.PlanJuridicalPerson)
            ...
            var disposalsIdsCell20_7Ids =
                disposalsIdsCell18_7.Where(x => x.TypeDisposal != TypeDisposalGji.DocumentGji)
                                    .Select(x => x.Id)
                                    .ToList();

            var exeDocWithViolationsCell20_7 =
                exeDocsDisposalsIds.Where(x => disposalsIdsCell20_7Ids.Contains(x.disposalId))
                                   .Where(x => exeDocsWithViolationsIds.Contains(x.exeDocId))
                                   .Select(x => x.exeDocId)
                                   .Distinct()
                                   .ToList();
            ...
            this.violationsCountCell20_7 =
                exeDocsWithViolations.Where(x => exeDocWithViolationsCell20_7.Contains(x.exeDocId))
                                     .Select(x => x.DocViol)
                                     .Distinct()
                                     .Count();
            ...
            var disposalsIdsCell22_6 =
                disposalsWithExeDocs.Where(
                    x => x.Code == TypeCheck.PlannedExit || x.Code == TypeCheck.PlannedDocumentation)
                    .Where(x => x.TypeBase == TypeBase.PlanJuridicalPerson)
                                    .Select(x => x.Id)
                                    .ToList();
            ...
            var disposalsIdsCell22_7 =
                disposalsWithExeDocs.Where(
                    x => x.Code == TypeCheck.NotPlannedExit || x.Code == TypeCheck.NotPlannedDocumentation)
                                    .Select(x => x.Id)
                                    .ToList();
            ...
            var servActCheckViolation =
                this.Container.Resolve<IDomainService<ActCheckViolation>>()
                    .GetAll()
            ...
            var actCheckViolations =
                servActCheckViolation.Where(x => tmpFirst.Contains(x.ActObject.ActCheck.Id))
                                     .Select(
                                         x => new { violationId = x.InspectionViolation.Id, actId = x.ActObject.ActCheck.Id })
                                     .ToList();
            ...
            while (start < allActsIds.Length)
            {
                ...
                actCheckViolations.AddRange(
                     servActCheckViolation.Where(x => tmp.Contains(x.ActObject.ActCheck.Id))
                                     .Select(
                                         x => new { violationId = x.InspectionViolation.Id, actId = x.ActObject.ActCheck.Id })
                                     .ToList());
            ...
            this.disposalsCount23_6 = exeDocsDisposalsIds.Where(x => disposalsIdsCell22_6.Contains(x.disposalId) && protocolsIds.Contains(x.exeDocId))
            ...
            this.disposalsCount23_7 = exeDocsDisposalsIds.Where(x => disposalsIdsCell22_7.Contains(x.disposalId) && protocolsIds.Contains(x.exeDocId))
                               .Select(x => x.disposalId)
                               .Distinct()
                               .Count();
            ...
            var dispStagesIds28_6 = disposalsWithExeDocs
                ...
                .Where(x => x.TypeBase == TypeBase.PlanJuridicalPerson)
                .Select(x => x.Stage.Id).Distinct().ToList();
            ...
            var resolutions =
                servResolutions.Where(x => tmpFirst.Contains(x.Stage.Parent.Id))
                                     .Select(
                                         x => new { resolutionId = x.Id, parentStageId = x.Stage.Parent.Id, sanctionCode = x.Sanction.Code, executantCode = x.Executant.Code })
                                     .ToList();
            ...
            while (start < allDispStagesIds.Length)
            {
                ...
                resolutions.AddRange(servResolutions.Where(x => tmp.Contains(x.Stage.Parent.Id))
                                     .Select(
                                         x => new { resolutionId = x.Id, parentStageId = x.Stage.Parent.Id, sanctionCode = x.Sanction.Code, executantCode = x.Executant.Code })
                                     .ToList());
            ...
            this.resolutionCount28_6 =
                resolutions.Where(x => dispStagesIds28_6.Contains(x.parentStageId))
            ...
            var executantCodesRow34 = new string[] { "6", "7", "14" };
            var executantCodesRow35 = new string[] { "1", "3", "5", "10", "12", "13", "16", "19" };
            var executantCodesRow37 = new string[] { "0", "2", "4", "8", "9", "11", "15" };
