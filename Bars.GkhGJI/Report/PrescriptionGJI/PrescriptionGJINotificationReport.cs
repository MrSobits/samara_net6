namespace Bars.GkhGji.Report
{
    ...
    public class PrescriptionGjiNotificationReport : GjiBaseReport
    {
        private long DocumentId { get; set; }

        protected override string CodeTemplate { get; set; }

        public PrescriptionGjiNotificationReport() : base(new ReportTemplateBinary(Properties.Resources.Notification_V))
        {
        }

        public override string Id
        {
            get { return "PrescriptionNotificationReport"; }
        }
        ...
        {
            get { return "Уведомление-вызов"; }
        }

        public override string Description
        {
            get { return "Уведомление-вызов из предписания"; }
        }
                    ...
                    new TemplateInfo
                        {
                            ...
                            Description = "Уведомление-вызов из предписания",
        ...
        {
            var prescription = Container.Resolve<IDomainService<Prescription>>().Get(DocumentId);
