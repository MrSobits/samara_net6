namespace Bars.GkhGji.Report
{
    ...
    /// Извещение
    /// </summary>
    public class AppealCitsDecisionReport : GkhBaseStimulReport
    {
        #region .ctor
        ...
        /// .ctor
        /// </summary>
        public AppealCitsDecisionReport()
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Name = "Решение по жалобе",
                    Description = "Решение по жалобе",
                    Code = "AppealDecision1",
                    Template = Properties.Resources.AppealCitsDecision
                }
            };
        }
