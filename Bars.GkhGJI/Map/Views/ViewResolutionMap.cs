namespace Bars.GkhGji.Map
{
    ...
    public class ViewResolutionMap : PersistentObjectMap<ViewResolution>
    {
        ...
        protected override void Map()
        {
            ...
            this.Property(x => x.ProtocolViolRoAddresses, "Адреса жилых домов").Column("PROTOCOL_RO_ADDRESSES");
            ...
            this.Property(x => x.ResolutionGjiId, "Постановление").Column("DOCUMENT_ID");
            this.Property(x => x.DeliveryDate, "Дата вручения").Column("DELIVERY_DATE");
            this.Property(x => x.Paided, "Штраф оплачен").Column("PAIDED");
            this.Property(x => x.BecameLegal, "Вступило в законную силу").Column("BECAME_LEGAL");
            this.Property(x => x.RoAddress, "Адреса по нарушениям").Column("RO_ADDRESS");
            //this.Property(x => x.GisUin, nameof(ViewResolution.GisUin)).Column("GIS_UIN");
            this.Property(x => x.TypeInitiativeOrg, nameof(ViewResolution.TypeInitiativeOrg)).Column("TYPE_INITIATIVE_ORG");
