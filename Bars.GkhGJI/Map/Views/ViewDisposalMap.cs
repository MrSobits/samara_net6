namespace Bars.GkhGji.Map
{
    ...
    public class ViewDisposalMap : PersistentObjectMap<ViewDisposal>
    {
        
        public ViewDisposalMap() : 
                base("Bars.GkhGji.Entities.ViewDisposal", "VIEW_GJI_DISPOSAL")
        {
        }
        ...
        protected override void Map()
        {
            ...
            this.Property(x => x.IssuedDisposal, "Поручитель").Column("ISSUED_DISPPOSAL_NAME");
