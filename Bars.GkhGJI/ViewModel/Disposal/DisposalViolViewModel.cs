namespace Bars.GkhGji.ViewModel
{
    ...
    public class DisposalViolViewModel : BaseViewModel<DisposalViolation>
    {
        public override IDataResult List(IDomainService<DisposalViolation> domain, BaseParams baseParams)
        {
