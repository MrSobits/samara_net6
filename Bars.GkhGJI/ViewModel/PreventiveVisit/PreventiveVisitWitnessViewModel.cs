namespace Bars.GkhGji.ViewModel
{
    ...
    public class PreventiveVisitWitnessViewModel : BaseViewModel<PreventiveVisitWitness>
    {
        public override IDataResult List(IDomainService<PreventiveVisitWitness> domainService, BaseParams baseParams)
        {
