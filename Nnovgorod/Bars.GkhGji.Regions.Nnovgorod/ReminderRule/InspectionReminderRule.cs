    ...
    public class InspectionReminderRule : IReminderRule
    {
        ...
        public void Create(IEntity entity)
        {
            ...
            try
            {
                ...
                else if (entity is ActCheckRealityObject)
                {
                    obj = servInspection.Load((entity as ActCheckRealityObject).ActCheck.Inspection.Id);
                }
                ...
                var listRemindersToDelete =
                    servReminder.GetAll().Where(x => x.InspectionGji.Id == obj.Id).Select(x => x.Id).ToList();
                        ...
                        var newReminder =
                            listRemindersToSave.FirstOrDefault(
                                ...
                                && (curr.InspectionGji != null
                                        ? (x.InspectionGji != null && x.InspectionGji.Id == curr.InspectionGji.Id)
