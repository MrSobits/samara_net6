...
namespace Bars.GkhGji.Regions.Nnovgorod.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Nnovgorod.Entities.DocumentGJIPhysPersonInfo"</summary>
    public class DocumentGJIPhysPersonInfoMap : BaseEntityMap<DocumentGJIPhysPersonInfo>
    {
        
        public DocumentGJIPhysPersonInfoMap() : 
                base("Bars.GkhGji.Regions.Nnovgorod.Entities.DocumentGJIPhysPersonInfo", "GJI_NNOV_DOCGJI_PERSINFO")
        {
        }
