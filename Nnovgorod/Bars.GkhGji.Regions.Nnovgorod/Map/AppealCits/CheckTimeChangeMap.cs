...
/// 
/// namespace Bars.GkhGji.Regions.Nnovgorod.Map.AppealCits
/// {
...
namespace Bars.GkhGji.Regions.Nnovgorod.Map.AppealCits
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Nnovgorod.Entities.AppealCits.CheckTimeChange"</summary>
    public class CheckTimeChangeMap : BaseEntityMap<CheckTimeChange>
    {
        
        public CheckTimeChangeMap() : 
                base("Bars.GkhGji.Regions.Nnovgorod.Entities.AppealCits.CheckTimeChange", "GJI_CHECK_TIME_CH")
        {
        }
