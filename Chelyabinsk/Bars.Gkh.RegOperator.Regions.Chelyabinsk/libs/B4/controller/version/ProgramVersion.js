Ext.define('B4.controller.version.ProgramVersion', {
    ...
    views: [
        ...
        'version.Add',
        'version.YearFromForCostsWindow',
    ...
    init: function() {
        ...
        this.control({
            ...
            'versionrecordsgrid [dataIndex=Order] menuitem': {
                click: {
                    fn: me.onOrderMenuItemClick,
                    scope: me
                }
            },
            ...
            'programversioneditpanel actualizeloggridgrid b4updatebutton': {
                click: { fn: me.onUpdateGrid, scope: me }
            },
            ...
            'versionrecordsgrid button[action=calculatecosts]': {
                click: {
                    fn: me.showCostsYearsWindow,
                    scope: me
                }
            },
            'yearfromforcostswindow b4closebutton': {
                click: {
                    fn: function (btn) {
                        btn.up('window').close();
                    }, scope: me
            ...
            'yearfromforcostswindow button[action=copy]': {
                click: { fn: me.onCalculateCostsClick, scope: me }
            },
   ...
   index: function() {
    ...
    version: function(id) {
        ...
        B4.Ajax.request({
            ...
            logStore = view.down('actualizeloggridgrid').getStore();
    ...
    onOrderMenuItemClick: function (menuitem) {
        var me = this,
            panel = me.getEditPanel();

        if (menuitem.action == 'Order1Stage') {
            me.stageForOrder = 1;
            me.showCalculateYearsWindow();
        } else if (menuitem.action == 'Order2Stage') {
            me.stageForOrder = 2;
            me.showCalculateYearsWindow();
        } else if (menuitem.action == 'Order3Stage') {
            me.stageForOrder = 3;
            me.showCalculateYearsWindow();
        }
    },
    ...
    showCostsYearsWindow: function () {
        var me = this,
            panel = me.getEditPanel(),
            grid = me.getVersionRecordsGrid();

        view = me.getOrderWindow() || Ext.widget('yearfromforcostswindow', {
            constrain: true,
            renderTo: B4.getBody().getActiveTab().getEl(),
            closeAction: 'destroy',
            ctxKey: me.getCurrentContextKey ? me.getCurrentContextKey() : ''
                ...
                if (btnId === "yes") {
                    ...
                    B4.Ajax.request({
                        ...
                        params: {
                            ...
                            stageForOrder: me.stageForOrder
                        },
                        timeout: 9999999
                    }).next(function (response) {
                        grid.getStore().load()
    ...
    onCalculateCostsClick: function(btn) {
        var me = this,
            panel = me.getEditPanel(),
            yearwin = btn.up('yearfromforcostswindow'),
            grid = me.getVersionRecordsGrid();  
