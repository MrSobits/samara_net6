namespace Bars.GkhGji.Regions.Chelyabinsk.Report
{
    ...
    public class SMEVReport1 : BasePrintForm
    {
        ...
        public SMEVReport1() : base(new ReportTemplateBinary(Properties.Resources.SMEV1))
        {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            //{
            //    var actCheck = Container.Resolve<IDomainService<DocumentGjiChildren>>().GetAll()
            ...
            try
            {
               ...
               .Where(x => (x.InspectionViolation.Inspection.Contragent !=null
                                && !contragentLicenseList.Contains(x.InspectionViolation.Inspection.Contragent.Id)) 
                                    || x.InspectionViolation.Inspection.Contragent == null)
               .Select(x => new
               {
                   ActCheckId = x.ActObject.ActCheck.Id,
            ...
            table["a_3"] = actChecksCount != 0 ? actCheckViolations.Count() / actChecksCount : 0;
            table["b_1"] = b_1;
