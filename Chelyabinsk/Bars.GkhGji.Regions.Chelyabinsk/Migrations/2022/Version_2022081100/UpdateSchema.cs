namespace Bars.GkhGji.Regions.Chelyabinsk.Migrations.Version_2022081100
{
    ...
    public class UpdateSchema : Migration
    {
        ...
        public override void Up()
        {
           ...
           new Column("GOALS", DbType.String, 5000),
       ...
       new RefColumn("FILE_INFO_ID", ColumnProperty.NotNull, "GJI_CH_GIS_ERKNM_FILE_INFO_ID", "B4_FILE_INFO", "ID"));
            ...
            Database.AddEntityTable("GJI_CH_GIS_ERKNM_VIOLATION",
               ...
               new Column("EXECUTION_NOTE", DbType.String, 1500),
               new Column("NUM_GUID", DbType.String, ColumnProperty.None),
               new Column("TEXT", DbType.String, 5000),
               new Column("VIOLATION_ACT", DbType.String, 5000),
               new Column("VIOLATION_NOTE", DbType.String, 5000),
               new Column("VLAWSUIT_TYPE_ID", DbType.Int32, 4, ColumnProperty.NotNull, 30),
               new RefColumn("GIS_ERKNM_ID", ColumnProperty.None, "GJI_CH_GIS_ERP_VIOLAT_ERKNM_ID", "GJI_CH_GIS_ERKNM", "ID"));
        }
