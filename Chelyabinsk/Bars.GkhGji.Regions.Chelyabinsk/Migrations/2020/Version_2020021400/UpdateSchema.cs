namespace Bars.GkhGji.Regions.Chelyabinsk.Migrations.Version_2020021400
{
    ...
    [MigrationDependsOn(typeof(Version_2020021100.UpdateSchema))]
    public class UpdateSchema : Migration
    {
        ...
        public override void Up()
        {
           ...
           new RefColumn("DOCUMENT_ID", ColumnProperty.None, "FK_GJI_CH_COURT_PRACTICE_DOCUMENT_ID", "GJI_DOCUMENT", "ID"),
           new RefColumn("INSTANCE_ID", ColumnProperty.None, "FK_GJI_CH_COURT_PRACTICE_INSTANCE_ID", "GJI_DICT_INSTANCE", "ID"),         
           new RefColumn("TYPE_FACT_ID", ColumnProperty.None, "FK_GJI_CH_COURT_PRACTICE_FV_ID", "GJI_DICT_TYPE_FACT_VIOL", "ID"),
           new RefColumn("CONTRAGENT_D_ID", ColumnProperty.None, "FK_GJI_CH_COURT_PRACTICE_DCONTR_ID", "GKH_CONTRAGENT", "ID"),
           new RefColumn("CONTRAGENT_P_ID", ColumnProperty.None, "FK_GJI_CH_COURT_PRACTICE_PCONTR_ID", "GKH_CONTRAGENT", "ID"),
           new RefColumn("CONTRAGENT_DIFF_ID", ColumnProperty.None, "FK_GJI_CH_COURT_PRACTICE_DIFFCONTR_ID", "GKH_CONTRAGENT", "ID"),
           new RefColumn("STATE_ID", "FK_GJI_CH_COURT_PRACTICE_STATE", "B4_STATE", "ID"),
           new RefColumn("FILE_ID", ColumnProperty.None, "FK_GJI_CH_COURT_PRACTICE_FILE_ID", "B4_FILE_INFO", "ID"),
           new RefColumn("JUR_INST_ID", ColumnProperty.NotNull, "FK_GJI_CH_COURT_PRACTICE_JURINST_ID", "CLW_JUR_INSTITUTION", "ID"));

            Database.AddEntityTable(
           "GJI_CH_COURT_PRACTICE_INSPECTOR",
           new Column("LAWYER_INSPECTOR", DbType.Int32, 4, ColumnProperty.NotNull, 10),
           new Column("DESCRIPTION", DbType.String, 1500),
           new RefColumn("CP_ID", ColumnProperty.NotNull, "FK_CPINSP_COURT_PRACTICE", "GJI_CH_COURT_PRACTICE", "ID"),
           new RefColumn("INSPECTOR_ID", ColumnProperty.NotNull, "FK_CPINSP_INSPECTOR", "GKH_DICT_INSPECTOR", "ID"));

            Database.AddEntityTable(
           "GJI_CH_COURT_PRACTICE_RO",
           new RefColumn("CP_ID", ColumnProperty.NotNull, "FK_CPRO_COURT_PRACTICE", "GJI_CH_COURT_PRACTICE", "ID"),
           new RefColumn("RO_ID", ColumnProperty.NotNull, "FK_CPRO_REALITY_OBJECT", "GKH_REALITY_OBJECT", "ID"));

            Database.AddEntityTable(
            "GJI_CH_COURT_PRACTICE_FILE",
            new Column("DOC_NAME", DbType.String, 1500),
            new Column("DESCRIPTION", DbType.String, 1500),
            new RefColumn("CP_ID", ColumnProperty.NotNull, "FK_CPFILE_COURT_PRACTICE", "GJI_CH_COURT_PRACTICE", "ID"),
        ...
        {
            Database.RemoveTable("GJI_CH_COURT_PRACTICE_FILE");
            Database.RemoveTable("GJI_CH_COURT_PRACTICE_RO");
            Database.RemoveTable("GJI_CH_COURT_PRACTICE_INSPECTOR");
            Database.RemoveTable("GJI_CH_COURT_PRACTICE");
        }
    }
}