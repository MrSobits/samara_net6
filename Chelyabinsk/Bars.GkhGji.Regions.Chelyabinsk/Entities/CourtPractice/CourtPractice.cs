namespace Bars.GkhGji.Regions.Chelyabinsk.Entities
{
    ...
    public class CourtPractice : BaseEntity, IStatefulEntity
    {
        ...
        /// Результат рассмотрения
        /// </summary>
        public virtual CourtMeetingResult DisputeResult { get; set; }
        ...
        /// <summary>
        /// Принудительное сохранение истории
        /// </summary>
        public virtual bool SaveHistory { get; set; }
        ...
        /// Предостережение
        /// </summary>
        public virtual AppealCitsAdmonition Admonition { get; set; }
        ...
        /// Решение по суд делу
        /// </summary>
        public virtual ResolutionDefinition ResolutionDefinition { get; set; }
