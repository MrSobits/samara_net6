namespace Bars.GkhGji.Regions.Chelyabinsk.InspectionRules
{
    ...
    /// <summary>
    /// Правило создания документа Распоряжения из основания проверки переоформления лицензии
    /// </summary>
    public class BaseLicenseReissuanceToDisposalRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseLicenseReissuanceToDisposalRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Распоряжения из основания проверки переоформления лицензии"; }
        }
        ...
        {
            get { return TypeBase.LicenseReissuance; }
        }
        ...
        public IDataResult ValidationRule(InspectionGji inspection)
        {
            ...
            */
            if (inspection != null)
            {
                ...
                {
                    return new BaseDataResult(false, "По документарной проверке юр. лиц уже создано распоряжение");
                }
            }
