namespace Bars.GkhGji.Regions.Chelyabinsk.InspectionRules
{
    ...
    /// </summary>
    public class BaseOMSUToDisposalRule : IInspectionGjiRule
    {
        ...
        public string Id
        {
            get { return "BaseOMSUDisposalRule"; }
        }

        public string Description
        {
            get { return "Правило создание документа Распоряжения из основания плановой проверки ОМСУ"; }
        }
        ...
        public IDataResult ValidationRule(InspectionGji inspection)
        {
            ...
            */
            if (inspection != null)
            {
                ...
                {
                    return new BaseDataResult(false, "По плановой проверке ОМСУ уже создано распоряжение");
                }
            }
