namespace Bars.GkhGji.Regions.Chelyabinsk.ViewModel
{
    ...
    public class ERKNMResultViolationsViewModel : BaseViewModel<ERKNMResultViolations>
    {
        public override IDataResult List(IDomainService<ERKNMResultViolations> domain, BaseParams baseParams)
        {
