namespace Bars.GkhGji.Regions.Chelyabinsk.Services.DataContracts.SyncInspections
{
    ...
    public class ActCheckProxy
    {
        ...
        /// <summary>
        /// Вопросы проверочного листа с ответами
        /// </summary>
        [DataMember]
        [XmlArray(ElementName = "ActCheckAnswerProxy")]
        public ActCheckAnswerProxy[] ActCheckAnswerProxy { get; set; }
    ...
    /// <summary>
    /// Вопросы проверочного листа
    /// </summary>
    [DataContract]
    [XmlType(TypeName = "ActCheckAnswerProxy")]
    public class ActCheckAnswerProxy
    {
        [DataMember]
        [XmlAttribute(AttributeName = "Id")]
        public long Id { get; set; }
        ...
        /// <summary>
        /// Ссылка на акт проверки
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "ActCheckId")]
        public long ActCheckId { get; set; }

        /// <summary>
        /// Ссылка на вопрос из списка
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "ControlListQuestionId")]
        public long ControlListQuestionId { get; set; }

        /// <summary>
        /// Ответ
        /// </summary>
        [DataMember]
        [XmlAttribute(AttributeName = "YesNoNotApplicable")]
        public short YesNoNotApplicable { get; set; }
    }
}