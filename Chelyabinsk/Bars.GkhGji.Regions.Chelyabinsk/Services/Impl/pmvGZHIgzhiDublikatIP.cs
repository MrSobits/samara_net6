namespace Bars.GkhGji.Regions.Chelyabinsk.Services.Impl
{
    ...
    //[ServiceBehavior(Namespace = "http://xsd.smev.ru/ppu/GZHIgzhiDublikatIP")]
    public class pmvGZHIgzhiDublikatIP : IDublikatIP
    {
        [XmlSerializerFormat]
        public createSmvGzhiDublikatIPResponse1 createSmvGzhiDublikatIP(createSmvGzhiDublikatIPRequest1 request)
        {
            // smevHistory
            string smevHistoryInnerId = Guid.NewGuid().ToString();
            string smevHistoryActionCode = "gzhiDublikatIP";
            ...
            var requestData = request.createSmvGzhiDublikatIPRequest.smvGzhiDublikatIP;

            //Prepare response
            var retVal = new createSmvGzhiDublikatIPResponse1();
            var resp = new createSmvGzhiDublikatIPResponse();
            resp.smvGzhiDublikatIP = requestData;
            retVal.createSmvGzhiDublikatIPResponse = resp;
