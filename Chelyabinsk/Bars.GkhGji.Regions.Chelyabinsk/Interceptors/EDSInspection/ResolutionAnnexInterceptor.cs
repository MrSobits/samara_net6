namespace Bars.GkhGji.Regions.Chelyabinsk.Interceptors
{
    ...
    public class ResolutionAnnexInterceptor : EmptyDomainInterceptor<ResolutionAnnex>
    {
        ...
        public override IDataResult AfterCreateAction(IDomainService<ResolutionAnnex> service, ResolutionAnnex entity)
        {
            ...
            try
            {
                logEntityHistoryService.UpdateLog(entity, TypeEntityLogging.DocumentGjiAnnex, entity.Id, entity.GetType(), GetPropertyValues(), entity.Resolution.Id.ToString() + " " + entity.Name);
            }
            catch
            {
