namespace Bars.GkhGji.Regions.Chelyabinsk.Interceptors
{
    ...
    public class AppealCitsRequestInterceptor : EmptyDomainInterceptor<AppealCitsRequest>
    {
        ...
        string MakeMessageBody()
        {
            ...
            body += $"Государственная жилищная инспекция Челябинской области уведомляет Вас о том, что в реестре электронного документооборота размещен новый запрос, файл запроса прикреплен к настоящему электронному сообщению.\r\n";
