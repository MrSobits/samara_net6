namespace Bars.GkhGji.Regions.Chelyabinsk.Interceptors
{
    ...
    public class DisposalAnnexInterceptor : EmptyDomainInterceptor<DisposalAnnex>
    {
        ...
        public override IDataResult AfterCreateAction(IDomainService<DisposalAnnex> service, DisposalAnnex entity)
        {
            ...
            try
            {
                logEntityHistoryService.UpdateLog(entity, TypeEntityLogging.DocumentGjiAnnex, entity.Id, entity.GetType(), GetPropertyValues(), entity.Disposal.Id.ToString() + " " + entity.Name);
            }
            catch
            {
