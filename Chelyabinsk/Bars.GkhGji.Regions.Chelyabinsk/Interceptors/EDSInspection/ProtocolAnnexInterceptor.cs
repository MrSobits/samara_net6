    ...
    public class ProtocolAnnexInterceptor : EmptyDomainInterceptor<ProtocolAnnex>
    {
        ...
        public override IDataResult AfterUpdateAction(IDomainService<ProtocolAnnex> service, ProtocolAnnex entity)
        {
            ...
            // снимаем задачу
            {
                ...
                logEntityHistoryService.UpdateLog(entity, TypeEntityLogging.DocumentGjiAnnex, entity.Id, entity.GetType(), GetPropertyValues(), entity.Protocol.DocumentNumber + " " + entity.Name);
            }
            catch
            {
        ...
        public override IDataResult AfterCreateAction(IDomainService<ProtocolAnnex> service, ProtocolAnnex entity)
        {
            var logEntityHistoryService = this.Container.Resolve<ILogEntityHistoryService>();
            try
            {
                logEntityHistoryService.UpdateLog(entity, TypeEntityLogging.DocumentGjiAnnex, entity.Id, entity.GetType(), GetPropertyValues(), entity.Protocol.Id.ToString() + " " + entity.Name);
            }
            catch
            {
        ...
        public override IDataResult AfterDeleteAction(IDomainService<ProtocolAnnex> service, ProtocolAnnex entity)
        {
            var logEntityHistoryService = this.Container.Resolve<ILogEntityHistoryService>();
            try
            {
                logEntityHistoryService.UpdateLog(null, TypeEntityLogging.DocumentGjiAnnex, entity.Id, entity.GetType(), GetPropertyValues(), entity.Protocol.DocumentNumber + " " + entity.Name);
            }
            catch
            {
