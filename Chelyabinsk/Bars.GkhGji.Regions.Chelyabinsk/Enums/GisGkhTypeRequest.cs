namespace Bars.GkhGji.Regions.Chelyabinsk.Enums
{
    ...
    public enum GisGkhTypeRequest
    {
        ...
        /// <summary>
        /// Выгрузка договоров КПР
        /// </summary>
        [Display("Выгрузка договоров КПР")]
        importBuildContract = 131,

        /// <summary>
        /// Выгрузка актов КПР
        /// </summary>
        [Display("Выгрузка актов КПР")]
        importPerfWorkAct = 132,
        ...
        /// <summary>
        /// Получение обращений (капремонт)
        /// </summary>
        [Display("Получение обращений (капремонт)")]
        exportAppealCR = 601,
        ...
        /// <summary>
        /// Отправка ответов (капремонт)
        /// </summary>
        [Display("Отправка ответов (капремонт)")]
        importAnswerCR = 611,
