...
namespace Bars.GkhGji.Regions.Chelyabinsk.DomainService
{
    ...
    public interface IComplaintsService
    {
        ...
        /// <param name="indicator"><see cref=IProgressIndicator/></param>
        /// <returns>true, если успешно</returns>
        bool CreateAppeals(Rootobject requestData, IProgressIndicator indicator = null);
        ...
        /// <param name="indicator"><see cref=IProgressIndicator/></param>
        /// <returns>true, если успешно</returns>
        bool CreateEmailGJI(Rootobject requestData, string token, IProgressIndicator indicator = null);
