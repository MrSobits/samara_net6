     ...
     aspects: [
         ...
         },
         {
             ...
             permissions: [
                 ...
                 {
                     name: 'GkhGji.SOPR.Field.Correspondent',
                     applyTo: '#gcCorrespondent',
                     selector: 'appealordergrid',
                     applyBy: function (component, allowed) {
                         var me = this;
                         debugger;
                 ...
                 {
                     name: 'GkhGji.SOPR.Field.Correspondent',
                     applyTo: '#gcCorrespondentAddress',
                     selector: 'appealordergrid',
                     applyBy: function (component, allowed) {
                         var me = this;
                         debugger;
                 ...
                 {
                     name: 'GkhGji.SOPR.Field.AppealFile',
                     applyTo: '#gcFile',
                     selector: 'appealordergrid',
                     applyBy: function (component, allowed) {
                         var me = this;
                 ...
                 {
                     name: 'GkhGji.SOPR.Field.Confirmed',
                     applyTo: '#cbConfirmedGJI',
                     selector: '#appealcitsAppealOrderEditWindow',
                     applyBy: function (component, allowed) {
                         var me = this;
                         debugger;
                 ...
                 {
                     name: 'GkhGji.SOPR.Field.AppealText',
                     applyTo: '#taAppealText',
                     selector: '#appealcitsAppealOrderEditWindow',
                     applyBy: function (component, allowed) {
                         var me = this;
                         debugger;
