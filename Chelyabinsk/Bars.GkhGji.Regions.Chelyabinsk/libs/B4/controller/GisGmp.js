Ext.define('B4.controller.GisGmp', {
    ...
    aspects: [
        ...
        },
        {
            ...
            name: 'gisGmpButtonExportAspect',
            gridSelector: 'gisgmpgrid',
            buttonSelector: 'gisgmpgrid #btnExport',
            controllerName: 'GISGMPExecute',
            actionName: 'Export',
            usePost: true,
            exportName: 'GisGmpDataExport',
        ...
        },
        {
            ...
            onChangeTypeLicenseRequest: function (field, newValue) {
                var form = this.getForm(),
                    ...
                    dfSMEVStage = form.down('#dfSMEVStage'),
                ...
                if (newValue == B4.enums.TypeLicenseRequest.First) {
                    ...
                    //{
                    //    dfSMEVStage.setValue("Пошлина за переоформление лицензии");
                    //}
                    //if (newValue == B4.enums.TypeLicenseRequest.Copy)
                    //{
                    //    dfSMEVStage.setValue("Пошлина за выдачу дубликата лицензии");
                    //}
                }
                else {
                    dfProtocol.show();
            ...
            listeners: {
                ...
                beforesetformdata: function (me, record) {
                    this.controller.afterset = false;
                    var gisGMP = record.getId(),
                        grid = form.down('gisgmpfileinfogrid'),
                    store = grid.getStore();
                    store.filter('GisGmp', gisGMP);
                }
