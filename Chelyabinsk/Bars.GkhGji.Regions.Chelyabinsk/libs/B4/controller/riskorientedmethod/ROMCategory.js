Ext.define('B4.controller.riskorientedmethod.ROMCategory', {
    ...
    stores: [
        ...
        'riskorientedmethod.G1Resolution',
    ...
    views: [
        ...
        'riskorientedmethod.G1ResolutionGrid',
             ...
             recalculate: function (record) {
                 ...
                 if (isChanges == true) {
                     ...
                     var result = B4.Ajax.request({
                         url: B4.Url.action('Calculate', 'ROMCalculate'),
                         params: {
             ...
             listeners: {
                 aftersetformdata: function (asp, rec, form) {
                  ...
                  //   me.controller.getAspect('admonitionPrintAspect').loadReportStore();
                     ...
                     var grid6 = form.down('g1resolutiongrid'),
                         store6 = grid6.getStore();
                     store6.filter('parentId', rec.getId());
