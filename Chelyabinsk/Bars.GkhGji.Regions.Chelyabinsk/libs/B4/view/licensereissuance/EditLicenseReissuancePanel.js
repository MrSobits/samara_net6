Ext.define('B4.view.licensereissuance.EditLicenseReissuancePanel', {
    extend: 'Ext.form.Panel',
    alias: 'widget.licenseReissuanceEditPanel',
    closable: true,
    minWidth: 700,
    bodyPadding: 5,
    layout: {
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'licensereissuancepersongrid',
                        ...
                        {
                            xtype: 'licensereissuanceprovdocgrid',
                            flex: 1
                        }
