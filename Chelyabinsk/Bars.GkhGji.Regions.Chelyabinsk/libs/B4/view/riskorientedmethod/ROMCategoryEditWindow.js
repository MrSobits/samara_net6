Ext.define('B4.view.riskorientedmethod.ROMCategoryEditWindow', {
    ...
    requires: [
        ...
        'B4.form.EnumCombo',
        'B4.enums.YearEnums',
        'B4.enums.SeverityGroup',
        'B4.enums.ProbabilityGroup',
        ...
        'B4.view.riskorientedmethod.G1ResolutionGrid',
                    ...
                    items: [
                        {
                            ...
                            editable: false,
                            name: 'SeverityGroup',
                            fieldLabel: 'Группа тяжести',
                            labelAlign: 'right',
                            enumName: 'B4.enums.SeverityGroup',
                            allowBlank: false,
                        },
                        {
                            xtype: 'b4enumcombo',
                            ...
                            fieldLabel: 'Группа вероятности',
                            labelAlign: 'right',
                            enumName: 'B4.enums.ProbabilityGroup',
                            allowBlank: false,
                        }
                    ]
                },
