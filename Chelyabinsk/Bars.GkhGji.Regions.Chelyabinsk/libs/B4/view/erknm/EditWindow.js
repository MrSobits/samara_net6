Ext.define('B4.view.erknm.EditWindow', {
    ...
    requires: [
        ...
        'B4.ux.button.Save',
        'B4.form.SelectField',
        'B4.store.ListDecisionForERKNM',
        'B4.store.dict.ProsecutorOffice',
        'B4.view.erknm.FileInfoGrid',
        'B4.view.erknm.ERKNMResultViolationsGrid',
    ...
    width: 1000,
    bodyPadding: 10,
    itemId: 'erknmEditWindow',
    title: 'Обмен данными с ЕРКНМ',
    closeAction: 'hide',
                    ...
                    items: [
                        {
                            ...
                            title: 'Отправка информации о КНМ',
                            border: false,
                            bodyPadding: 10,
                            items: [
                                {
                                ...
                                },
                                {
                                    ...
                                    flex: 1,
                                    store: B4.enums.ERKNMRequestType.getStore(),
                                    valueField: 'Value',
                                    allowBlank: false,
                                    editable: false
                                },                               
                                {
                                    ...
                                    items: [

                                        {
                                            ...
                                            itemId: 'dfProtocol',
                                            store: 'B4.store.ListDecisionForERKNM',
                                            flex: 1,
                                            editable: false,
                                            allowBlank: true,
                                            columns: [
                                ...
                                },                                
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'erknmresultviolationsgrid',
                                            flex: 1
                                        },
                                        {
                                            xtype: 'erknmfileinfogrid',
                                            flex: 1
                                        }
                                    ]
                                }
