Ext.define('B4.view.courtpractice.EditWindow', {
    ...
    requires: [
        ...
        'B4.store.appealcits.Decision',
        'B4.store.resolution.CourtPracticeDecision',
        'B4.store.dict.RevenueSourceGji',
        'B4.store.dict.RevenueFormGji',
        'B4.store.mkdlicrequest.MKDLicRequest',
        'B4.enums.TypeDocumentGji',
        'B4.form.FileField',
        'B4.store.resolution.ResolutionDefinition',
        'B4.store.resolution.AppealCitsDefinition',
        'B4.view.courtpractice.DisputeHistoryGrid',
        'B4.store.Contragent',
        ...
        'B4.store.resolution.AppealDecision',
        'B4.view.Control.GkhTriggerField',
        ...
        Ext.applyIf(me, {
            items: [
                ...
                },
                {
                    ...
                    labelAlign: 'right',
                    fieldLabel: 'Решение',
                    store: 'B4.store.resolution.CourtPracticeDecision',
                    columns: [
                ...
                },
                {
                    ...
                    itemId: 'sfAppealCitsDecision2',
                    textProperty: 'AppealNumber',
                    allowBlank: true,
                    labelAlign: 'right',
                    fieldLabel: 'Решение',
                    store: 'B4.store.resolution.AppealDecision',
                    columns: [
                        { text: 'Номер жалобы', dataIndex: 'AppealNumber', flex: 1, filter: { xtype: 'textfield' } },
                        { xtype: 'datecolumn', format: 'd.m.Y', text: 'Дата жалобы', dataIndex: 'AppealDate', flex: 0.5, filter: { xtype: 'datefield' } },
                        { text: 'Заявитель', dataIndex: 'Apellant', flex: 1, filter: { xtype: 'textfield' } }
                ...
                },
                {
                    ...
                    itemId: 'sfAppealCitsDefinition',
                    textProperty: 'DocumentNum',
                    allowBlank: true,
                    labelAlign: 'right',
                    fieldLabel: 'Определение',
                    store: 'B4.store.resolution.AppealCitsDefinition',
                    columns: [
                        { text: 'Номер', dataIndex: 'DocumentNum', flex: 1, filter: { xtype: 'textfield' } },
                        { xtype: 'datecolumn', format: 'd.m.Y', text: 'Дата жалобы', dataIndex: 'DocumentDate', flex: 0.5, filter: { xtype: 'datefield' } },
                        { xtype: 'b4enumcolumn', text: 'Тип', dataIndex: 'TypeDefinition', flex: 1, enumName: 'B4.enums.TypeDefinitionResolution', filter: true }
                    ],
                    editable: false
                },
                {
                    ...
                    itemId: 'sfResolutionDefinition',
                    textProperty: 'DocumentNum',
                    allowBlank: true,
                    labelAlign: 'right',
                    fieldLabel: 'Определение',
                    store: 'B4.store.resolution.ResolutionDefinition',
                    columns: [
                        { text: 'Номер', dataIndex: 'DocumentNum', flex: 1, filter: { xtype: 'textfield' } },
                        { text: 'Номер постановления', dataIndex: 'ResolutionNum', flex: 1, filter: { xtype: 'textfield' } },
                        { xtype: 'datecolumn', format: 'd.m.Y', text: 'Дата жалобы', dataIndex: 'DocumentDate', flex: 0.5, filter: { xtype: 'datefield' } },
                        { xtype: 'b4enumcolumn', text: 'Тип', dataIndex: 'TypeDefinition', flex: 1, enumName: 'B4.enums.TypeDefinitionResolution', filter: true }
                    ],
                    editable: false
                },
                {
                    ...
                    items: [
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'checkbox',
                                            itemId: 'cbSaveHistory',
                                            name: 'SaveHistory',
                                            hidden: true,
                                            flex: 0.3,
                                            fieldLabel: 'Занести в историю',
                                            allowBlank: true,
                                            disabled: false,
                                            labelWidth: 120,
                                            editable: true
                        ...
                        {
                            xtype: 'courtpracticeDisputeHistoryGrid',
                            disabled: true,
                            flex: 1
                        }
