Ext.define('B4.view.smevegrul.Grid', {
    extend: 'B4.ux.grid.Panel',
    
    alias: 'widget.smevegrulgrid',
    ...
    title: 'Реестр запросов в ЕГРЮЛ',
    store: 'smev.SMEVEGRUL',
