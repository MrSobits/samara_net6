Ext.define('B4.view.mkdlicrequest.AnswerEditWindow', {
    ...
    minHeight: 400,
    bodyPadding: 5,
    itemId: 'mkdLicRequestAnswerEditWindow',
    title: 'Ответ',
    ...
    requires: [
        ...
        'B4.view.mkdlicrequest.AnswerAttachmentGrid',
        'B4.store.Contragent'
    ],
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'mkdLicRequestAnswerAttachmentGrid',
                            flex: 1
                        }
                    ]
                }
