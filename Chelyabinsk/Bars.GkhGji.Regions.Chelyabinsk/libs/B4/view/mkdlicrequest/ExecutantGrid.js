Ext.define('B4.view.mkdlicrequest.ExecutantGrid', {
    ...
    requires: [
        ...
        'B4.form.ComboBox',
        'B4.store.mkdlicrequest.Executant'
    ],

    alias: 'widget.mkdLicRequestExecutantGrid',
    store: 'mkdlicrequest.Executant',
    itemId: 'mkdLicRequestExecutantGrid',
