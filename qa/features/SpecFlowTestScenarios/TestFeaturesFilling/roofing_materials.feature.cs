...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "тесткейсы для раздела \"Материалы кровли\"", "Справочники - Жилищно-коммунальное хозяйство - Материалы кровли", ProgrammingLanguage.CSharp, ((string[])(null)));
...
this.FeatureBackground();
#line 19
testRunner.Given("пользователь сохраняет этот материал кровли", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Дано ");
#line 20
testRunner.Given("пользователь добавляет новый материал кровли", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Дано ");
#line 21
testRunner.And("пользователь у этого материала кровли заполняет поле Наименование \"материал кровл" +
