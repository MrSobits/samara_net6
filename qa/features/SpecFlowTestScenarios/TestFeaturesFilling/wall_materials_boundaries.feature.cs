...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "тесткейсы граничных значений для раздела \"Материалы стен\"", "Справочники - Жилищно-коммунальное хозяйство - Материалы стен", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("создание нового материала стен с пустыми полями", ((string[])(null)));
#line 6
