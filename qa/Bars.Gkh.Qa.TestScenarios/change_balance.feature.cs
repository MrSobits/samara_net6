...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "установка и изменение сальдо", "", ProgrammingLanguage.CSharp, new string[] {
...
#line 7
testRunner.And("пользователь в реестре ЛС выбирает лицевой счет \"100000390\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "И ");
#line 8
...
testRunner.And("у этой записи, в истории изменений ЛС, Описание измененного атрибута \"Ручное изме" +
                    "нение сальдо с 3027.08 на 1000\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "И ");
#line 15
...
#line 18
testRunner.And("у этой записи, в истории изменений ЛС, Причина \"тест сальдо\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "И ");
#line 19
...
#line 21
testRunner.And("у этой детальной информации есть запись \"Установка/изменение сальдо\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "И ");
#line 23
testRunner.And("у этой записи по пени заполнено поле Изменение сальдо \"-2027,0800000000\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "И ");
#line 24
...
#line 26
testRunner.And("у этой записи по текущему периоду заполнено поле Сумма \"-2027,08000\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "И ");
#line 28
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("неудачная смена сальдо без выбора ЛС", new string[] {
                        "ignore"});
#line 34
this.ScenarioSetup(scenarioInfo);
#line 35
testRunner.When("пользователь вызывает операцию Установка и изменение сальдо без ваыбора лс", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Когда ");
#line 36
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("неудачная сальдо сальдо для одновременно двух ЛС", new string[] {
                        "ignore"});
#line 40
this.ScenarioSetup(scenarioInfo);
#line 41
...
#line 42
testRunner.Then("падает ошибка с текстом \"Необходимо выбрать один лицевой счет!\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Тогда ");
#line hidden
            this.ScenarioCleanup();
        }
