...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "тесткейсы для раздела \"Кредитные организации\"", "Участники процесса - Контрагенты - Кредитные организации", ProgrammingLanguage.CSharp, new string[] {
