namespace Bars.GisIntegration.Smev.Map.ERKNM
{
    using Bars.B4.Modules.Mapping.Mappers;
    using Bars.GisIntegration.Smev.Entity.ERKNM;

    public class ErknmEntityMap : BaseEntityMap<ErknmEntity>
    {
        public ErknmEntityMap()
            : base("Bars.GkhGji.Entities", "GI_ERKNM")
        {
        }
        ...
        protected override void Map()
        {
            ...
            Property(x => x.ReplyDate, "Дата ответа").Column("REPLY_DATE");
