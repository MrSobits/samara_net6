...
//        {
//            #region GI_ATTACHMENT

//            new TableProxy("gi_attachment", @"
//                CREATE TABLE gi_attachment
//                (
//                  id serial NOT NULL,
...
//                  src_file_info_id bigint NOT NULL DEFAULT 0,
//                  file_storage_name smallint NOT NULL DEFAULT 0,
//                  CONSTRAINT ris_attachment_pkey PRIMARY KEY (id),
//                  CONSTRAINT fk_ris_attach_file_info FOREIGN KEY (file_info_id)
//                      REFERENCES b4_file_info (id) MATCH SIMPLE
//                      ON UPDATE NO ACTION ON DELETE NO ACTION
//                )
//            ", new List<IndexProxy>
//            {
//                new IndexProxy("ind_ris_attach_file_info", @"
//                    CREATE INDEX ind_ris_attach_file_info
//                    ON gi_attachment
//                    USING btree
//                    (file_info_id);
//                ")
...
//            #region GI_CONTRAGENT

//            new TableProxy("gi_contragent", @"
//                CREATE TABLE gi_contragent
//                (
//                  id serial NOT NULL,
//                  object_version bigint NOT NULL,
//                  object_create_date timestamp without time zone NOT NULL,
...
//                  orgrootentityguid character varying(50),
//                  orgversionguid character varying(50),
//                  fact_address character varying(500),
//                  jur_address character varying(500),
//                  orgtype smallint,
//                  orgppaguid character varying(50),
//                  CONSTRAINT ris_contragent_pkey PRIMARY KEY (id)
//                )
//            "),

//            #endregion

//            #region GI_CONTEXT_SETTINGS

//            new TableProxy("gi_context_settings", @"
//                CREATE TABLE gi_context_settings
//                (
//                  id serial NOT NULL,
//                  object_version bigint NOT NULL,
//                  object_create_date timestamp without time zone NOT NULL,
//                  object_edit_date timestamp without time zone NOT NULL,
//                  file_storage_name smallint NOT NULL,
//                  context character varying(100) NOT NULL,
//                  CONSTRAINT gi_context_settings_pkey PRIMARY KEY (id)
//                )
//            "),

//            #endregion

//            #region GI_INTEGR_DICT

//            new TableProxy("gi_integr_dict", @"
//                CREATE TABLE gi_integr_dict
//                (
//                  id serial NOT NULL,
//                  object_version bigint NOT NULL,
//                  object_create_date timestamp without time zone NOT NULL,
...
//                  action_code character varying(500),
//                  registry_number character varying(50),
//                  dict_group smallint,
//                  state smallint,
//                  rec_compare_date timestamp without time zone,
//                  CONSTRAINT ris_integr_dict_pkey PRIMARY KEY (id)
//                )
//            "),

//            #endregion

//            #region GI_INTEGR_REF_DICT

//            new TableProxy("gi_integr_ref_dict", @"
//                CREATE TABLE gi_integr_ref_dict
//                (
//                  id serial NOT NULL,
//                  object_version bigint NOT NULL,
//                  object_create_date timestamp without time zone NOT NULL,
//                  object_edit_date timestamp without time zone NOT NULL,
//                  dict_id bigint,
//                  gis_rec_name character varying(1000),
//                  gkh_rec_id bigint,
//                  gkh_rec_name character varying(1000),
//                  gis_rec_guid character varying(50),
//                  gis_rec_id character varying(10),
//                  CONSTRAINT ris_integr_ref_dict_pkey PRIMARY KEY (id),
//                  CONSTRAINT fk_ris_integr_ref_dict FOREIGN KEY (dict_id)
//                      REFERENCES gi_integr_dict (id) MATCH SIMPLE
//                      ON UPDATE NO ACTION ON DELETE NO ACTION
//                )
//            ", new List<IndexProxy>
//            {
//                new IndexProxy("ind_ris_integr_ref_dict", @"
//                    CREATE INDEX ind_ris_integr_ref_dict
//                    ON gi_integr_ref_dict
//                    USING btree
//                    (dict_id);
//                ")
//            }),
...
//            #region GI_PACKAGE_DATA

//            new TableProxy("gi_package_data", @"
//                CREATE TABLE gi_package_data
//                (
//                  id serial NOT NULL,
//                  data_id bigint,
//                  sig_data_id bigint,
//                  transport_guid_dictionary bytea,
//                  CONSTRAINT gi_package_data_pkey PRIMARY KEY (id),
//                  CONSTRAINT fk_gi_pac_dat_dat FOREIGN KEY (data_id)
//                      REFERENCES b4_file_info (id) MATCH SIMPLE
//                      ON UPDATE NO ACTION ON DELETE NO ACTION,
//                  CONSTRAINT fk_gi_pac_dat_sigdat FOREIGN KEY (sig_data_id)
//                      REFERENCES b4_file_info (id) MATCH SIMPLE
//                      ON UPDATE NO ACTION ON DELETE NO ACTION
//                )
//            ", new List<IndexProxy>
//            {
//                new IndexProxy("ind_gi_pac_dat_dat", @"
//                    CREATE INDEX ind_gi_pac_dat_dat
//                    ON gi_package_data
//                    USING btree
//                    (data_id)
//                "),
//                new IndexProxy("ind_gi_pac_dat_sigdat", @"
//                    CREATE INDEX ind_gi_pac_dat_sigdat
//                    ON gi_package_data
//                    USING btree
//                    (sig_data_id)
//                ")
...
//            new TableProxy("gi_package", @"
//               CREATE TABLE gi_package
//                (
//                  id serial NOT NULL,
//                  object_version bigint NOT NULL,
//                  object_create_date timestamp without time zone NOT NULL,
//                  object_edit_date timestamp without time zone NOT NULL,
//                  not_signed_data bytea,
//                  signed_data bytea,
//                  transport_guid_dictionary bytea,
...
//                  package_data_id bigint NOT NULL DEFAULT 0,
//                  CONSTRAINT ris_package_pkey PRIMARY KEY (id),
//                  CONSTRAINT fk_ris_pack_contr FOREIGN KEY (contragent_id)
//                      REFERENCES gi_contragent (id) MATCH SIMPLE
//                      ON UPDATE NO ACTION ON DELETE NO ACTION
//                )
//            ", new List<IndexProxy>
//            {
//                new IndexProxy("ind_ris_pack_contr", @"
//                    CREATE INDEX ind_ris_pack_contr
//                    ON gi_package
//                    USING btree
//                    (contragent_id);
//                ")
...
//            #region GI_PACKAGE_TRIGGER

//            new TableProxy("gi_package_trigger", @"
//              CREATE TABLE gi_package_trigger
//                (
//                    id serial NOT NULL,
//                    object_version bigint NOT NULL,
//                    object_create_date timestamp without time zone NOT NULL,
...
//                    trigger_id bigint,
//                    message text,
//                    ack_message_guid character varying(100),
//                    processing_result bytea,
//                    state smallint NOT NULL DEFAULT 10,
//                    CONSTRAINT ris_package_trigger_pkey PRIMARY KEY (id),
//                    CONSTRAINT fk_ris_package_trigger_package FOREIGN KEY (package_id)
//                        REFERENCES gi_package (id) MATCH SIMPLE
//                        ON UPDATE NO ACTION ON DELETE NO ACTION,
//                    CONSTRAINT fk_ris_package_trigger_trigger FOREIGN KEY (trigger_id)
//                        REFERENCES schdlr_trigger (id) MATCH SIMPLE
//                        ON UPDATE NO ACTION ON DELETE NO ACTION
//                )
//            ", new List<IndexProxy>
//            {
//                new IndexProxy("ind_ris_package_trigger_package", @"
//                    CREATE INDEX ind_ris_package_trigger_package
//                    ON gi_package_trigger
//                    USING btree
//                    (package_id);

//                "),
//                 new IndexProxy("ind_ris_package_trigger_trigger", @"
//                    CREATE INDEX ind_ris_package_trigger_trigger
//                    ON gi_package_trigger
//                    USING btree
//                    (trigger_id);
//                ")
...
//            new TableProxy("gi_task", @"
//               CREATE TABLE gi_task
//                (
//                  id serial NOT NULL,
//                  object_version bigint NOT NULL,
//                  object_create_date timestamp without time zone NOT NULL,
...
//                  task_state smallint NOT NULL DEFAULT 110,
//                  message bytea,
//                  CONSTRAINT ris_task_pkey PRIMARY KEY (id)
//                )
//            "),

//            #endregion

//            #region GI_TASK_TRIGGER

//            new TableProxy("gi_task_trigger", @"
//               CREATE TABLE gi_task_trigger
//                (
//                  id serial NOT NULL,
//                  object_version bigint NOT NULL,
//                  object_create_date timestamp without time zone NOT NULL,
...
//                  trigger_state smallint NOT NULL DEFAULT 70,
//                  message bytea,
//                  CONSTRAINT ris_task_trigger_pkey PRIMARY KEY (id),
//                  CONSTRAINT fk_ris_task_trigger_task FOREIGN KEY (task_id)
//                      REFERENCES gi_task (id) MATCH SIMPLE
//                      ON UPDATE NO ACTION ON DELETE NO ACTION,
//                  CONSTRAINT fk_ris_task_trigger_trigger FOREIGN KEY (trigger_id)
//                      REFERENCES schdlr_trigger (id) MATCH SIMPLE
//                      ON UPDATE NO ACTION ON DELETE NO ACTION
//                )
//            ", new List<IndexProxy>
//            {
//                new IndexProxy("ind_ris_task_trigger_task", @"
//                    CREATE INDEX ind_ris_task_trigger_task
//                    ON gi_task_trigger
//                    USING btree
//                    (task_id);
//                "),
//                new IndexProxy("ind_ris_task_trigger_trigger", @"
//                    CREATE INDEX ind_ris_task_trigger_trigger
//                    ON gi_task_trigger
//                    USING btree
//                    (trigger_id);
//                ")
...
//            #region GI_SERVICE_SETTINGS

//            new TableProxy("gi_service_settings", @"
//                CREATE TABLE gi_service_settings
//                (
//                    id serial NOT NULL,
//                    object_version bigint NOT NULL,
//                    object_create_date timestamp without time zone NOT NULL,
//                    object_edit_date timestamp without time zone NOT NULL,
//                    integration_service integer NOT NULL,
//                    address character varying(255),
//                    async_address character varying(255),
//                    CONSTRAINT ris_service_settings_pkey PRIMARY KEY (id)
//                )
//            ", new List<IndexProxy>
//            {
//                new IndexProxy("integration_service", @"
//                    CREATE UNIQUE INDEX integration_service
//                    ON gi_service_settings
//                    USING btree
//                    (integration_service);
//                ")
//            }),
...
//                  CONSTRAINT fk_ris_contratt_account FOREIGN KEY (account_id)
//                      REFERENCES ris_account (id) MATCH SIMPLE
//                      ON UPDATE NO ACTION ON DELETE NO ACTION,
...
//            ", new List<IndexProxy>
//            {
//                new IndexProxy("ind_ris_contratt_account", @"
//                    CREATE INDEX ind_ris_contratt_account
...
//                      CONSTRAINT fk_ris_trustdocatt_account FOREIGN KEY (account_id)
//                          REFERENCES ris_account (id) MATCH SIMPLE
//                          ON UPDATE NO ACTION ON DELETE NO ACTION,
...
//                new List<IndexProxy>
//                {
//                    new IndexProxy("ind_ris_trustdocatt_account", @"
//                        CREATE INDEX ind_ris_trustdocatt_account
...
//                      CONSTRAINT fk_ris_capital_repair_debt_container FOREIGN KEY (gi_container_id)
//                          REFERENCES public.gi_container (id) MATCH SIMPLE
//                          ON UPDATE NO ACTION ON DELETE NO ACTION,
...
//                new List<IndexProxy>
//                {
//                    new IndexProxy("ind_ris_capital_repair_debt_container", @"
//                        CREATE INDEX ind_ris_capital_repair_debt_container
