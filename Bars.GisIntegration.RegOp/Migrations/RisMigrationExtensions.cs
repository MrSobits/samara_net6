namespace Bars.GisIntegration.RegOp.Migrations
{
    using System;
    ...
    public static class RisMigrationExtensions
    {
        ...
        [Obsolete("Использовать метод AddRisTable")]
        ...
        /// <param name="tableName">Имя таблицы</param>
        /// <param name="columns">Дополнительные колонки</param>
        public static void AddRisTable(this ITransformationProvider database, string tableName,
            params Column[] columns)
        {
            var dictColumns = new List<Column>
            {
