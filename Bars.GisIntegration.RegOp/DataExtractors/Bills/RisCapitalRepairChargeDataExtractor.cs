namespace Bars.GisIntegration.RegOp.DataExtractors.Bills
{
    ...
    /// <summary>
    /// Экстрактор "Начисление за капитальный ремонт"
    /// </summary>
    public class RisCapitalRepairChargeDataExtractor : BaseSlimDataExtractor<RisCapitalRepairCharge>
    {
        /// <summary>
        ...
        public override List<RisCapitalRepairCharge> Extract(DynamicDictionary parameters)
        {
            ...
            var risCapitalRepairChargeDomain = this.Container.ResolveDomain<RisCapitalRepairCharge>();

            using (this.Container.Using(risCapitalRepairChargeDomain))
            {
                return risCapitalRepairChargeDomain.GetAll()
        ...
        private bool ExecuteProcedures(long[] extractedPayDocs, DateTime reportingPeriod)
        {
            ...
            try
            {
                ...
                var procedures = new[] { "ris_transfer_capital_repair_charge" };
        ...
        /// <param name="reportingPeriod">Период</param>
