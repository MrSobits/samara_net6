namespace Bars.GisIntegration.RegOp.Dictionaries.HouseManagement
{
    ...
    /// </summary>
    public class OverhaulFormingKindDictionary : BaseDictionary
    {
        /// <summary>
        /// Конструктор справочника
        /// </summary>
        /// <param name="container">IoC контейнер</param>
        public OverhaulFormingKindDictionary(IWindsorContainer container)
            : base(container)
        {
        }
        ...
        {
            return ExternalEntityProxyList.FromEnum<CrFundFormationDecisionType>();
        }
    }
}
