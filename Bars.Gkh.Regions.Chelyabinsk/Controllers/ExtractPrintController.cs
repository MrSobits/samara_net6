namespace Bars.Gkh.Regions.Chelyabinsk.Controllers
{
    ...
    /// </summary>
    public class ExtractPrintController : BaseController
    {
        /// <summary>
    ...
    public class XSLTransformer
    {
        public static string CreateHtmlExtractFromXML(string xml)
        {
            ...
            Stream xsltStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Bars.Gkh.Regions.Chelyabinsk.resources.xsl.Common.xsl");
