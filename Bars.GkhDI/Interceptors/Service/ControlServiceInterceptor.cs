namespace Bars.GkhDi.Interceptors
{
    ...
    public class ControlServiceInterceptor : EmptyDomainInterceptor<ControlService>
    {
        public override IDataResult AfterCreateAction(IDomainService<ControlService> service, ControlService entity)
        {
        ...
        public override IDataResult BeforeDeleteAction(IDomainService<ControlService> service, ControlService entity)
        {
