namespace Bars.GkhDi.Interceptors
{
    ...
    public class HousingServiceInterceptor : EmptyDomainInterceptor<HousingService>
    {
        public override IDataResult AfterCreateAction(IDomainService<HousingService> service, HousingService entity)
        {
        ...
        public override IDataResult BeforeDeleteAction(IDomainService<HousingService> service, HousingService entity)
        {
