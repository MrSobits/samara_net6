namespace Bars.GkhDi.Interceptors
{
    ...
    public class AdditionalServiceInterceptor : EmptyDomainInterceptor<AdditionalService>
    {
        public override IDataResult AfterCreateAction(IDomainService<AdditionalService> service, AdditionalService entity)
        {
        ...
        public override IDataResult BeforeDeleteAction(IDomainService<AdditionalService> service, AdditionalService entity)
        {
