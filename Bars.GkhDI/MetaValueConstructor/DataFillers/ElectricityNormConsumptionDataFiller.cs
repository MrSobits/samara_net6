namespace Bars.GkhDi.MetaValueConstructor.DataFillers
{
    ...
    /// </summary>
    public class ElectricityNormConsumptionDataFiller : AbstractNormConsumptionDataFiller
    {
        /// <summary>
        ...
        {
            value.Value = this.normConsumptionDict.Get(value.EfManagingOrganization.ManagingOrganization.Id)?.Electricity ?? 0;
        }
    }
}