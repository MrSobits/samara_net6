namespace Bars.GkhDi.MetaValueConstructor.DataFillers
{
    ...
    /// <summary>
    /// Общие доходы компании за отчетный период
    /// </summary>
    public class TotalIncomeCompanyDataFiller : BaseManagingOrganizationDataFiller
    {
        ...
        {
            value.Value = this.disclosureInfoHouseManagingInfo.Get(value.EfManagingOrganization.ManagingOrganization.Id)?.SumIncomeManage ?? 0;
        }
    }
}