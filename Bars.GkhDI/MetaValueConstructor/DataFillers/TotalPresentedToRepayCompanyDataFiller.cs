namespace Bars.GkhDi.MetaValueConstructor.DataFillers
{
    ...
    /// <summary>
    ///  Начисленные платежи за отчетный период
    /// </summary>
    public class TotalPresentedToRepayCompanyDataFiller : BaseManagingOrganizationDataFiller
    {
        ...
        {
            value.Value = this.disclosureInfoHouseManagingInfo.Get(value.EfManagingOrganization.ManagingOrganization.Id)?.PresentedToRepay ?? 0;
        }
    }
}