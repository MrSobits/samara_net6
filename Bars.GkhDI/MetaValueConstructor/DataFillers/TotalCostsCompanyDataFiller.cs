namespace Bars.GkhDi.MetaValueConstructor.DataFillers
{
    ...
    /// <summary>
    /// Общие затраты компании за отчетный период
    /// </summary>
    public class TotalCostsCompanyDataFiller : BaseManagingOrganizationDataFiller
    {
        ...
        {
            value.Value = this.disclosureInfoHouseManagingInfo.Get(value.EfManagingOrganization.ManagingOrganization.Id)?.SumFactExpense ?? 0;
        }
    }
}