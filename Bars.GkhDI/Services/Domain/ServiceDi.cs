namespace Bars.GkhDi.Services.Domain
{
    ...
    using Entities;
    using Enums;
    using DataContracts.GetManOrgRealtyObjectInfo;
    ...
    public class ServiceDi : IServiceDi
    {
        ...
        public GetManOrgRealtyObjectInfoResponse GetManOrgRealtyObjectInfo(string houseId, string periodId = null)
        {
            ...
            var informationOnContractsDomain = this.Container.Resolve<IDomainService<Entities.InformationOnContracts>>();
            ...
            var workPprRepairDetailDomain = this.Container.Resolve<IDomainService<WorkRepairDetail>>();
            ...
            try
            {
                ...
                var planWorkServiceRepWorksItem = planWorkServiceRepairWorksDomain
                    ...
                    .ToDictionary(x => x.Key,
                        ...
                        {
                            WorksPpr = y.AsEnumerable().Select(z => new DataContracts.GetManOrgRealtyObjectInfo.WorkPpr
                            {
                                ...
                                Details = workPprRepairDetailDomain.GetAll()
                ...
                var workRepairTechServ = workRepairTechServDomain.GetAll()
                    ...
                    .ToDictionary(x => x.Key,
                        y => new PlanWorkServiceRepWorksItem
                        {
                            WorksTo = y.AsEnumerable().Select(z => new DataContracts.GetManOrgRealtyObjectInfo.WorkTo
                            {
                    ...
                    .Select(
                        x =>
                            new
                            {
                                ...
                                UnitMeasure = x.UnitMeasure.Name,
                                ProviderName = providerServiceDomain.GetAll()
                                    .Where(ps => ps.BaseService.Id == x.Id && ps.IsActive)
                                    .Select(ps => ps.Provider.Name)
                                    .FirstOrDefault(),
                                x.TemplateService.Code,
                                x.TariffForConsumers,
                                            ...
                                            DataByRealityObject = new DataByRealityObject
                                            {
                                                ...
                                                OrderAndConditionService = new OrderAndConditionService
                                                {
                                                    ...
                                                    WorksList = documents.ContainsKey(y.PeriodId) && documents[y.PeriodId].FileCatalogRepair != null
                                                        ...
                                                        : null,
                                                    Documents = new DataContracts.GetManOrgRealtyObjectInfo.Documents
                                                    {
                                                    ...
                                                    InformationOnContracts =
                                                        new Bars.GkhDi.Services.DataContracts.GetManOrgRealtyObjectInfo.InformationOnContracts
                                                        {
                                                                ...
                                                                .Select(
                                                                    z => new InformationOnContItem
                                                                    {
                                                                        ...
                                                                        From = z.From.HasValue && z.From.Value.Date != DateTime.MinValue.Date
                                                                            ? z.From.Value.ToShortDateString()
                                                                            : string.Empty,
                                                                        DateStart = z.DateStart.HasValue &&
                                                                            z.DateStart.Value.Date != DateTime.MinValue.Date
                                                                                ? z.DateStart.Value.ToShortDateString()
                                                                                : string.Empty,
                                                                        DateEnd = z.DateEnd.HasValue && z.DateEnd.Value.Date != DateTime.MinValue.Date
                                                                            ? z.DateEnd.Value.ToShortDateString()
                ...
                return new GetManOrgRealtyObjectInfoResponse
                    { Result = result, RealityObjectItem = realityObjectItem };
            }
            finally
            {
                ...
                this.Container.Release(workPprRepairDetailDomain);
