Ext.define('B4.view.service.control.TariffForConsumersControlGrid', {
    extend: 'B4.ux.grid.Panel',
    alias: 'widget.tariffforconsumcontrolgrid',
    requires: [
    ...
    itemId: 'tariffForConsumersControlGrid',
    store: 'service.TariffForConsumersControl',
    title: 'Тарифы',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    tooltip: 'Сохранить',
                                    iconCls: 'icon-accept',
                                    itemId: 'tariffForConsumersControlSaveButton'
                                }
                            ]
                        }
                    ]
