...
Ext.define('B4.controller.Service', {
    ...
    aspects: [
        ...
        },
        {
            ...
            listeners: {
                ...
                beforesetformdata: function (asp, record, form) {
                    ...
                    B4.Ajax.request(B4.Url.action('GetOptionsFields', 'TemplateService', {
                        templateServiceId: asp.controller.templateServiceId ? asp.controller.templateServiceId : record.get('TemplateService')
                    })).next(function (response) {
            ...
            otherActions: function (actions) {
                ...
                actions['#repairServiceEditWindow #sflProvider'] = { 'beforeload': { fn: this.controller.onBeforeLoadProvider, scope: this } };

                actions['#serviceGrid #btnUnfilledMandatoryServs'] = { 'click': { fn: this.unfillMandServBtnClick, scope: this } };

                actions['#communalServiceEditWindow'] = { 'render': function(w) {
                    var me = this,
                        params = me.params || {},
    ...
    init: function () {
        ...
        this.getStore('service.Base').on('beforeload', this.onBeforeLoad, this);

        this.getStore('service.TariffForConsumers').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.TariffForRso').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.ConsumptionNormsNpa').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.TariffForConsumersCapRep').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.TariffForConsumersRepair').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.TariffForConsumersHousing').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.TariffForConsumersControl').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.TariffForConsumersAdditional').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.HousingCostItem').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.WorkCapRepair').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.WorkRepairList').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.WorkRepairTechServ').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.WorkRepairDetail').on('beforeload', this.onBeforeLoadTariff, this, 'withSelModel');

        this.getStore('service.ProviderServiceAdditional').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.ProviderServiceControl').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.ProviderServiceHousing').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.ProviderServiceCommunal').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.ProviderServiceRepair').on('beforeload', this.onBeforeLoadTariff, this);

        this.getStore('service.ProviderServiceCapRepair').on('beforeload', this.onBeforeLoadTariff, this);
    ...
    onChangeKindServiceDi: function (newValue) {
        var win = this.controller.getCustomWindow(this);
    ...
    customServiceBtnClick: function (btn, event, aspect, record) {
        var asp = aspect.asp;
        var customWindow = asp.controller.getCustomWindow(asp);
        var kindServiceValue;
        if (customWindow && !customWindow.isHidden()) {
            kindServiceValue = customWindow.down('#KindServiceDi').getValue();
            asp.controller.templateService = customWindow.down('#templateService').getValue();
        ...
        if (kindServiceValue) {
            ...
            record ? asp.editRecord(record) : asp.editRecord(record);
        }
    ...
    setCurrentId: function (rec) {
        this.templateServiceId = rec.get('TemplateService') ? rec.get('TemplateService').Id : null;
        var id = this.baseServiceId = rec.getId();

        var tbpnl = Ext.ComponentQuery.query(this.tbpnl)[0];

        var storeTariffForConsumers = this.getStore('service.TariffForConsumers');
        var storeTariffForConsumersCapRep = this.getStore('service.TariffForConsumersCapRep');
        var storeTariffForConsumersRepair = this.getStore('service.TariffForConsumersRepair');
        var storeTariffForConsumersHousing = this.getStore('service.TariffForConsumersHousing');
        var storeTariffForConsumersControl = this.getStore('service.TariffForConsumersControl');
        var storeTariffForConsumersAdditional = this.getStore('service.TariffForConsumersAdditional');
        var storeProviderServiceAdditional = this.getStore('service.ProviderServiceAdditional');
        var storeProviderServiceControl = this.getStore('service.ProviderServiceControl');
        var storeProviderServiceHousing = this.getStore('service.ProviderServiceHousing');
        var storeProviderServiceRepair = this.getStore('service.ProviderServiceRepair');
        var storeProviderServiceCapRepair = this.getStore('service.ProviderServiceCapRepair');
        var storeProviderServiceCommunal = this.getStore('service.ProviderServiceCommunal');
        var storeHousingCostItem = this.getStore('service.HousingCostItem');
        var storeWorkCapRepair = this.getStore('service.WorkCapRepair');
        var storeTariffForRso = this.getStore('service.TariffForRso');
        var storeConsumptionNormsNpa = this.getStore('service.ConsumptionNormsNpa');
        var storeWorkRepairList = this.getStore('service.WorkRepairList');
        var storeWorkRepairDetail = this.getStore('service.WorkRepairDetail');
        var storeWorkRepairTechServ = this.getStore('service.WorkRepairTechServ');
            ...
            if (gridList) {
                gridList.getSelectionModel().on('selectionchange', function (sm, selectedRecord) {
                    if (selectedRecord.length > 0) {
                        controller.currentGroupWorkPpr = selectedRecord[0].get('GroupWorkPpr');
