            ...
            onLoadReportStore: function (store) {
                ...
                if (btn) {
                    ...
                    store.each(function (rec) {
                        ...
                        if ((rec.get('Id') === 'MotivatedProposalForLicenseReport' || rec.get('Id') === 'MotivatedProposalForRefusalLicenseReport')
                            && me.controller.params.TypeBase !== B4.enums.TypeBase.LicenseApplicants) {
                            // не показываем эти печатные формы, если основание не Проверка соискателей лицензии
                        } else {
                            btn.menu.add({
                                xtype: 'menuitem',
            ...
            */
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                B4.Ajax.request(B4.Url.action('GetInfo', 'ActCheck', {
                    ...
                    me.controller.params.TypeBase = obj.typeBase;
