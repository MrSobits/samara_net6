namespace Bars.Gkh.Overhaul.Tat.ViewModel
{
    ...
    public class SpecialAccountDecisionNoticeViewModel : BaseViewModel<SpecialAccountDecisionNotice>
    {
        public override IDataResult Get(IDomainService<SpecialAccountDecisionNotice> domainService, BaseParams baseParams)
        {
            ...
            if (value == null)
            {
                var decisionDomain = Container.Resolve<IDomainService<SpecialAccountDecision>>();
            ...
            var contragent = value.SpecialAccountDecision.RegOperator != null
                                 ? value.SpecialAccountDecision.RegOperator.Contragent
                                 : value.SpecialAccountDecision.ManagingOrganization != null
