namespace Bars.Gkh.Overhaul.Hmao.Migration.Version_2013122400
{
    ...
    [global::Bars.B4.Modules.Ecm7.Framework.MigrationDependsOn(typeof(global::Bars.Gkh.Overhaul.Tat.Migration.Version_2013121700.UpdateSchema))]
    public class UpdateSchema : global::Bars.B4.Modules.Ecm7.Framework.Migration
    {
        public override void Up()
        {
             ...
             * иначе может быть такое, что какой-то Дом удалили а Id Его уже был сохранен в таблице OVRHL_LONGTERM_PR_OBJECT
             * досихпор остались посольку не было FK дом удалился без проблем
             */
