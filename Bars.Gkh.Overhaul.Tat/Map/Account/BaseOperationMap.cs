...
/// namespace Bars.Gkh.Overhaul.Tat.Map.Account
/// {
...
namespace Bars.Gkh.Overhaul.Tat.Map
{
    ...
    /// <summary>Маппинг для "Bars.Gkh.Overhaul.Tat.Entities.BaseOperation"</summary>
    public class BaseOperationMap : BaseEntityMap<BaseOperation>
    {
        
        public BaseOperationMap() : 
                base("Bars.Gkh.Overhaul.Tat.Entities.BaseOperation", "OVRHL_ACCOUNT_OPERATION")
        {
        }
