...
namespace Bars.Gkh.Overhaul.Tat.Map
{
    ...
    /// <summary>Маппинг для "Bars.Gkh.Overhaul.Tat.Entities.SpecialAccountDecisionNotice"</summary>
    public class SpecialAccountDecisionNoticeMap : BaseEntityMap<SpecialAccountDecisionNotice>
    {
        
        public SpecialAccountDecisionNoticeMap() : 
                base("Bars.Gkh.Overhaul.Tat.Entities.SpecialAccountDecisionNotice", "OVRHL_DEC_SPEC_ACC_NOTICE")
        {
        }
