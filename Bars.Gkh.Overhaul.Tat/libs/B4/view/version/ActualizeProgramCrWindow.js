            ...
            items: [
                {
                    ...
                    html: '<span style="display: table-cell"><span class="im-info" style="vertical-align: top;"></span></span><span style="display: table-cell; padding-left: 5px;">Выберите программу кап. ремонта, на основании которой необходимо актуализирвоать долгосрочную программу кап. ремонта</span>'
                },
                {
                    xtype: 'b4selectfield',
                    name: 'ProgramCr',
