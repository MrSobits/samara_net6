Ext.define('B4.controller.report.LongProgramReport', {
    ...
    refs: [
        { ref: 'fieldMunicipality', selector: '#longprogramreportpanel #tfMunicipality' },
        { ref: 'fieldDateReport', selector: '#longprogramreportpanel #dfDateReport' },
        { ref: 'fieldYearReport', selector: '#longprogramreportpanel #cbYear' }
    ],
    ...
    aspects: [
        {
            ...
            fieldSelector: '#longprogramreportpanel #tfMunicipality',
