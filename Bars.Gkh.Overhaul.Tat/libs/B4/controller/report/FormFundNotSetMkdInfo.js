Ext.define('B4.controller.report.FormFundNotSetMkdInfo', {
    ...
    refs: [
        ...
        { ref: 'dateTimeReportField', selector: '#reportFormFundNotSetMkdInfoPanel datefield[name="DateTimeReport"]' },
                { ref: 'typeCollectRealObjField', selector: '#reportFormFundNotSetMkdInfoPanel b4combobox[name="TypeCollectRealObj"]' },
        { ref: 'programCrSelectField', selector: '#reportFormFundNotSetMkdInfoPanel #sfProgramCr' },
    ...
    getParams: function() {
        var mcpField = this.getMunicipalityTriggerField(),
            ...
            typeCollectRealObjField = this.getTypeCollectRealObjField(),
            prgCrSelectField = this.getProgramCrSelectField();
        ...
        return {
            ...
            typeCollectRealObj: (typeCollectRealObjField ? typeCollectRealObjField.getValue() : null),
            programCrId: (prgCrSelectField ? prgCrSelectField.getValue() : null),
