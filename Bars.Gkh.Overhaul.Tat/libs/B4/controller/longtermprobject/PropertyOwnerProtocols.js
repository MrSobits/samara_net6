Ext.define('B4.controller.longtermprobject.PropertyOwnerProtocols', {
    ...
    aspects: [
        ...
        },
        {
            ...
            permissions: [
                { name: 'Gkh.RealityObject.Register.OwnerProtocol.PropertyOwnerProtocols.Create', applyTo: 'b4addbutton', selector: '#propertyownerprotocolsGrid' },
                ...
                {
                    name: 'Gkh.RealityObject.Register.OwnerProtocol.PropertyOwnerProtocols.Delete', applyTo: 'b4deletecolumn', selector: '#propertyownerprotocolsGrid',
