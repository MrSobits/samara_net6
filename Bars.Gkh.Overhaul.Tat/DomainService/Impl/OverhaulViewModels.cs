namespace Bars.Gkh.Overhaul.Tat.DomainService.Impl
{
    ...
    public class OverhaulViewModels : IOverhaulViewModels
    {
        ...
        public IDataResult DefectListGet(IDomainService<DefectList> domainService, BaseParams baseParams)
        {
            ...
            var workPriceService = this.Container.Resolve<IDomainService<WorkPrice>>();
            ...
            try
            {
                    ...
                    var jobQuery =
                        seQuery.Where(
                            x =>
                                ...
                                versStage1.Stage1Version.StrElement.Id);
                ...
                return
                    new BaseDataResult(new
                    {
                        ...
                        obj.Sum,
                        versStage1?.Stage1Version.StrElement.CalculateBy,
                        DpkrVolume = versStage1?.Volume ?? 0M,
                        MargCost = versStage1 != null && workPrice != null
                            ? versStage1.Stage1Version.StrElement.CalculateBy == PriceCalculateBy.Volume
                                ? workPrice.NormativeCost
                                : workPrice.SquareMeterCost
                            : 0M,
                        DpkrCost = versStage1?.Sum ?? 0M,
                    });
            }
            finally
            {
        ...
        public IDataResult TypeWorkCrList(IDomainService<TypeWorkCr> domainService, BaseParams baseParams)
        {
            ...
            try
            {
                ...
                var dictControlDate = controlDateDomain.GetAll()
                ...
                var data = domainService.GetAll()
                    ...
                    .Select(
                        x => new
                        {
                            ...
                            WorkFinSourceName = $"{x.WorkName} ({x.FinanceSourceName})", //поле нужно для акта выполненных работ
        ...
        public IDataResult TypeWorkStage1List(BaseParams baseParams)
        {
            ...
            try
            {
                var data = typeWorkVersSt1Service.GetAll()
                    ...
                    {
                        x.Id,
                        StructuralElement = x.Stage1Version.StrElement.Name,
