namespace Bars.GkhGji.Regions.Khakasia.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Khakasia.Entities.AppealCitsExecutant"</summary>
    public class AppealCitsExecutantMap : BaseEntityMap<AppealCitsExecutant>
    {

        public AppealCitsExecutantMap() :
                base("Bars.GkhGji.Regions.Khakasia.Entities.AppealCitsExecutant", "GJI_APPCIT_EXECUTANT")
        {
        }
