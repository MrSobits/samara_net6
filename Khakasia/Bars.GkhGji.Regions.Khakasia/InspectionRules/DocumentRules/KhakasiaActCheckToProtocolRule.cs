namespace Bars.GkhGji.Regions.Khakasia.InspectionRules
{
    ...
    /// <summary>
    /// Правило создание документа 'Протокола' из документа 'Акт проверки'
    /// В Хакасии меняется работа с нарушениями потому что выбираются не нарушения а описания
    /// </summary>
    public class KhakasiaActCheckToProtocolRule : IDocumentGjiRule
    {
        ...
        public IDataResult ValidationRule(DocumentGji document)
        {
            ...
            {
                return new BaseDataResult(false, "В Хакасии для Акта проверки предписания нельзя формировать протокол");
            }
