namespace Bars.GkhGji.Regions.Khakasia.InspectionRules.DocumentRules
{
	...
	public class KhakasiaDisposalToActCheckRule : DisposalToActCheckRule
    {
        public override IDataResult ValidationRule(DocumentGji document)
        {
            return new BaseDataResult(false, "В Хакасии нет Акт проверки (общий) есть тольк оакт проверки с выбором 1го или несколько домов");
