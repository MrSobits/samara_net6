namespace Bars.GkhGji.Regions.Khakasia.InspectionRules
{
    ...
    /// <summary>
    /// в Хакасии нельзя сформироть приказ если дома не выбраны
    /// </summary>
    public class KhakasiaBaseJurPersonToDisposalRule :Bars.GkhGji.InspectionRules.BaseJurPersonToDisposalRule
    {
