        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                },
                {
                    ...
                    /*, В Хакасии нередактируется этот грид вся работа идет через грид Описания
                    editor: {
                        xtype: 'datefield',
                        format: 'd.m.Y'
                    }
                    ...
                    items: [
                        {
                            xtype: 'buttongroup',
                            items: [
                                /* В Хакасии у грида нарешний недолжно быт ькнопки Созхранить потомучто все данные сохраняются не через инайн грид а через другой грил Описания
                                {
                                    xtype: 'button',
