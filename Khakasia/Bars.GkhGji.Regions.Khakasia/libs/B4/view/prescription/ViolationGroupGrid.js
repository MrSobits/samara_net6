    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                /* В Хакасии Описания добавляются и удаляются в Акте проверки, тоетсь нельзя удалять описания которые бли создания при создании предписания из акта проверки
                ,
                {
                    ...
                    items: [
                        {
                            xtype: 'buttongroup',
                            items: [
                                /* В Хакасии нельзя добавлять описания в Предписани потомучт оони туда попадают через Акт проверки
                                {
                                    xtype: 'b4addbutton',
