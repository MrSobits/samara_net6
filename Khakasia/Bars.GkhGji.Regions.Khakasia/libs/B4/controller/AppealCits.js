        ...
        },
        {
            ...
            */
            ...
            selectedGridRowActionHandler: function (action, record) {
                ...
                var gridSelected = me.getSelectedGrid();
                me.selectedGridRowAction(gridSelected, action, record);

                me.getSelectGrid().getSelectionModel().deselect(record);

                if (gridSelected) {
                    gridSelected.down('[ref=status]').setText(gridSelected.getStore().getCount() + ' записи');
                }
            },
            onRowDeselect: function (rowModel, record) {
                ...
                var gridSelected = me.getSelectedGrid();
                me.selectedGridRowAction(gridSelected, 'delete', record);
            },
            otherActions: function (actions) {
                var me = this;
                actions[me.multiSelectWindowSelector + ' #multiSelectGrid'] = {
                    'itemclick':
                    {
                        fn: me.selectRow,
                        scope: me
            ...
            selectRow: function (rowModel, record) {
                var me = this;
                ...
                if (selectGrid) {
                    var model = selectGrid.getSelectionModel();
