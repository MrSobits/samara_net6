    ...
    aspects: [
        ...
        },
        {
            ...
            */
            ...
            //saveButtonSelector: '#prescriptionRealityObjListPanel #prescriptionViolationSaveButton', В Хакасии нельзя созхранять грид нарушений все заполняется через Описания
            otherActions: function(actions) {
                var me = this;
            ...
            /* В Хакасии грид нарушения работает тольк она отображение вся работа по вводу ДАт осущетсвляется в описаниях
            ,
            listeners: {
                beforesave: {
