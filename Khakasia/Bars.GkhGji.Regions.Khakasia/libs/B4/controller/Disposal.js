    ...
    aspects: [
        {
            ...
            */
            ...
            onValidateUserParams: function (params) {
                ...
                if (params.ruleId == 'DisposalToActCheckByRoRule' || params.ruleId == 'DisposalToActSurveyRule' || params.ruleId == 'KhakasiaDisposalToActViewRule') {
                    return false;
                }
        ...
        },
        {
            ...
            */
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                B4.Ajax.request(B4.Url.action('GetInfo', 'Disposal', {
        ...
        },
        {
            ...
            buttonSelector: '#disposalEditPanel [ruleId=KhakasiaDisposalToActViewRule]',
