            ...
            try
            {
                    ...
                    violPiontDomain.GetAll()
                                   ...
                                   .Select(
                                       ...
                                       new
                                       {
                                           ...
                                           x.ViolStage.InspectionViolation.Violation.NormativeDocNames
                                       })
                                   .AsEnumerable()
                                   ...
                                   .ToDictionary(
                                        ...
                                        y => new
                                        {
                                            ...
                                            NormDocNums = y.Select(z => z.NormativeDocNames)
                                                        .Distinct()
                                                        .Aggregate((str, result) => !string.IsNullOrEmpty(result) ? result + "," + str : str),
                ...
                var data = query
                    ...
                    .Select(x => new
                    {
                        ...
                        NormDocNums = violPoints.ContainsKey(x.Id) ? violPoints[x.Id].NormDocNums : null,
                    })
                    .AsQueryable()
