namespace Bars.GkhGji.Regions.Khakasia.Import
{
    using System;
    ...
    /// </summary>
    public class AnswersImport : IGkhImport
    {
        public virtual IWindsorContainer Container { get; set; }

        public static string Id = "DeloServiceAnswersImport";
        ...
        {
            get { return "DeloServiceAnswersImport"; }
        }

        public virtual string Name
        {
            get { return "Отправка ответа по обращению в АСЭД ДЕЛО"; }
        }
