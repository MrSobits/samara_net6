...
namespace Bars.GkhGji.Regions.Khakasia.NumberValidation
{
    using System.Linq;
    using Bars.B4;
    ...
    public class KhakasiaValidationRule : INumberValidationRule
    {
        public IWindsorContainer Container { get; set; }

        public string Id
        {
            get { return "GJI_KHAKASIA_doc_number_validation"; }
        }

        public string Name
        {
            get { return "Правило проставления номера документа ГЖИ Хакасии"; }
        }
