namespace Bars.GkhGji.Regions.Khakasia.Report
{
    ...
    public class ActCheckNotificationReport : GjiBaseStimulReport
    {
        ...
        private void FillContragentInfo(Contragent contragent)
        {
            ...
            this.ReportParams["КонтрагентЮрАдрес"] = contragent.FiasJuridicalAddress != null ? "{0}, {1}".FormatUsing(contragent.FiasJuridicalAddress.PostCode, contragent.FiasJuridicalAddress.AddressName) : string.Empty;
