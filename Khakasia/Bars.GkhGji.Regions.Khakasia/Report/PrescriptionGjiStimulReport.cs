namespace Bars.GkhGji.Regions.Khakasia.Report
{
    ...
    public class PrescriptionGjiStimulReport : GjiBaseStimulReport
    {
        ...
        public PrescriptionGjiStimulReport()
            : base(new ReportTemplateBinary(Properties.Resources.KhakasiaPrescription))
        {
        }
        ...
        public override string Id
        {
            get
            {
                return "KhakasiaPrescriptionGji";
            }
        }
            ...
            return new List<TemplateInfo>
                       {
                           new TemplateInfo
                               {
                                   Code = "KhakasiaPrescriptionGji",
                                   Name = "Prescription",
                                   Description = "Предписание",
                                   Template = Properties.Resources.KhakasiaPrescription
                               }
                       };
        }
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            try
            {
                ...
                {
                    this.ReportParams["ДомаИАдреса"] = listRealityObjs.Select(x => x.FiasAddress.AddressName).ToList().AggregateWithSeparator(", ");
