namespace Bars.GkhGji.Regions.Khakasia.Report
{
    ...
    {
        /// <summary>
        /// Определение протокола ГЖИ (Для Хакасии).
        /// </summary>
        private KhakasiaProtocolDefinition definition;
        ...
        public ProtocolGjiDefinitionStimulReport()
            : base(new ReportTemplateBinary(Properties.Resources.KhakasiaProtocol_Definition))
        {
        }
        ...
        /// </summary>
        public KhakasiaProtocolDefinition Definition
        {
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Name = "KhakasiaProtocol_Definition_1",
                    Code = "KhakasiaProtocol_Definition_1",
                    Description =
                        "об отложении рассмотрения дела об административном правонарушении",
                    Template = Properties.Resources.KhakasiaProtocol_Definition
                },
                new TemplateInfo
                {
                    Name = "KhakasiaProtocol_Definition_2",
                    Code = "KhakasiaProtocol_Definition_2",
                    Description = "о назначении рассмотрения дела об административном правонарушении",
                    Template = Properties.Resources.KhakasiaProtocol_Definition
                },
                new TemplateInfo
                {
                    Name = "KhakasiaProtocol_Definition_3",
                    Code = "KhakasiaProtocol_Definition_3",
                    Description = "о продлении срока рассмотрения дела об административном правонарушении",
                    Template = Properties.Resources.KhakasiaProtocol_Definition
                },
                new TemplateInfo
                {
                    Name = "KhakasiaProtocol_Definition_4",
                    Code = "KhakasiaProtocol_Definition_4",
                    Description = "о передаче дела на рассмотрение по подведомственности",
                    Template = Properties.Resources.KhakasiaProtocol_Definition
                },
                new TemplateInfo
                {
                    Name = "KhakasiaProtocol_Definition_5",
                    Code = "KhakasiaProtocol_Definition_5",
                    Description = "о возвращении протокола об административном правонарушении и других материалов дела должностному лицу",
                    Template = Properties.Resources.KhakasiaProtocol_Definition
                },
                new TemplateInfo
                {
                    Name = "KhakasiaProtocol_Definition_6",
                    Code = "KhakasiaProtocol_Definition_6",
        ...
        #region Injections
        public IDomainService<KhakasiaProtocolDefinition> protocolDefinitionDomain { get; set; }
        ...
        private void GetCodeTemplate()
        {
            switch (this.definition.TypeDefinition)
            {
                case TypeDefinitionProtocol.PostponeCase:
                    this.CodeTemplate = "KhakasiaProtocol_Definition_1";
                    break;
                case TypeDefinitionProtocol.TimeAndPlaceHearing:
                    this.CodeTemplate = "KhakasiaProtocol_Definition_2";
                    break;
                case TypeDefinitionProtocol.TermAdministrativeInfraction:
                    this.CodeTemplate = "KhakasiaProtocol_Definition_3";
                    break;
                case TypeDefinitionProtocol.TransferCase:
                    this.CodeTemplate = "KhakasiaProtocol_Definition_4";
                    break;
                case TypeDefinitionProtocol.ReturnProtocol:
                    this.CodeTemplate = "KhakasiaProtocol_Definition_5";
                    break;
                case TypeDefinitionProtocol.RequestDeviation:
                    this.CodeTemplate = "KhakasiaProtocol_Definition_6";
                    break;
            }
        }
    }
