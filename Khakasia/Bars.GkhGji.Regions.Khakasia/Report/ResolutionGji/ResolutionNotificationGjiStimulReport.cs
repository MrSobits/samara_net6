    ...
    public class ResolutionNotificationGjiStimulReport : GjiBaseStimulReport
    {
        ...
        public override void PrepareReport(ReportParams reportParams)
        {
            ...
            if (protocol != null)
            {
                ...
                this.ReportParams["ДатаВремяНазнач"] = protocolDefinition != null 
                ...
                this.ReportParams["Статья"] = articleLaws.AggregateWithSeparator(", ");
                    ...
                    .Contains(protocol.Executant.Code))
                {
                    if (contragent != null)
                    {
                        this.ReportParams["АдресМестаНахождения"] = contragent.JuridicalAddress;
                    }
                }

                else if (new List<string> { "6", "7", "14", "20", "2", "3" }.Contains(protocol.Executant.Code))
                {
                    this.ReportParams["АдресМестаНахождения"] = physPersonInfo != null
                ...
                if (protocol.Executant != null)
                {
                        ...
                        .Contains(protocol.Executant.Code))
                    {
                        if (contragent != null)
                        {
                            ...
                            if (headContragent != null)
                            {
                                ...
                                this.ReportParams["ФИОРукОрг"] = headContragent.FullName;
                            }

                            this.ReportParams["Кого"] = (!headPosition.IsEmpty() ? headPosition + Environment.NewLine : string.Empty)
                            ...
                            .Contains(protocol.Executant.Code))
                    {
                        ...
                        this.ReportParams["Кого"] = physPersonName.Дательный;
                        this.ReportParams["ФизЛицоРП"] = physPersonName.Родительный;
