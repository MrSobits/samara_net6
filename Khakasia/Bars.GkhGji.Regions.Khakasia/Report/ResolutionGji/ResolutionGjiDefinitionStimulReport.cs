namespace Bars.GkhGji.Regions.Khakasia.Report
{
    ...
    public class ResolutionGjiDefinitionStimulReport : GjiBaseStimulReport
    {
        ...
        public ResolutionGjiDefinitionStimulReport()
            : base(new ReportTemplateBinary(Properties.Resources.KhakasiaResolution_Definition))
        {
        }
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Name = "KhakasiaResolution_Definition_1",
                    Code = "KhakasiaResolution_Definition_1",
                    Description =
                        "о назначении времени и места рассмотрения жалобы на постановление по делу об административном правонарушении",
                    Template = Properties.Resources.KhakasiaResolution_Definition
                },
                new TemplateInfo
                {
                    Name = "KhakasiaResolution_Definition_2",
                    Code = "KhakasiaResolution_Definition_2",
                    Description =
                ...
                new TemplateInfo
                {
                    Name = "KhakasiaResolution_Definition_3",
                    Code = "KhakasiaResolution_Definition_3",
                    Description =
                ...
                new TemplateInfo
                {
                    Name = "KhakasiaResolution_Definition_4",
                    Code = "KhakasiaResolution_Definition_4",
                    Description =
        ...
        private void GetCodeTemplate()
        {
            switch (definition.TypeDefinition)
            {
                case TypeDefinitionResolution.AppointmentPlaceTime:
                    CodeTemplate = "KhakasiaResolution_Definition_1";
                    break;
                case TypeDefinitionResolution.Deferment:
                    CodeTemplate = "KhakasiaResolution_Definition_2";
                    break;
                case TypeDefinitionResolution.Installment:
                    CodeTemplate = "KhakasiaResolution_Definition_3";
                    break;
                case TypeDefinitionResolution.CorrectionError:
                    CodeTemplate = "KhakasiaResolution_Definition_4";
                    break;
            }
        }
