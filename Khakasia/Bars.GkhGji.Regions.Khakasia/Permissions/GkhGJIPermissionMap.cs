namespace Bars.GkhGji.Regions.Khakasia.Permissions
{
    using B4;
    ...
    public class GkhGjiPermissionMap: PermissionMap
    {
        public GkhGjiPermissionMap()
        {
            ...
            Namespace<AppealCitsAnswer>("GkhGji.AppealCitizensState.Answer.Field", "Поля");
            Permission("GkhGji.AppealCitizensState.Answer.Field.DocumentName_Edit", "Документ - Изменение");
            Permission("GkhGji.AppealCitizensState.Answer.Field.DocumentNumber_Edit", "Номер документа - Изменение");
            Permission("GkhGji.AppealCitizensState.Answer.Field.DocumentDate_Edit", "Дата документа - Изменение");
            Permission("GkhGji.AppealCitizensState.Answer.Field.Addressee_Edit", "Адресат - Изменение");
            Permission("GkhGji.AppealCitizensState.Answer.Field.Executor_Edit", "Исполнитель - Изменение");
            Permission("GkhGji.AppealCitizensState.Answer.Field.AnswerContent_Edit", "Содержание ответа - Изменение");
            Permission("GkhGji.AppealCitizensState.Answer.Field.File_Edit", "Файл - Изменение");
            Permission("GkhGji.AppealCitizensState.Answer.Field.Description_Edit", "Описание - Изменение");

            Permission("GkhGji.AppealCitizensState.Answer.Field.DocumentName_View", "Документ - Просмотр");
            Permission("GkhGji.AppealCitizensState.Answer.Field.DocumentNumber_View", "Номер документа - Просмотр");
            Permission("GkhGji.AppealCitizensState.Answer.Field.DocumentDate_View", "Дата документа - Просмотр");
            Permission("GkhGji.AppealCitizensState.Answer.Field.Addressee_View", "Адресат - Просмотр");
            Permission("GkhGji.AppealCitizensState.Answer.Field.Executor_View", "Исполнитель - Просмотр");
            Permission("GkhGji.AppealCitizensState.Answer.Field.AnswerContent_View", "Содержание ответа - Просмотр");
            Permission("GkhGji.AppealCitizensState.Answer.Field.File_View", "Файл - Просмотр");
            Permission("GkhGji.AppealCitizensState.Answer.Field.Description_View", "Описание - Просмотр");
