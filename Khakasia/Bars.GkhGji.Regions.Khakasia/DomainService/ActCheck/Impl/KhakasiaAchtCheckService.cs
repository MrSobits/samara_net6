namespace Bars.GkhGji.Regions.Khakasia.DomainService
{
	...
	/// </summary>
    public class KhakasiaActCheckService : ActCheckService, IKhakasiaActCheckService
    {
		/// <summary>
		...
		public IDataResult ListRealObjForActCheck(BaseParams baseParams)
        {
            ...
            var data = this.InspRealObjDomain.GetAll()
               .Where(x => x.Inspection.Id == inspectionId)
               .Where(x => !this.ActCheckRoDomain.GetAll().Any(y => y.ActCheck.Inspection.Id == inspectionId && y.RealityObject.Id == x.RealityObject.Id))
               .Select(x => new
               {
                   x.Id,
        ...
        public override IDataResult ListView(BaseParams baseParams)
        {
            ...
            */
            ...
            var serviceActCheckRobject = this.Container.ResolveDomain<ActCheckRealityObject>();
