namespace Bars.GkhGji.Regions.Khakasia.DomainService
{
	...
	public class ViolationGroupService : IViolationGroupService
    {
        ...
        {
            var violGroupDomain = this.Container.Resolve<IDomainService<DocumentViolGroup>>();
            var violGroupPointDomain = this.Container.Resolve<IDomainService<DocumentViolGroupPoint>>();
            ...
            {
                this.Container.Release(violGroupDomain);
                this.Container.Release(violGroupPointDomain);
            }
        }
    }
}