...
/// namespace Bars.GkhGji.Regions.Tula.Map.AppealCits
/// {
...
namespace Bars.GkhGji.Regions.Tula.Map.AppealCits
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Tula.Entities.AppealCits.CheckTimeChange"</summary>
    public class CheckTimeChangeMap : BaseEntityMap<CheckTimeChange>
    {
        
        public CheckTimeChangeMap() : 
                base("Bars.GkhGji.Regions.Tula.Entities.AppealCits.CheckTimeChange", "GJI_CHECK_TIME_CH")
        {
        }
