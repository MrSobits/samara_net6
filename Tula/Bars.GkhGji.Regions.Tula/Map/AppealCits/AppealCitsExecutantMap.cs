...
namespace Bars.GkhGji.Regions.Tula.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Tula.Entities.AppealCitsExecutant"</summary>
    public class AppealCitsExecutantMap : BaseEntityMap<AppealCitsExecutant>
    {
        
        public AppealCitsExecutantMap() : 
                base("Bars.GkhGji.Regions.Tula.Entities.AppealCitsExecutant", "GJI_APPCIT_EXECUTANT")
        {
        }
