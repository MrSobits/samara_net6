...
namespace Bars.GkhGji.Regions.Tula.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Tula.Entities.DocumentViolGroup"</summary>
    public class DocumentViolGroupMap : BaseEntityMap<DocumentViolGroup>
    {
        
        public DocumentViolGroupMap() : 
                base("Bars.GkhGji.Regions.Tula.Entities.DocumentViolGroup", "GJI_DOC_VIOLGROUP")
        {
        }
