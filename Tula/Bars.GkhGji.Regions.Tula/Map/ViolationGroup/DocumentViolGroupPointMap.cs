...
namespace Bars.GkhGji.Regions.Tula.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Tula.Entities.DocumentViolGroupPoint"</summary>
    public class DocumentViolGroupPointMap : BaseEntityMap<DocumentViolGroupPoint>
    {
        
        public DocumentViolGroupPointMap() : 
                base("Bars.GkhGji.Regions.Tula.Entities.DocumentViolGroupPoint", "GJI_DOC_VIOLGROUP_POINT")
        {
        }
