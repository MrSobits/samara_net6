...
namespace Bars.GkhGji.Regions.Tula.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Tula.Entities.DocumentViolGroupLongText"</summary>
    public class DocumentViolGroupLongTextMap : BaseEntityMap<DocumentViolGroupLongText>
    {
        
        public DocumentViolGroupLongTextMap() : 
                base("Bars.GkhGji.Regions.Tula.Entities.DocumentViolGroupLongText", "GJI_DOC_VIOLGROUP_LTEXT")
        {
        }
