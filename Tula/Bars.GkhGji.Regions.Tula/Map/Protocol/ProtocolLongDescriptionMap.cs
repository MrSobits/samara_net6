...
namespace Bars.GkhGji.Regions.Tula.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Tula.Entities.ProtocolLongDescription"</summary>
    public class ProtocolLongDescriptionMap : BaseEntityMap<ProtocolLongDescription>
    {
        
        public ProtocolLongDescriptionMap() : 
                base("Bars.GkhGji.Regions.Tula.Entities.ProtocolLongDescription", "GJI_PROTOCOL_LONGDESC")
        {
        }
