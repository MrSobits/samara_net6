...
/// using Bars.GkhGji.Regions.Tula.Enums;
/// 
...
namespace Bars.GkhGji.Regions.Tula.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Tula.Entities.ResolProsDefinition"</summary>
    public class ResolProsDefinitionMap : BaseEntityMap<ResolProsDefinition>
    {
        
        public ResolProsDefinitionMap() : 
                base("Bars.GkhGji.Regions.Tula.Entities.ResolProsDefinition", "GJI_RESOL_PROS_DEFINITION")
        {
        }
