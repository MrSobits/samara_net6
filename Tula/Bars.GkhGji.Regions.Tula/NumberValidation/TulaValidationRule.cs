...
namespace Bars.GkhGji.Regions.Tula.NumberValidation
{
    using System.Linq;
    using Bars.B4;
    ...
    public class TulaValidationRule : INumberValidationRule
    {
        public IWindsorContainer Container { get; set; }

        public string Id
        {
            get { return "gji_tula_doc_number_validation"; }
        }

        public string Name
        {
            get { return "Правило проставления номера документа ГЖИ Тулы"; }
        }
