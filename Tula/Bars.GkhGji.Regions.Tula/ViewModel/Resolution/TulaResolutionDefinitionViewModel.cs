namespace Bars.GkhGji.Regions.Tula.ViewModel
{
    ...
    public class TulaResolutionDefinitionViewModel : Bars.GkhGji.DomainService.ResolutionDefinitionViewModel<TulaResolutionDefinition>
    {
        public override IDataResult List(IDomainService<TulaResolutionDefinition> domainService, BaseParams baseParams)
        {
        ...
        public override IDataResult Get(IDomainService<TulaResolutionDefinition> domainService, BaseParams baseParams)
        {
