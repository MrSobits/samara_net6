namespace Bars.GkhGji.Regions.Tula.Migrations.Version_2014071800
{
    using System.Data;
    ...
    [global::Bars.B4.Modules.Ecm7.Framework.MigrationDependsOn(typeof(global::Bars.GkhGji.Regions.Tula.Migrations.Version_2014071700.UpdateSchema))]
    public class UpdateSchema : global::Bars.B4.Modules.Ecm7.Framework.Migration
    {
        public override void Up()
        {
            ...
            Database.AddForeignKey("FK_TULA_GJI_ACTSURVEY", "TULA_GJI_ACTSURVEY", "ID", "GJI_ACTSURVEY", "ID");

            Database.ExecuteNonQuery(@"insert into TULA_GJI_ACTSURVEY (id)
        ...
        {
            Database.RemoveTable("TULA_GJI_ACTSURVEY");
