Ext.define('B4.controller.ActCheck', {
    ...
    aspects: [
        ...
        {   /* 
            ...
            columnsGridSelect: [
                { header: 'Пункты нормативных документов', xtype: 'gridcolumn', dataIndex: 'NormDocNums', flex: 1, filter: { xtype: 'textfield' } },
            ...
            columnsGridSelected: [
                { header: 'Пункты', xtype: 'gridcolumn', dataIndex: 'NormDocNums', flex: 1, sortable: false },
        ...
        },
        {
            ...
            columnsGridSelect: [
                { header: 'Пункт нормативного документа', flex: 1, xtype: 'gridcolumn', dataIndex: 'NormDocNum', filter: { xtype: 'textfield' }, sortable: false },
                {
                    header: 'Наименование',
                    xtype: 'gridcolumn',
                    dataIndex: 'Name',
            ...
            columnsGridSelected: [
                { header: 'Пункт нормативного документа', xtype: 'gridcolumn', flex: 1, dataIndex: 'NormDocNum', sortable: false }
            ],
        ...
        },
        {
            ...
            */
            ...
            textProperty: 'NormDocNum',
            columnsGridSelect: [
                { header: 'Пункт нормативного нарушения', xtype: 'gridcolumn', dataIndex: 'NormDocNum', flex: 1, filter: { xtype: 'textfield' } },
