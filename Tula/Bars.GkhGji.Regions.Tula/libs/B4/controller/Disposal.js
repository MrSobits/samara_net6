    ...
    aspects: [
        {
            ...
            */
            ...
            onValidateUserParams: function (params) {
                ...
                if (params.ruleId == 'DisposalToActCheckByRoRule' || params.ruleId == 'DisposalToActSurveyRule' || params.ruleId == 'TulaDisposalToActViewRule') {
                    return false;
                }
        ...
        },
        {
            ...
            buttonSelector: '#disposalEditPanel [ruleId=TulaDisposalToActViewRule]',
