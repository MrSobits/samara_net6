namespace Bars.GkhGji.Regions.Tula.InspectionRules
{
    ...
    /// Данное правило для Тулы иземнено потомучто при создании предписания из акта пользователь выбирает не нарушения, а Описания (то есть группы нарушений)
    /// </summary>
    public class TulaActCheckToPrescriptionRule : IDocumentGjiRule
    {
