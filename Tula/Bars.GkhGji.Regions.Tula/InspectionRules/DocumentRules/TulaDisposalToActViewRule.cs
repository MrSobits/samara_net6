...
namespace Bars.GkhGji.Regions.Tula.InspectionRules.DocumentRules
{
    /// <summary>
    /// Правило создание документа 'Акт осмотра' из документа 'Распоряжение' 
    /// </summary>
    public class TulaDisposalToActViewRule : IDocumentGjiRule
    {
        #region injection
        ...
        {
            get { return "TulaDisposalToActViewRule"; }
        }
