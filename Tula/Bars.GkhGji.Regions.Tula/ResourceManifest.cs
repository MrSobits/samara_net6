...
{    
    ...
    public partial class ResourceManifest : ResourceManifestBase
    {
        ...
        {  
            ...
            AddResource(container, "libs/B4/aspects/permission/TulaActSurvey.js");
        ...
        private void AddResource(IResourceManifestContainer container, string path)
		{
            ...
            container.Add(path, string.Format("Bars.GkhGji.Regions.Tula.dll/Bars.GkhGji.Regions.Tula.{0}", path.Replace("/", ".")));
        }
    }
}
