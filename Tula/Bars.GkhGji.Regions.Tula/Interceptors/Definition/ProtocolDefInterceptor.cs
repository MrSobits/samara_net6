...
namespace Bars.GkhGji.Regions.Tula.Interceptors
{
    ...
    public class ProtocolDefInterceptor : ProtocolDefinitionInterceptor<TulaProtocolDefinition>
    {
        public IDefinitionService DefinitionService { get; set; }

        public override IDataResult BeforeUpdateAction(IDomainService<TulaProtocolDefinition> service, TulaProtocolDefinition entity)
        {
        ...
        public override IDataResult BeforeCreateAction(IDomainService<TulaProtocolDefinition> service, TulaProtocolDefinition entity)
        {
            return CreateNumber(entity);
        }

        private IDataResult CreateNumber(TulaProtocolDefinition entity)
        {
