namespace Bars.GkhGji.Regions.Tula.Interceptors
{
    ...
    public class TulaActSurveyInterceptor: ActSurveyServiceInterceptor<TulaActSurvey>
    {
        ...
        public override IDataResult BeforeCreateAction(IDomainService<TulaActSurvey> service, TulaActSurvey entity)
        {
            entity.ConclusionIssued = YesNo.No;
            return base.BeforeCreateAction(service, entity);
        }

        public override IDataResult BeforeDeleteAction(IDomainService<TulaActSurvey> service, TulaActSurvey entity)
        {
