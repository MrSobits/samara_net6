namespace Bars.GkhGji.Regions.Habarovsk.Controllers
{
   ...
   // using iTextSharp.text.pdf.security;
    ...
    public class AppealCitsAdmonitionSignController : BaseController
    {
     ...
     //   protected Image blazon = Image.GetInstance(Properties.Resources.blazon_Voronezh);

        public AppealCitsAdmonitionSignController(IFileManager fileManager, IDomainService<FileInfo> fileDomain)
        {
