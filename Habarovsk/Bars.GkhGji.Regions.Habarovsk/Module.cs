namespace Bars.GkhGji.Regions.Habarovsk
{
    ...
    using Bars.GkhGji.Regions.Habarovsk.DomainService.Impl;
    using Bars.GkhGji.Regions.Habarovsk.ExecutionAction;
    using Bars.GkhGji.Regions.Habarovsk.InspectionRules.DocumentRules;
    using Bars.GkhGji.Regions.Habarovsk.NumberRule;
    using Bars.GkhGji.Regions.Habarovsk.Report;
    ...
    using ViewModel;
    using Imports;
    using Bars.GkhGji.Regions.Habarovsk.Permissions;
    ...
    using Bars.GkhGji.Regions.Habarovsk.Interceptors;
    using Bars.B4.Modules.FileStorage;
    using Bars.B4.Modules.FileStorage.DomainService;
    using Bars.B4.Modules.DataExport.Domain;
    using Bars.GkhGji.Regions.Habarovsk.Controllers.FileTransport;
    using Bars.GkhGji.Regions.Habarovsk.DataExport;
    using Bars.GkhGji.Regions.Habarovsk.StateChanges;
    using Bars.GkhGji.Entities;
    using Bars.GkhGji.Regions.Habarovsk.Controllers.ActRemoval;
    using Bars.GkhGji.Regions.Habarovsk.Controllers.Protocol197;
    using Bars.GkhGji.Regions.Habarovsk.Services.ServiceContracts;
    using Bars.GkhGji.Regions.Habarovsk.Services.Impl;
    using Bars.GkhGji.Regions.Habarovsk.InspectionRules;
    using Bars.GkhGji.Regions.Habarovsk.Navigation;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.EGRULSendInformationRequest;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.EGRNSendInformationRequest;
    using Bars.GkhGji.Regions.BaseChelyabinsk.Entities;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.MVDSendInformationRequest;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.EGRIPSendInformationRequest;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.SendSMEVPropertyType;
    using Bars.GkhGji.Regions.Habarovsk.Entities.SMEVPremises;
    using Bars.GkhGji.Regions.Habarovsk.Entities.SMEVEmergencyHouse;
    using Bars.GkhGji.Regions.Habarovsk.Import;
    ...
    using Bars.GkhGji.Regions.Habarovsk.DomainService.SMEVHelpers;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.SendSMEVValidPassport;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.SendSMEVLivingPlace;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.SendSMEVStayingPlace;
    using Bars.GkhGji.Regions.BaseChelyabinsk.Entities.Protocol197;
    using Bars.GkhGji.Regions.Habarovsk.StateChange;
    using Bars.GkhGji.Regions.Habarovsk.Tasks.ERULSendInformationRequest;
    using Bars.GkhGji.Regions.Habarovsk.Controllers.SMEV;
    ...
    public class Module : AssemblyDefinedModule
    {
        ...
        public override void Install()
        {
            ...
            Container.RegisterTransient<IStatefulEntitiesManifest, StatefulEntityManifest>("GkhGji.Regions.Habarovsk statefulentity");
            this.Container.Register(Component.For<INavigationProvider>().Named("GkhGJI.Regions.Habarovsk navigation").ImplementedBy<NavigationProvider>()
                   .LifeStyle.Transient);
            Container.RegisterTransient<IPermissionSource, GkhGjiHabarovskPermissionMap>();
            ...
            this.Container.RegisterTransient<IFieldRequirementSource, GjiHabarovskFieldRequirementMap>();
   ...
   //         Container.RegisterTransient<ISMEVEDOService, SMEVEDOService>();
            ...
            this.Container.ReplaceComponent<ISmevPrintPdfHelper>(
                ...
                Component.For<ISmevPrintPdfHelper>().ImplementedBy<SmevPdfHelperHabarovsk>().LifeStyle.Transient);
    ...
    //        Container.RegisterController<SMEVEDOExecuteController>();
            ...
            //fileTransport
            // TODO: Разобраться с контроллером
        ...
        private void RegisterServices()
        {
            ...
            this.Container.ReplaceTransient<ITaskCalendarService, Bars.GkhGji.Regions.BaseChelyabinsk.DomainService.TaskCalendarService,
                 Bars.GkhGji.Regions.Habarovsk.DomainService.TaskCalendarService>();
          ...
          //   .AsWcfSecurityService()
            ...
            Component.For<IAppealCitFromEDMService>()
             .ImplementedBy<AppealCitFromEDMService>()
           //  .AsWcfRestService()
             .RegisterIn(this.Container);
            ...
            this.Container.ReplaceTransient<IExtReminderService, ChelyabinskReminderService, HabarovskReminderService>();
            this.Container.ReplaceTransient<IExportSuggestionService, ExportSuggestionService, HabarovskExportSuggestionService>();
        ...
        private void RegisterRules()
        {
            ...
            this.Container.RegisterTransient<IRuleChangeStatus, ActCheckNumberValidationHabarovskRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, DisposalNumberValidationHabarovskRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, DecisionNumberValidationHabarovskRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, PrescriptionNumberValidationHabarovskRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, ProtocolNumberValidationHabarovskRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, PresentationNumberValidationHabarovskRule>();
            this.Container.RegisterTransient<IRuleChangeStatus, ResolutionNumberValidationHabarovskRule>();
        ...
        {
            this.Container.ReplaceTransient<IGkhBaseReport, Chelyabinsk.ChelyabinskDisposalStimulReport, HabarovskDisposalStimulReport>();
        ...
        private void RegisterInspectionRules()
        {
            this.Container.ReplaceComponent<IDocumentGjiRule>(
                ...
                Component.For<IDocumentGjiRule>().ImplementedBy<HabarovskPrescriptionToDisposalRule>().LifeStyle.Transient);
        ...
        {
            this.Container.RegisterTransient<IViewCollection, GkhGjiHabarovskViewCollection>("GkhGjiHabarovskViewCollection");
        }
        ...
        private void ReplaceComponents()
        {
            ...
            Container.ReplaceComponent<IGisGkhRegionalService>(
               ...
               Component.For<IGisGkhRegionalService>().ImplementedBy<Bars.GkhGji.Regions.Habarovsk.DomainService.GisGkhRegional.Impl.GisGkhRegionalService>().LifeStyle.Transient);
            ...
            Container.ReplaceTransient<IViewModel<EntityChangeLogRecord>, EntityChangeLogRecordViewModel, HabarovskEntityChangeLogRecordViewModel>();
        }
    }
}
