Ext.define('B4.view.smevlivingplace.Grid', {
    extend: 'B4.ux.grid.Panel',
    
    alias: 'widget.smevlivingplacegrid',
    ...
    title: 'Проверка действительности регистрации по месту жительства',
    store: 'smev2.SMEVLivingPlace',
