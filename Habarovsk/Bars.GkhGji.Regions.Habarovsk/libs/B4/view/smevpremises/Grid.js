Ext.define('B4.view.smevpremises.Grid', {
    extend: 'B4.ux.grid.Panel',
    
    alias: 'widget.smevpremisesgrid',
    ...
    store: 'smevpremises.SMEVPremises',
    closable: true,
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                },
                {
                    ...
                    dataIndex: 'ActDate',
                    flex: 1,
                    text: 'Дата принятия акта'
                },
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'ActName',
                    flex: 1,
                    text: 'Наименование акта'
                },
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'ActDepartment',
                    flex: 1,
                    text: 'Орган выдавший акт'
                },
                {
                   xtype: 'gridcolumn',
