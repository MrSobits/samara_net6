Ext.define('B4.view.smevstayingplace.Grid', {
    extend: 'B4.ux.grid.Panel',
    
    alias: 'widget.smevstayingplacegrid',
    ...
    title: 'Проверка действительности регистрации по месту пребывания',
    store: 'smev2.SMEVStayingPlace',
