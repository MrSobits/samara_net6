namespace Bars.GkhGji.Regions.Habarovsk.StateChange
{
    ...
    public class ComplaintsInWorkAcceptRule : IRuleChangeStatus
    {
        /// <summary>
        ...
        public string Id
        {
            get { return "ComplaintsInWorkAcceptRule"; }
        }

        public string Name { get { return "Прием в рассмотрение"; } }
        public string TypeId { get { return "gji_smev_complaints"; } }
        public string Description
        {
            get
            {
                return "При переводе статуса будет отправлен запрос о приеме в работу заявки на досудебное обжалование";
            }
        }
