...
namespace Bars.GkhGji.Regions.Habarovsk.Tasks
{
    ...
    /// </summary>
    public class FileRegisterTaskProvider : ITaskProvider
    {
        #region Fields
        ...
        public string TaskCode => "FileRegisterTaskProvider";

        #endregion

        #region Constructors

        public FileRegisterTaskProvider(IWindsorContainer container)
        {
