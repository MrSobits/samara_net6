namespace Bars.GkhGji.Regions.Habarovsk
{
    ...
    public partial class ResourceManifest
    {
        ...
        {
            container.Add("WS/MobileApplicationService.svc", "Bars.GkhGji.Regions.Habarovsk.dll/Bars.GkhGji.Regions.Habarovsk.Services.MobileApplicationService.svc");
            container.Add("WS/AppealCitService.svc", "Bars.GkhGji.Regions.Habarovsk.dll/Bars.GkhGji.Regions.Habarovsk.Services.AppealCitService.svc");
            container.Add("WS/AppealCitFromEDMService.svc", "Bars.GkhGji.Regions.Habarovsk.dll/Bars.GkhGji.Regions.Habarovsk.Services.AppealCitFromEDMService.svc");
