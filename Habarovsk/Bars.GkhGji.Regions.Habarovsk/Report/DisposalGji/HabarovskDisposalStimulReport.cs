namespace Bars.GkhGji.Regions.Habarovsk.Report
{
    ...
    /// Отчет для приказа
    /// </summary>
    public class HabarovskDisposalStimulReport : GjiBaseStimulReport
    {
        #region .ctor
        ...
        /// Конструктор
        /// </summary>
        public HabarovskDisposalStimulReport() : base(new ReportTemplateBinary(Properties.Resources.ChelyabinskDisposal))
        {
        }
