...
{    
    ...
    public partial class ResourceManifest : ResourceManifestBase
    {
        ...
        {  
            ...
            AddResource(container, "libs/B4/aspects/permission/SahaActSurvey.js");
        ...
        private void AddResource(IResourceManifestContainer container, string path)
		{
            ...
            container.Add(path, string.Format("Bars.GkhGji.Regions.Saha.dll/Bars.GkhGji.Regions.Saha.{0}", path.Replace("/", ".")));
        }
    }
}
