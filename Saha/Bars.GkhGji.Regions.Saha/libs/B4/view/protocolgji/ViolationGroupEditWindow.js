Ext.define('B4.view.protocolgji.ViolationGroupEditWindow', {
    extend: 'B4.form.Window',

    alias: 'widget.protocolgjiViolationGroupEditWindow',
    ...
    bodyPadding: 5,
    modal: true,
    itemId: 'protocolgjiViolationGroupEditWindow',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    xtype: 'b4savebutton',
                                    itemId: 'protocolgjiViolGroupEditWindowSaveButton'
                                }
                            ]
                        },
                        {
