namespace Bars.GkhGji.Regions.Saha.Report
{
    ...
    public class ResolutionGjiDefinitionStimulReport : GjiBaseStimulReport
    {
        ...
        public ResolutionGjiDefinitionStimulReport()
            : base(new ReportTemplateBinary(Properties.Resources.SahaResolution_Definition))
        {
        }
        ...
        public override List<TemplateInfo> GetTemplateInfo()
        {
            return new List<TemplateInfo>
            {
                new TemplateInfo
                {
                    Name = "SahaResolution_Definition_1",
                    Code = "SahaResolution_Definition_1",
                    Description =
                        "о назначении времени и места рассмотрения жалобы на постановление по делу об административном правонарушении",
                    Template = Properties.Resources.SahaResolution_Definition
                },
                new TemplateInfo
                {
                    Name = "SahaResolution_Definition_2",
                    Code = "SahaResolution_Definition_2",
                    Description =
                ...
                new TemplateInfo
                {
                    Name = "SahaResolution_Definition_3",
                    Code = "SahaResolution_Definition_3",
                    Description =
                ...
                new TemplateInfo
                {
                    Name = "SahaResolution_Definition_4",
                    Code = "SahaResolution_Definition_4",
                    Description =
        ...
        private void GetCodeTemplate()
        {
            switch (definition.TypeDefinition)
            {
                case TypeDefinitionResolution.AppointmentPlaceTime:
                    CodeTemplate = "SahaResolution_Definition_1";
                    break;
                case TypeDefinitionResolution.Deferment:
                    CodeTemplate = "SahaResolution_Definition_2";
                    break;
                case TypeDefinitionResolution.Installment:
                    CodeTemplate = "SahaResolution_Definition_3";
                    break;
                case TypeDefinitionResolution.CorrectionError:
                    CodeTemplate = "SahaResolution_Definition_4";
                    break;
            }
        }
