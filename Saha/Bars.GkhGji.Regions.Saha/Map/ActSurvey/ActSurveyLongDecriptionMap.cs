...
namespace Bars.GkhGji.Regions.Saha.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Saha.Entities.ActSurveyLongDescription"</summary>
    public class ActSurveyLongDescriptionMap : BaseEntityMap<ActSurveyLongDescription>
    {
        
        public ActSurveyLongDescriptionMap() : 
                base("Bars.GkhGji.Regions.Saha.Entities.ActSurveyLongDescription", "GJI_ACTSURVEY_LONGDESC")
        {
        }
