...
namespace Bars.GkhGji.Regions.Saha.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Saha.Entities.ActSurveyConclusion"</summary>
    public class ActSurveyConclusionMap : BaseEntityMap<ActSurveyConclusion>
    {
        
        public ActSurveyConclusionMap() : 
                base("Bars.GkhGji.Regions.Saha.Entities.ActSurveyConclusion", "GJI_ACTSURVEY_CONCLUSION")
        {
        }
