...
namespace Bars.GkhGji.Regions.Saha.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Saha.Entities.ActCheckRoLongDescription"</summary>
    public class ActCheckRoLongDescriptionMap : BaseEntityMap<ActCheckRoLongDescription>
    {
        
        public ActCheckRoLongDescriptionMap() : 
                base("Bars.GkhGji.Regions.Saha.Entities.ActCheckRoLongDescription", "GJI_ACTCHECKRO_LTEXT")
        {
        }
