namespace Bars.GkhGji.Regions.Saha.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Saha.Entities.AppealCitsExecutant"</summary>
    public class AppealCitsExecutantMap : BaseEntityMap<AppealCitsExecutant>
    {
        
        public AppealCitsExecutantMap() : 
                base("Bars.GkhGji.Regions.Saha.Entities.AppealCitsExecutant", "GJI_APPCIT_EXECUTANT")
        {
        }
