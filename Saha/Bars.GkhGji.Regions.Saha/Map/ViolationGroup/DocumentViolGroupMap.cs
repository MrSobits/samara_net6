...
namespace Bars.GkhGji.Regions.Saha.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Saha.Entities.DocumentViolGroup"</summary>
    public class DocumentViolGroupMap : BaseEntityMap<DocumentViolGroup>
    {
        
        public DocumentViolGroupMap() : 
                base("Bars.GkhGji.Regions.Saha.Entities.DocumentViolGroup", "GJI_DOC_VIOLGROUP")
        {
        }
