...
namespace Bars.GkhGji.Regions.Saha.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Saha.Entities.DocumentViolGroupLongText"</summary>
    public class DocumentViolGroupLongTextMap : BaseEntityMap<DocumentViolGroupLongText>
    {
        
        public DocumentViolGroupLongTextMap() : 
                base("Bars.GkhGji.Regions.Saha.Entities.DocumentViolGroupLongText", "GJI_DOC_VIOLGROUP_LTEXT")
        {
        }
