namespace Bars.GkhGji.Regions.Saha.ViewModel
{
    ...
    public class SahaProtocolDefinitionViewModel : GkhGji.ViewModel.ProtocolDefinitionViewModel<SahaProtocolDefinition>
    {
        public override IDataResult List(IDomainService<SahaProtocolDefinition> domainService, BaseParams baseParams)
        {
        ...
        public override IDataResult Get(IDomainService<SahaProtocolDefinition> domainService, BaseParams baseParams)
        {
