namespace Bars.GkhGji.Regions.Saha.ViewModel
{
    ...
    public class SahaResolutionDefinitionViewModel : Bars.GkhGji.DomainService.ResolutionDefinitionViewModel<SahaResolutionDefinition>
    {
        public override IDataResult List(IDomainService<SahaResolutionDefinition> domainService, BaseParams baseParams)
        {
        ...
        public override IDataResult Get(IDomainService<SahaResolutionDefinition> domainService, BaseParams baseParams)
        {
