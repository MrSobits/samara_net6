namespace Bars.GkhGji.Regions.Saha.Migrations.Version_2014071800
{
    using System.Data;
    ...
    [global::Bars.B4.Modules.Ecm7.Framework.MigrationDependsOn(typeof(global::Bars.GkhGji.Regions.Saha.Migrations.Version_2014071700.UpdateSchema))]
    public class UpdateSchema : global::Bars.B4.Modules.Ecm7.Framework.Migration
    {
        public override void Up()
        {
            ...
            Database.AddForeignKey("FK_SAHA_GJI_ACTSURVEY", "SAHA_GJI_ACTSURVEY", "ID", "GJI_ACTSURVEY", "ID");

            Database.ExecuteNonQuery(@"insert into SAHA_GJI_ACTSURVEY (id)
        ...
        {
            Database.RemoveTable("SAHA_GJI_ACTSURVEY");
