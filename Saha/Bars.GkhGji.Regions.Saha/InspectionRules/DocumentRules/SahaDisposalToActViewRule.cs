...
namespace Bars.GkhGji.Regions.Saha.InspectionRules.DocumentRules
{
    /// <summary>
    /// Правило создание документа 'Акт осмотра' из документа 'Распоряжение' 
    /// </summary>
    public class SahaDisposalToActViewRule : IDocumentGjiRule
    {
        #region injection
        ...
        {
            get { return "SahaDisposalToActViewRule"; }
        }
