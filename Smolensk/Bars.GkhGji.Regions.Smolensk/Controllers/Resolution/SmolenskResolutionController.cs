namespace Bars.GkhGji.Regions.Smolensk.Controllers
{
    ...
    public class SmolenskResolutionController : ResolutionController
    {
        public IBlobPropertyService<Resolution, ResolutionLongDescription> DescriptionService { get; set; }
