namespace Bars.GkhGji.Regions.Smolensk.InspectionRules
{
    ...
    /// Данное правило для САХи иземнено потомучто при создании предписания из акта пользователь выбирает не нарушения, а Описания (то есть группы нарушений)
    /// </summary>
    public class SmolenskActCheckToPrescriptionRule : IDocumentGjiRule
    {
