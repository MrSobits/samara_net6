Ext.define('B4.view.disposal.EditPanel', {
    ...
    requires: [
        ...
        'B4.view.disposal.DisposalControlMeasures',
    ...
    initComponent: function() {
        ...
        me.title = B4.view.DisposalTextValues.getSubjectiveCase();
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                                    ...
                                    items: [
                                        {
                                            ...
                                            textProperty: 'Fio',
                                            name: 'IssuedDisposal',
                                            fieldLabel: 'ДЛ, вынесшее ' + B4.view.DisposalTextValues.getSubjectiveCase(),
                                            columns: [
                        ...
                        {
                            xtype: 'disposalsurveysubjectgrid',
                            flex: 1
                        },
                        {
