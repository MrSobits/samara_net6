Ext.define('B4.aspects.permission.Disposal', {
    ...
    permissions: [
        ...
        */
        ...
        { name: 'GkhGji.DocumentsGji.Disposal.Field.VerifPurpose_Edit', applyTo: '[name=VerificationPurpose]', selector: '#disposalEditPanel' },
        { name: 'GkhGji.DocumentsGji.Disposal.Field.VerifPurpose_View', applyTo: '[name=VerificationPurpose]', selector: '#disposalEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) component.show();
                    else component.hide();
        ...
        { name: 'GkhGji.DocumentsGji.Disposal.Register.ControlMeasures.Edit', applyTo: 'b4savebutton', selector: '#controlMeasuresEditWindow' },
        {
