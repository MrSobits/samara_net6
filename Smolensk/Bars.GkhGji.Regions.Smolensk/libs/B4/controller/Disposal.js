Ext.define('B4.controller.Disposal', {
    ...
    views: [
        ...
        'disposal.DisposalSurveySubjectGrid',
            ...
            */
            ...
            onAfterSetPanelData: function(asp, rec, panel) {
                ...
                if (rec.get('DocumentNumber'))
                    panel.setTitle(B4.view.DisposalTextValues.getSubjectiveCase() + " " + rec.get('DocumentNumber'));
                else
                    panel.setTitle(B4.view.DisposalTextValues.getSubjectiveCase());
