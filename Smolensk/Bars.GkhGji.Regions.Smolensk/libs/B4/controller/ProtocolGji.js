Ext.define('B4.controller.ProtocolGji', {
    ...
    aspects: [
        ...
        {   /*
            ...
            */
            ...
            onAfterSetPanelData: function (asp, rec, panel) {
                ...
                asp.fireEvent('aftersetformdata', asp, rec);
            },
            ...
            setTypeExecutantPermission: function (typeExec) {
                ...
                if (typeExec) {
                    ...
                    B4.Ajax.request({
                        ...
                        var perm, applyPermissions;

                        me.controller.unmask();

                        perm = Ext.decode(response.responseText)[0];
                        applyPermissions = function (permission, forceDisable) {
                            panel.down('#taPhysPersonInfo').setDisabled(!permission[1] || forceDisable);
        ...
        },
        {
            ...
            fieldSelector: '[name="ViolationDescription"]',
            ...
            previewField: 'ViolationDescription'
        },
        {
            xtype: 'gkhblobtextaspect',
            fieldSelector: '[name="ExplanationsComments"]',
            editPanelAspectName: 'protocolEditPanelAspect',
            controllerName: 'Protocol',
            valueFieldName: 'ExplanationsComments',
            previewLength: 200,
            autoSavePreview: true,
            previewField: 'ExplanationsComments'
        },
        {
            /*
