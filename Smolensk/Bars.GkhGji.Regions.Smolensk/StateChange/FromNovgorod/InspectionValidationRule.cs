...
namespace Bars.GkhGji.Regions.Smolensk.StateChange
{
    public class InspectionValidationRule : IRuleChangeStatus
    {
        ...
        public string Name
        {
            get { return "Перенесено из ННовгорода - Проверка заполненности инспекционных проверок"; }
        }
        ...
        {
            get { return "Перенесено из ННовгорода - Данное правило проверяет заполненность необходимых полей инспекционных проверок"; }
        }
