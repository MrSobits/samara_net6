namespace Bars.GkhGji.Regions.Smolensk.StateChange
{
    ...
    public class AppealNumberValidationRule : IRuleChangeStatus
    {
        ...
        public string Name
        {
            get { return "Перенесено из ННовгорода - Проверка формирования номера обращения НН"; }
        }
        ...
        {
            get { return "Перенесено из ННовгорода - Данное правило проверяет возможность перевода статуса обращения граждан"; }
        }
