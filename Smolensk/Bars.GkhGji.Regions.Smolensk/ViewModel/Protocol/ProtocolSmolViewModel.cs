namespace Bars.GkhGji.Regions.Smolensk.ViewModel
{
    ...
    public class ProtocolSmolViewModel : ProtocolViewModel<ProtocolSmol>
    {
        // Если ндао изменить List или get то писать тут

        public IDomainService<DocumentGJIPhysPersonInfo> DocumentGjiPhysPersonInfoDomain { get; set; }

        public override IDataResult Get(IDomainService<ProtocolSmol> domainService, BaseParams baseParams)
        {
            ...
            obj.ResolutionId = this.Container.Resolve<IDomainService<Bars.GkhGji.Entities.Resolution>>().GetAll()
            ...
            return new BaseDataResult(new
            {
                ...
                obj.NoticeDocNumber,
                obj.NoticeDocDate,
                obj.ViolationDescription,
                obj.ExplanationsComments
            });
        }
    }
