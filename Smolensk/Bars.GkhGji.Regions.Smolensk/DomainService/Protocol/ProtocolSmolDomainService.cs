namespace Bars.GkhGji.Regions.Smolensk.DomainService
{
    ...
    public class ProtocolSmolenskDomainService : BaseDomainService<ProtocolSmol>
    {
        ...
        {
            var values = new List<ProtocolSmol>();
            InTransaction(() =>
            {
        ...
        private void UpdatePhysPersonRequisites(SaveRecord<ProtocolSmol> protocol)
        {
