namespace Bars.GkhGji.Regions.Smolensk.DomainService.Reminder.Impl
{
    using System;
    using System.Linq;
                            ...
                            new
                                {
                                    ...
                                    Num = x.TypeReminder == TypeReminder.Statement ?
                                    !string.IsNullOrEmpty(x.NumGji) ? x.NumGji : x.DocNum 
                                                : x.Num,
