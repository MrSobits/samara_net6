...
namespace Bars.GkhGji.Regions.Smolensk.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Smolensk.Entities.DocumentViolGroupPoint"</summary>
    public class DocumentViolGroupPointMap : BaseEntityMap<DocumentViolGroupPoint>
    {
        
        public DocumentViolGroupPointMap() : 
                base("Bars.GkhGji.Regions.Smolensk.Entities.DocumentViolGroupPoint", "GJI_DOC_VIOLGROUP_POINT")
        {
        }
