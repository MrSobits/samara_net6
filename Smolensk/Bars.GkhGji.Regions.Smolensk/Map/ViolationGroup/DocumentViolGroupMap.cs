...
namespace Bars.GkhGji.Regions.Smolensk.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Smolensk.Entities.DocumentViolGroup"</summary>
    public class DocumentViolGroupMap : BaseEntityMap<DocumentViolGroup>
    {
        
        public DocumentViolGroupMap() : 
                base("Bars.GkhGji.Regions.Smolensk.Entities.DocumentViolGroup", "GJI_DOC_VIOLGROUP")
        {
        }
