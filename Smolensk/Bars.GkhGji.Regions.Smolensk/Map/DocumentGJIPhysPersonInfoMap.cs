...
namespace Bars.GkhGji.Regions.Smolensk.Map
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Smolensk.Entities.DocumentGJIPhysPersonInfo"</summary>
    public class DocumentGJIPhysPersonInfoMap : BaseEntityMap<DocumentGJIPhysPersonInfo>
    {
        
        public DocumentGJIPhysPersonInfoMap() : 
                base("Bars.GkhGji.Regions.Smolensk.Entities.DocumentGJIPhysPersonInfo", "GJI_NNOV_DOCGJI_PERSINFO")
        {
        }
