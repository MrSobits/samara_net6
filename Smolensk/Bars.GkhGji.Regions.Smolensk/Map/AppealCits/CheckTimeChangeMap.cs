...
/// namespace Bars.GkhGji.Regions.Smolensk.Map.AppealCits
/// {
...
namespace Bars.GkhGji.Regions.Smolensk.Map.AppealCits
{
    ...
    /// <summary>Маппинг для "Bars.GkhGji.Regions.Smolensk.Entities.AppealCits.CheckTimeChange"</summary>
    public class CheckTimeChangeMap : BaseEntityMap<CheckTimeChange>
    {
        
        public CheckTimeChangeMap() : 
                base("Bars.GkhGji.Regions.Smolensk.Entities.AppealCits.CheckTimeChange", "GJI_CHECK_TIME_CH")
        {
        }
