                                    ...
                                    items: [
                                        {
                                            xtype: 'numberfield',
                                            name: 'CbDebtSum',
                                            fieldLabel: 'Сумма долга по базовому тарифу (руб.)',
                                            hideTrigger: true,
                                            allowDecimals: true
                                        },
                                        {
                                    ...
                                    items: [
                                        {
                                            ...
                                            fieldLabel: 'Сумма долга по тарифу решения (руб.)',
                                            hideTrigger: true,
                                            allowDecimals: true
                                        },
                                        {
                                            xtype: 'numberfield',
                                            name: 'CbDuty',
                                            fieldLabel: 'Сумма гос. пошлины (руб.)',
                                            hideTrigger: true,
                                            allowDecimals: true
                                        }
                                    ]
...

                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            xtype: 'numberfield',
                                            name: 'CbSumRepayment',
                                            fieldLabel: 'Сумма для погашения (руб.)',
                                            hideTrigger: true,
                                            allowDecimals: true
                                        }
                                    ]
                                    ...
                                    items: [
                                        {
                                            xtype: 'numberfield',
                                            name: 'CbSumStep',
                                            fieldLabel: 'Сумма погашения в рамках производства (руб.)',
                                            hideTrigger: true,
                                            allowDecimals: true,
                                            flex:2
                                        },
