//Todo Внмание!!!! Для ставраполи было необходимо при проверки РАспоряжения не учитывать АКты у которых РЕзультатыПроверки =Да и при этом есть Галочаа = Передан в Прокуратур
// все остальное как у РТ 
