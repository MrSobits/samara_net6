namespace Bars.GkhGji.Regions.Stavropol.ViewModel
{
    ...
    public class ActCheckViewModel : GkhGji.ViewModel.ActCheckViewModel
    {
        ...
        public override IDataResult Get(IDomainService<ActCheck> domainService, BaseParams baseParams)
        {
            ...
            {
                var docRef = this.Container.Resolve<IDomainService<DocumentGjiReference>>().GetAll()
            ...
            var actCheckTime = this.ServiceActCheckTime.GetAll().FirstOrDefault(x => x.ActCheck.Id == intId);
