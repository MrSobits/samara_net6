...
namespace Bars.GkhGji.Regions.Stavropol.Report
{
    ...
    public class PrescriptionNotificationReport : GjiBaseReport
    {
        private long DocumentId { get; set; }

        protected override string CodeTemplate { get; set; }

        public PrescriptionNotificationReport()
        ...
        {
            get { return "Уведомление о составлении протокола (предписание)"; }
        }
                    ...
                    new TemplateInfo
                        {
                            ...
                            Description = "Уведомление о составлении протокола (предписание)",
