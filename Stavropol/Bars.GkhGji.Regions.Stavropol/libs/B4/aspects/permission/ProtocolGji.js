...
Ext.define('B4.aspects.permission.ProtocolGji', {
    ...
    */
    ...
    //поля панели редактирования
        ...
        {
            name: 'GkhGji.DocumentsGji.Protocol.Register.Definition.Fields.DocumentNum_View', applyTo: 'textfield[name=DocumentNum]', selector: '#protocolgjiDefinitionEditWindow',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) component.show();
                    else component.hide();
        ...
        {
            name: 'GkhGji.DocumentsGji.Protocol.Register.Definition.Fields.DocumentNumber_View', applyTo: 'numberfield[name=DocumentNumber]', selector: '#protocolgjiDefinitionEditWindow',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) component.show();
                    else component.hide();
