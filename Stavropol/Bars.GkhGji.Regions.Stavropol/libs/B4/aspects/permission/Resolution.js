Ext.define('B4.aspects.permission.Resolution', {
    ...
    */
        ...
        {
            name: 'GkhGji.DocumentsGji.Resolution.Field.SectorNumber_View', applyTo: '#tfSectorNumber', selector: '#resolutionEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) component.show();
                    else component.hide();
        ...
        {
            name: 'GkhGji.DocumentsGji.Resolution.Field.DateWriteOut_View', applyTo: '#dfDateWriteOut', selector: '#resolutionEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) component.show();
                    else component.hide();
        ...
        {
            name: 'GkhGji.DocumentsGji.Resolution.Register.Definition.Fields.DocumentNum_View', applyTo: 'textfield[name=DocumentNum]', selector: '#resolutionDefinitionEditWindow',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) component.show();
                    else component.hide();
        ...
        {
            name: 'GkhGji.DocumentsGji.Resolution.Register.Definition.Fields.DocumentNumber_View', applyTo: 'numberfield[name=DocumentNumber]', selector: '#resolutionDefinitionEditWindow',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) component.show();
                    else component.hide();
