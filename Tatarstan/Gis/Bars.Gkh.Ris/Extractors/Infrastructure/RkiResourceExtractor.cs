namespace Bars.Gkh.Ris.Extractors.Infrastructure
{
    ...
    /// </summary>
    public class RkiResourceExtractor : BaseDataExtractor<RisResource, OkiCommunalSource>
    {
        /// <summary>
        ...
        public override List<OkiCommunalSource> GetExternalEntities(DynamicDictionary parameters)
        {
            ...
            try
            {
                var res = okiCommunalServiceRepository
                    ...
                    .Where(x => x.OkiSection == OkiSection.NetOkiObject && x.OkiObject != null)
        ...
        protected override void UpdateRisEntity(OkiCommunalSource externalEntity, RisResource risEntity)
        {
            ...
            try
            {
                ...
                risEntity.SetPower = externalEntity.InstallPower;
                risEntity.SitingPower = externalEntity.AvailPower;
            }
            finally
            {
