namespace Bars.Gkh.Ris.Extractors.Infrastructure
{
    ...
    /// <summary>
    /// Экстрактор услуг ОКИ
    /// </summary>
    public class RkiCommunalServiceExtractor : BaseDataExtractor<RisRkiCommunalService, OkiCommunalService>
    {
        /// <summary>
        ...
        public override List<OkiCommunalService> GetExternalEntities(DynamicDictionary parameters)
        {
            var okiCommunalServiceRepository = this.Container.ResolveDomain<OkiCommunalService>();
            ...
            try
            {
                var res = okiCommunalServiceRepository
                    ...
                    .Where(x => x.OkiObject != null && x.CommunalService != null)
        ...
        protected override void UpdateRisEntity(OkiCommunalService externalEntity, RisRkiCommunalService risEntity)
        {
            ...
            try
            {
                ...
                risEntity.ServiceCode = externalEntity.CommunalService.DictCode;
                risEntity.ServiceGuid = externalEntity.CommunalService.GisGuid;
                risEntity.ServiceName = externalEntity.CommunalService.Value;
            }
            finally
            {
