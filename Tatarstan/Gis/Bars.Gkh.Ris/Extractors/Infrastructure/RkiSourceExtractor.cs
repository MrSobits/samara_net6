namespace Bars.Gkh.Ris.Extractors.Infrastructure
{
    ...
    /// <summary>
    /// Экстрактор источников ОКИ
    /// </summary>
    public class RkiSourceExtractor : BaseDataExtractor<RisRkiSource, SourceReceiver>
    {
        /// <summary>
        ...
        protected override void UpdateRisEntity(SourceReceiver externalEntity, RisRkiSource risEntity)
        {
            ...
            try
            {
                ...
                risEntity.SourceRkiItem = rkiRepository
                    .GetAll()
                    .Where(x => x.ExternalSystemName == "ris")
