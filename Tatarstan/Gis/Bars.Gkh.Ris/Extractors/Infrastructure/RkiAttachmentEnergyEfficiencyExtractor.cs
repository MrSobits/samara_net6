namespace Bars.Gkh.Ris.Extractors.Infrastructure
{
    ...
    /// <summary>
    /// Экстрактор документов ОКИ - Документы, подтверждающие соответсвие требованиям энергоэффективности
    /// </summary>
    public class RkiAttachmentEnergyEfficiencyExtractor : BaseDataExtractor<RisAttachmentsEnergyEfficiency, OkiDoc>
    {
        /// <summary>
        ...
        public override List<OkiDoc> GetExternalEntities(DynamicDictionary parameters)
        {
            ...
            try
            {
                var res = okiDocRepository
                    ...
                    .Where(x => x.OkiObject != null && x.OkiDocType.Id == 2) //Документы, подтверждающие соответсвие требованиям энергоэффективности
        ...
        protected override void UpdateRisEntity(OkiDoc externalEntity, RisAttachmentsEnergyEfficiency risEntity)
        {
            ...
            catch (FileNotFoundException)
            {
                ...
                this.Log.Add(
                    new BaseLogRecord(MessageType.Info, "Файл документа, подтверждающего соответсвие требованиям энергоэффективности " + file?.FullName + " не найден"));
            }
            finally
            {
