namespace Bars.Gkh.Ris.Extractors.Bills
{
    ...
    /// <summary>
    /// Экстрактор "Начисление по услуге - Жилищная услуга"
    /// </summary>
    public class RisHousingServiceChargeInfoDataExtractor : BaseSlimDataExtractor<RisHousingServiceChargeInfo>
    {
        /// <summary>
        ...
        public override List<RisHousingServiceChargeInfo> Extract(DynamicDictionary parameters)
        {
            ...
            var risHousingServiceChargeInfoDomain = this.Container.ResolveDomain<RisHousingServiceChargeInfo>();
            using (this.Container.Using(risHousingServiceChargeInfoDomain))
            {
                return risHousingServiceChargeInfoDomain.GetAll()
        ...
        private bool ExecuteProcedures(long[] houseIds, DateTime reportingPeriod)
        {
            ...
            try
            {
                ...
                var procedures = new[]
                {
                    "ris_transfer_housing_service_charge_info"
                };
