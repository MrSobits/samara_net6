namespace Bars.Gkh.Ris.Extractors.Bills
{
    ...
    /// <summary>
    /// Экстрактор "Начисление по услуге - дополнительная услуга"
    /// </summary>
    public class RisAdditionalServiceChargeInfoDataExtractor : BaseSlimDataExtractor<RisAdditionalServiceChargeInfo>
    {
        /// <summary>
        ...
        public override List<RisAdditionalServiceChargeInfo> Extract(DynamicDictionary parameters)
        {
            ...
            var risAdditionalServiceChargeInfoDomain = this.Container.ResolveDomain<RisAdditionalServiceChargeInfo>();
            using (this.Container.Using(risAdditionalServiceChargeInfoDomain))
            {
                return risAdditionalServiceChargeInfoDomain.GetAll()
        ...
        private bool ExecuteProcedures(long[] houseIds, DateTime reportingPeriod)
        {
            ...
            try
            {
                ...
                var procedures = new[]
                {
                    "ris_transfer_additional_service_charge_info"
                };
