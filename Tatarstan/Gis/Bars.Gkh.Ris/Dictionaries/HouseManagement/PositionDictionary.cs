namespace Bars.Gkh.Ris.Dictionaries.HouseManagement
{
    ...
    /// <summary>
    /// Справочник "Расположение помещения"
    /// </summary>
    public class PositionDictionary : BaseDictionary
    {
        /// <summary>
        /// Конструктор справочника
        /// </summary>
        /// <param name="container">IoC контейнер</param>
        public PositionDictionary(IWindsorContainer container)
            : base(container)
        {
        }
        ...
        /// Наименование
        /// </summary>
        public override string Name => "Расположение помещения";
        ...
        {
            return ExternalEntityProxyList.FromEnum<Position>();
        }
    }
}
