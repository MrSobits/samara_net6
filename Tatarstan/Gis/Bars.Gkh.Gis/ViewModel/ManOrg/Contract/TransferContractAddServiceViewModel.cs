namespace Bars.Gkh.Gis.ViewModel.ManOrg.Contract
{
    ...
    public class TransferContractAddServiceViewModel : BaseViewModel<TransferContractAddService>
    {
        /// <summary>
        /// Получить список
        /// </summary>
        ...
        /// </returns>
        public override IDataResult List(IDomainService<TransferContractAddService> domainService, BaseParams baseParams)
        {
