namespace Bars.Gkh.Gis.ViewModel.ManOrg.Contract
{
    ...
    public class RelationContractCommServiceViewModel : BaseViewModel<RelationContractCommService>
    {
        /// <summary>
        /// Получить список
        /// </summary>
        ...
        /// </returns>
        public override IDataResult List(IDomainService<RelationContractCommService> domainService, BaseParams baseParams)
        {
