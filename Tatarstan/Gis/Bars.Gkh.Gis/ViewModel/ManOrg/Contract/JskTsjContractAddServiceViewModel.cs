namespace Bars.Gkh.Gis.ViewModel.ManOrg.Contract
{
    ...
    public class JskTsjContractAddServiceViewModel : BaseViewModel<JskTsjContractAddService>
    {
        /// <summary>
        /// Получить список
        /// </summary>
        ...
        /// </returns>
        public override IDataResult List(IDomainService<JskTsjContractAddService> domainService, BaseParams baseParams)
        {
