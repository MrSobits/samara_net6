namespace Bars.Gkh.Gis.ViewModel.ManOrg.Contract
{
    ...
    public class TransferContractWorkServiceViewModel : BaseViewModel<TransferContractWorkService>
    {
        /// <summary>
        /// Получить список
        /// </summary>
        ...
        /// </returns>
        public override IDataResult List(IDomainService<TransferContractWorkService> domainService, BaseParams baseParams)
        {
        ...
        /// </returns>
        public override IDataResult Get(IDomainService<TransferContractWorkService> domainService, BaseParams baseParams)
        {
