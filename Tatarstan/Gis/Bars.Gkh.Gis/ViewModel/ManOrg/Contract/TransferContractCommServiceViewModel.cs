namespace Bars.Gkh.Gis.ViewModel.ManOrg.Contract
{
    ...
    public class TransferContractCommServiceViewModel : BaseViewModel<TransferContractCommService>
    {
        /// <summary>
        /// Получить список
        /// </summary>
        ...
        /// </returns>
        public override IDataResult List(IDomainService<TransferContractCommService> domainService, BaseParams baseParams)
        {
