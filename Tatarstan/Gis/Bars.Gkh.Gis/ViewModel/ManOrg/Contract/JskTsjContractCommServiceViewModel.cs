namespace Bars.Gkh.Gis.ViewModel.ManOrg.Contract
{
    ...
    public class JskTsjContractCommServiceViewModel : BaseViewModel<JskTsjContractCommService>
    {
        /// <summary>
        /// Получить список
        /// </summary>
        ...
        /// </returns>
        public override IDataResult List(IDomainService<JskTsjContractCommService> domainService, BaseParams baseParams)
        {
