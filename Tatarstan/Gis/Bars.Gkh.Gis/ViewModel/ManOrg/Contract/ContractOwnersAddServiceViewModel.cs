namespace Bars.Gkh.Gis.ViewModel.ManOrg.Contract
{
    ...
    public class ContractOwnersAddServiceViewModel : BaseViewModel<ContractOwnersAddService>
    {
        /// <summary>
        /// Получить список
        /// </summary>
        ...
        /// </returns>
        public override IDataResult List(IDomainService<ContractOwnersAddService> domainService, BaseParams baseParams)
        {
