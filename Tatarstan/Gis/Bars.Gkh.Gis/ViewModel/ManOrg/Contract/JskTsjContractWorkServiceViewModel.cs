namespace Bars.Gkh.Gis.ViewModel.ManOrg.Contract
{
    ...
    public class JskTsjContractWorkServiceViewModel : BaseViewModel<JskTsjContractWorkService>
    {
        /// <summary>
        /// Получить список
        /// </summary>
        ...
        /// </returns>
        public override IDataResult List(IDomainService<JskTsjContractWorkService> domainService, BaseParams baseParams)
        {
        ...
        /// </returns>
        public override IDataResult Get(IDomainService<JskTsjContractWorkService> domainService, BaseParams baseParams)
        {
