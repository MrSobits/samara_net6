Ext.define('B4.view.manorg.contract.TransferEditWindow', {
    ...
    requires: [
        ...
        'B4.view.manorg.contract.TransferCommunalServiceGrid',
        'B4.view.manorg.contract.TransferAdditionServiceGrid',
        'B4.view.manorg.contract.TransferWorkServiceGrid'
    ],
            ...
            items: [
                {
                    ...
                    items: [
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            enumName: 'B4.enums.ManOrgTransferContractFoundation'
                                        },
                                        {
                                            xtype: 'textfield',
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'transferadditionservicegrid',
                                    border: true,
                                    padding: '0 0 5 0'
                                },
                                {
                                    xtype: 'transfercommunalservicegrid',
                                    border: true
                                }
                            ]
                        },
