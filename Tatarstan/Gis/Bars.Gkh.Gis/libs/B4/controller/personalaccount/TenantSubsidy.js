Ext.define('B4.controller.personalaccount.TenantSubsidy', {
    extend: 'B4.base.Controller',
    requires: ['B4.aspects.PeriodFilterGrid'],

    mixins: { context: 'B4.mixins.Context' },
    views: ['personalAccount.TenantSubsidyGrid'],
    mainView: 'personalAccount.TenantSubsidyGrid',
    mainViewSelector: 'tenantSubsidyGrid',

    init: function () {
        this.callParent(arguments);

        this.control({
            'tenantSubsidyGrid b4updatebutton': {
                'click': function () {
    ...
    index: function (id) {
        var me = this,
            view = this.getMainView() || Ext.widget('tenantSubsidyGrid');
