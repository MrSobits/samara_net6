namespace Bars.Gkh.Gis.Map.ManOrg.Contract
{
    ...
    /// <summary>
    /// Маппинг для  ContractOwnersWorkService
    /// </summary>
    public class ContractOwnersWorkServiceMap : BaseEntityMap<ContractOwnersWorkService>
    {
        /// <summary>
        /// ctor
        /// </summary>
        public ContractOwnersWorkServiceMap()
            : base("Работы и услуги договора управления с собственником", "CONTRACT_OWNERS_WORK_SERVICE")
        {
        }
