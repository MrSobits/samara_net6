namespace Bars.Gkh.Gis.Map.ManOrg.Contract
{
    ...
    /// <summary>
    /// Маппинг для TransferContractCommService
    /// </summary>
    public class TransferContractCommServiceMap : BaseEntityMap<TransferContractCommService>
    {
        /// <summary>
        /// ctor
        /// </summary>
        public TransferContractCommServiceMap()
            : base("Коммунальная услуга договора передачи управления УК", "TRANSFER_CONTRACT_COMM_SERVICE")
        {
        }
