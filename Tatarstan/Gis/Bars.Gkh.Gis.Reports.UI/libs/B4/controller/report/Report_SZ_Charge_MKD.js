Ext.define('B4.controller.report.Report_SZ_Charge_MKD', {
    extend: 'B4.controller.BaseReportController',

    //Указываем главную форму и ее селектор
    mainView: 'B4.view.report.Report_SZ_Charge_MKDPanel',
    mainViewSelector: '#ReportPanel_SZ_Charge_MKD',

    //Указываем ref, для более удобного получения компонентов
    refs: [
        {
            ref: 'ReportDateField',
            selector: '#ReportPanel_SZ_Charge_MKD datefield[name=ReportDate]'
        }
    ],
