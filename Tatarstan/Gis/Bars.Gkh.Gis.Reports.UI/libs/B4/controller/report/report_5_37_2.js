Ext.define('B4.controller.report.Report_5_37_2', {
    extend: 'B4.controller.BaseReportController',

    //Указываем главную форму и ее селектор
    mainView: 'B4.view.report.Report_5_37_2Panel',
    mainViewSelector: '#ReportPanel_5_37_2',

    //Указываем ref, для более удобного получения компонентов
    refs: [
        {
            ref: 'StartReportDateField',
            selector: '#ReportPanel_5_37_2 datefield[name=StartReportDate]'
        },
        {
            ref: 'EndReportDateField',
            selector: '#ReportPanel_5_37_2 datefield[name=EndReportDate]'
        }
