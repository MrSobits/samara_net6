Ext.define('B4.controller.report.Report_SZ_Indicator', {
    extend: 'B4.controller.BaseReportController',

    //Указываем главную форму и ее селектор
    mainView: 'B4.view.report.Report_SZ_IndicatorPanel',
    mainViewSelector: '#ReportPanel_SZ_Indicator',

    //Указываем ref, для более удобного получения компонентов
    refs: [
        {
            ref: 'ReportDateField',
            selector: '#ReportPanel_SZ_Indicator datefield[name=ReportDate]'
        }
    ],
