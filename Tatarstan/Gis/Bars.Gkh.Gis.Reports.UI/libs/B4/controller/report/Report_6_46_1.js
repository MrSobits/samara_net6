Ext.define('B4.controller.report.Report_6_46_1', {
    extend: 'B4.controller.BaseReportController',

    //Указываем главную форму и ее селектор
    mainView: 'B4.view.report.Report_6_46_1Panel',
    mainViewSelector: '#ReportPanel_6_46_1',

    //Указываем ref, для более удобного получения компонентов
    refs: [
        {
            ref: 'StartReportDateField',
            selector: '#ReportPanel_6_46_1 datefield[name=StartReportDate]'
        },
        {
            ref: 'EndReportDateField',
            selector: '#ReportPanel_6_46_1 datefield[name=EndReportDate]'
        }
