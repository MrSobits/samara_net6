Ext.define('B4.view.dict.realityobjectoutdoorprogram.Grid', {
    ...
    title: 'Программы благоустройства дворов',
    alias: 'widget.outdoorprogramgrid',
    closable: true,

    initComponent: function () {
        var me = this,
            store = Ext.create('B4.store.dict.RealityObjectOutdoorProgram');
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'TypeVisibilityProgram',
                    flex: 2,
                    text: 'Видимость',
