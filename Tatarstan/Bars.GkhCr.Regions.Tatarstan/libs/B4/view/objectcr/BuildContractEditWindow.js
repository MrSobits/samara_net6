                                ...
                                items: [
                                    {
                                        ...
                                        editable: false,
                                        enumName: B4.enums.TypeContractBuild,
                                        listConfig: {
                                            listeners: {
                                                refresh: function () {
                                                    // Скрываем поле "На энергообследование" в выпадающем списке
                                                    var me = this,
                                                        storeItems = me.store.getRange(),
                                                        index = storeItems.findIndex(function (x) {
                                                            return x.get('Value') === B4.enums.TypeContractBuild.EnergySurvey;
                                                        });

                                                    if (index) {
                                                        me.all.elements[index].hidden = true;
                                                    }
                                                }
                                            }
                                        }
