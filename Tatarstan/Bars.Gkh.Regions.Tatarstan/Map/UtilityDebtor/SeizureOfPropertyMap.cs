namespace Bars.Gkh.Regions.Tatarstan.Map.UtilityDebtor
{
    ...
    /// <summary>
    /// Маппинг для "Постановление о наложении ареста на имущество"
    /// </summary>
    public class SeizureOfPropertyMap : JoinedSubClassMap<SeizureOfProperty>
    {
        public SeizureOfPropertyMap()
            : base("Постановление о наложении ареста на имущество", "CLW_PROP_SEIZURE")
        {
        }
        ...
        protected override void Map()
        {
            ...
            this.Property(x => x.IsCanceled, "Аннулировано").Column("IS_CANCELED").DefaultValue(false).NotNull();
