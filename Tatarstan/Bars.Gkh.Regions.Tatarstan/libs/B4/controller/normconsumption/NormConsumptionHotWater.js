Ext.define('B4.controller.normconsumption.NormConsumptionHotWater', {
    ...
    models: ['normconsumption.NormConsumptionHotWater'],
    stores: ['normconsumption.NormConsumptionHotWater'],
    views: [
        'normconsumption.Grid',
        'normconsumption.HotWaterGrid'
    ],

    mainView: 'normconsumption.HotWaterGrid',
    mainViewSelector: 'normconsumptiongrid',

    refs: [
        {
            ref: 'mainView',
            selector: 'normconshotwatergrid'
        }
    ],
    ...
    aspects: [
        {
            ...
            editPanelSelector: 'normconshotwatergrid',
            name: 'normconshotwatereditpanelaspect',
            listeners: {
        ...
        },
        {
            ...
            storeName: 'normconsumption.NormConsumptionHotWater',
            modelName: 'normconsumption.NormConsumptionHotWater',
            gridSelector: 'normconshotwatergrid gridpanel',
            saveButtonSelector: 'normconshotwatergrid b4savebutton',
            save: function() {
                var me = this;
            ...
            otherActions: function (actions) {
                actions['normconshotwatergrid b4updatebutton'] = { 'click': { fn: this.onUpdateBtnClick, scope: this } };
            },
        ...
        },
        {
            ...
            listeners: {
                transfersuccess: function (asp, entityId) {
                    asp.controller.getAspect('normconshotwatereditpanelaspect').setData(entityId);
                }
            }
        },
        {
            ...
            gridSelector: 'normconshotwatergrid gridpanel',
            buttonSelector: 'normconshotwatergrid [action="Export"]',
    ...
    index: function (id) {
        ...
        var me = this,
            view = me.getMainView() || Ext.widget('normconshotwatergrid'),
            store = view.down('grid').getStore();
        me.bindContext(view);
        me.application.deployView(view);
        me.getAspect('normconshotwatereditpanelaspect').setData(id);
