Ext.define('B4.controller.regop.personal_account.Details',
{
    ...
    views: [
        ...
        'regop.personal_account.ChangevalbtnRoomAddress'
    ],
    stores: [
    ...
    models: [
        ...
        'regop.personal_account.ApartmentNumber'
    ],
    ...
    init: function () {
        var me = this,
            events = {
                ...
                'personalaccounteditpanel changevalbtnRoomAddress':{
                    'show': function (grid) {
                        grid.getStore().on('beforeload', me.onBeforeLoadRoomAddresses, me);
                    },

                    'valuesaved': function (btn, newValue) {
                        var field = me.getEditPanel().down(btn.valueFieldSelector);

                        if (field) {
                            field.setValue(me.AddressRealtyObj + newValue);
                        }
                    }
                },
                'paccounthistorygrid': {
                ...
                'personalaccounteditpanel changevalbtnRoomAddress[name=btnRoomAddress]': { click: { fn: me.onClickBtnRoomAddress, scope: me } }
    ...
    show: function (id) {
        ...
        model.load(id, {
            success: function (rec) {
                ...
                me.setContextValue(me.getMainComponent(), 'RealityObject', params.realityObjectId);
                me.AddressRealtyObj = rec.get('RealityObject').Address
                me.fiasAddress = rec.get('FiasAddress');
    ...
    onBeforeLoadRoomAddresses: function (store, operation){
        operation.params.realtyId = this.getContextValue(this.getMainView(), 'RealityObject');
    },

    onClickBtnRoomAddress: function (form) {
        form.showWindow();
        form.initValue(this.accId, this.fiasAddress);
    }
});