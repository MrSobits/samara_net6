namespace Bars.GkhGji.Regions.Tatarstan.StateChange
{
    ...
    public class ResolutionGisChargeRule : BaseResolutionGisChargeRule
    {
        public override string Id => "gji_resolution_gis_charge_rule";

        public override string Name => "Постановление - Формирование файла начисления для ГИС ГМП";
        ...
        protected override ChargeStatus ChargeStatus => ChargeStatus.Send;
