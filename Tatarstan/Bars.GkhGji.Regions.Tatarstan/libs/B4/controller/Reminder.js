Ext.define('B4.controller.Reminder', {
    ...
    init: function () {
        ...
        actions['reminderPanel[typeReminder = "head"] reminderfilterpnl #cbResolution'] = { 'change': { fn: this.onChangeResolution, scope: this } };
        ...
        actions['reminderPanel[typeReminder = "inspector"] reminderfilterpnl #cbResolution'] = { 'change': { fn: this.onChangeResolution, scope: this } };
    ...
    reminderTaskState: function (colorType, typeReminder) {
        ...
        if (!pnl) {
            ...
            switch (type) {
                ...
                case 50: {
                    lableText = 'Состояние по задачам с типом \"Постановление\"';
                }
                    break;
    ...
    fillDopFilter: function (pnl) {
        ...
        B4.Ajax.request(B4.Url.action('GetInfo', 'Reminder', {
            ...
            isResolution: pnl.params.isResolution,
    ...
    onChangeResolution: function (field, newValue) {
        field.up('reminderPanel').params.isResolution = newValue;
    },
    ...
    onBeforeLoad: function (store, operation) {
        ...
        if (params) {
            ...
            operation.params.isResolution = params.isResolution;
    ...
    getControllerName: function(typeBase) {
        switch (typeBase) {
            ...
            //протокол гжи
            case 140:
                return 'B4.controller.tatarstanprotocolgji.Navigation';
            //Без основания                     
            case 150:
