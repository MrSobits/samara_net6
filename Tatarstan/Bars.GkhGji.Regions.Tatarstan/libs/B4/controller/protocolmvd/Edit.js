    ...
    aspects: [
        ...
        },
        {
            ...
            */
            ...
            applyOn: { event: 'show', selector: '#protocolMvdEditPanel' },
            name: 'protocolMvdRequirementAspect',
            requirements: [
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.SurName',
                    applyTo: '[name=SurName]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.Name',
                    applyTo: '[name=Name]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.Patronymic',
                    applyTo: '[name=Patronymic]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.BirthDate',
                    applyTo: '[name=BirthDate]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.BirthPlace',
                    applyTo: '[name=BirthPlace]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.Address',
                    applyTo: '[name=PhysicalPersonInfo]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.SerialAndNumber',
                    applyTo: '[name=SerialAndNumber]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.IssueDate',
                    applyTo: '[name=IssueDate]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.IssuingAuthority',
                    applyTo: '[name=IssuingAuthority]',
                    selector: '#protocolMvdEditPanel'
                },
                {
                    name: 'GkhGji.DocumentReestrGji.ProtoclMvd.Field.Company',
        ...
        {   /*
            ...
            */
            ...
            onChangeCitizenshipType: function(field, newValue, oldValue) {
                if (newValue) {
                    var editPanel = field.up('#protocolMvdEditPanel'),
                        citizenship = editPanel.down('#citizenship');
                    ...
                    field.setValue(B4.enums.CitizenshipType.RussianFederation);
                }
            },
        },
        {
