Ext.define('B4.controller.Prescription', {
    ...
    aspects: [
        ...
        {
            /*
            Аспект взаимодействия Таблицы решений с формой редактирования
            */
            xtype: 'grideditwindowaspect',
            ...
            setCancelId: function(id) {
                ...
                if (id > 0) {
                    var element = editWindow.down('[name=Prolongation]');
        ...
        },
        {
            ...
            */
            ...
            otherActions: function (actions) {
                actions['prescrclosepanel'] = { 'store.beforeload': { fn: this.controller.onBeforeLoad, scope: this.controller } };
            },
        },
        {
    ...
    init: function () {
        ...
        me.control({
            'prescrclosepanel': {
                'afterrender': {
                    fn: function (panel) {
                        panel.down('b4grid').getStore().load();
                    },
                    scope: me
                }
            }
