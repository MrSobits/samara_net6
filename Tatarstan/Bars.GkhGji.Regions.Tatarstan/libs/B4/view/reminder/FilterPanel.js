            ...
            items: [
               ...
               },
               {
                   ...
                   items: [
                        ...
                        {
                            xtype: 'label',
                            html: '<div style="margin-bottom: 15px; font-size: 11.5px;">По постановлению - <div style="margin-left: 5px; margin-top: 4px; line-height: 17px;">дата вручения или дата постановления (в случае отсутствия даты вручения) + 70 дней</div></div>'
                        },
                       {
                            xtype: 'label',
