Ext.define('B4.view.warninginspection.Grid', {
    extend: 'B4.ux.grid.Panel',

    alias: 'widget.warninginspectiongrid',
    ...
    initComponent: function () {
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'AppealCitsNumberDate',
