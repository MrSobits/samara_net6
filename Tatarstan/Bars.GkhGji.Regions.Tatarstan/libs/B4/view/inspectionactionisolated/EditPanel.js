Ext.define('B4.view.inspectionactionisolated.EditPanel', {
    ...
    itemId: 'inspectionActionIsolatedEditPanel',
    title: 'Проверка по КНМ',
    ...
    requires: [
        ...
        'B4.view.inspectionactionisolated.RealityObjectGrid',
        'B4.view.inspectionactionisolated.JointInspectionGrid',
        ...
        Ext.applyIf(me, {
            items: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'inspectionActionIsolatedRealityObjGrid',
                        },
                        {
                            xtype: 'inspectionActionIsolatedJointInspectionGrid'
                        }
                    ]
                }
            ],
