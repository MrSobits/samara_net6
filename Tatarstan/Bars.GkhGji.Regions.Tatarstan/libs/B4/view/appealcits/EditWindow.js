Ext.define('B4.view.appealcits.EditWindow', {
    ...
    requires: [
        ...
        'B4.view.appealcits.ActionIsolatedGrid',
        'B4.view.appealcits.WarningInspectionGrid',
        'B4.view.appealcits.MotivatedPresentationGrid',
        'B4.view.appealcits.SoprInformationPanel',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'b4combobox',
                            itemId: 'isIdentityVerifiedComboBox',
                            name: 'IsIdentityVerified',
                            editable: false,
                            hidden: true,
                            disabled: true,
                            fieldLabel: 'Данные личности подтверждены',
                ...
                },
                {
                    ...
                    items: [
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            boxLabel: 'Проведена предварительная проверка',
                                            fieldLabel: '&nbsp;',
                                            labelSeparator: ''
                                        }
                                    ]
                        ...
                        {
                            xtype: 'appealcitssoprinformationpanel',
                            flex: 1
                        },
                        {
                            xtype: 'appealcitsactionisolatedgrid',
                            flex: 1
                        },
                        {
                            xtype: 'motivatedpresentationappealcitsgrid',
                            flex: 1
                        },
                        {
                        ...
                        {
                            xtype: 'appealCitsWarningInspectionGrid',
                            flex: 1
                        },
                        {
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'button',
                                    text: 'Сформировать предостережение',
                                    iconCls: 'icon-application-go',
                                    textAlign: 'left',
                                    aspectName: 'warningInspectionAppCitEditWindowAspect',
                                    itemId: 'btnCreateWarningInspection',
                                    disabled: true
                                },
                                {
                                    xtype: 'button',
                                    text: 'Сформировать КНМ без взаимодействия',
                                    iconCls: 'icon-application-go',
                                    textAlign: 'left',
                                    itemId: 'btnCreateActionIsolated'
                                },
                                {
                                    xtype: 'button',
                                    text: 'Сформировать мотивированное представление',
                                    iconCls: 'icon-application-go',
                                    textAlign: 'left',
                                    itemId: 'btnCreateMotivatedPresentation'
                                }
                            ]
                        },
                        {
