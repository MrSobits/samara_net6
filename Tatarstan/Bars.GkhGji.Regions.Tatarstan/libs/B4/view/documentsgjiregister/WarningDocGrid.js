Ext.define('B4.view.documentsgjiregister.WarningDocGrid', {
    ...
    store: 'view.WarningDoc',
    itemId: 'docsGjiRegisterWarningDocGrid',
    closable: true,
                    ...
                    filter: {
                        ...
                        listeners: {
                            storebeforeload: function (field, store, options) {
                                options.params.typeId = 'gji_document_warning';
                            },
                            storeloaded: {
                                fn: function (me) {
