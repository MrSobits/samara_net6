Ext.define('B4.aspects.permission.ActRemoval', {
    ...
    permissions: [
        ...
        */
        ...
        {
            name: 'GkhGji.DocumentsGji.ActRemoval.Field.SumAmountWorkRemoval_Edit', applyTo: '#cdfSumAmountWorkRemoval', selector: '#actRemovalViolationGrid',
            applyBy: function (component, allowed) {
                if (allowed) component.editor =
                    {
                        xtype: 'numberfield',
                        hideTrigger: true,
                        keyNavEnabled: false,
