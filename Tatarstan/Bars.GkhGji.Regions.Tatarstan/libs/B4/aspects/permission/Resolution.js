Ext.define('B4.aspects.permission.Resolution', {
    ...
    permissions: [
        ...
        */
        ...
        { name: 'GkhGji.DocumentsGji.Resolution.Field.SanctionsDuration_Edit',applyTo: '#tfSanctionsDuration',selector: '#resolutionEditPanel'},
        {
            name: 'GkhGji.DocumentsGji.Resolution.Field.SanctionsDuration_View',
            applyTo: '#tfSanctionsDuration',
            selector: '#resolutionEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
                    component.viewPermissionAllowed = allowed;
                    //отображение через событие 'change' комбобокса 'cbSanction'
                }
            }
        },
        { name: 'GkhGji.DocumentsGji.Resolution.Field.Snils_Edit', applyTo: '#tfSnils', selector: '#resolutionEditPanel' },
        {
            name: 'GkhGji.DocumentsGji.Resolution.Field.Snils_View',
            applyTo: '#tfSnils',
            selector: '#resolutionEditPanel',
            applyBy: function (component, allowed) {
        ...
        {
            name: 'GkhGji.DocumentsGji.Resolution.Field.PatternDict_View',
            applyTo: '#patternDict',
            selector: '#resolutionEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
        ...
        {
            name: 'GkhGji.DocumentsGji.Resolution.Field.ChangeReason_View',
            applyTo: '#changeReason',
            selector: '#resolutionEditPanel',
            applyBy: function (component, allowed) {
                if (component) {
                    if (allowed) component.show();
