namespace Bars.GkhGji.Regions.Tatarstan.ViewModel.ActCheck
{
    ...
    public class ActCheckActionViolationViewModel : BaseViewModel<ActCheckActionViolation>
    {
        /// <inheritdoc />
        public override IDataResult List(IDomainService<ActCheckActionViolation> domainService, BaseParams baseParams)
        {
